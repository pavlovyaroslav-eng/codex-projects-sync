...
_base_completions = interpreter.llm.completions


def hometele_completions(**params):
    """Disable Qwen thinking so output tokens contain the visible answer/code."""
    params["extra_body"] = {
        "chat_template_kwargs": {"enable_thinking": False}
    }
    yield from _base_completions(**params)
...
interpreter.llm.completions = hometele_completions
