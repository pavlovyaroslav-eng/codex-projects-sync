...
Generated: 2026-09-11T22:09:02+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 22:09:02 up 5 days, 18:48,  1 user,  load average: 0.18, 0.18, 0.18
```
...
udp   UNCONN 0      0                  *:40263            *:*    users:(("rw-core",pid=252273,fd=138))                                                                              
udp   UNCONN 0      0                  *:39285            *:*    users:(("rw-core",pid=252273,fd=51))                                                                               
udp   UNCONN 0      0               [::]:59810         [::]:*    users:(("amneziawg-go",pid=905,fd=15))                                                                             
udp   UNCONN 0      0                  *:443              *:*    users:(("rw-core",pid=252273,fd=7))                                                                                
udp   UNCONN 0      0                  *:53742            *:*    users:(("rw-core",pid=252273,fd=117))                                                                              
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 24996 bytes 3181084 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 24996 bytes 2215874 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 24995 bytes 1500692 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 52266629 bytes 36254250677 accept
		ct state related,established counter packets 154359050 bytes 111298472666 accept
		ct state invalid counter packets 14364 bytes 880207 jump ufw-logging-deny
		ct state invalid counter packets 14364 bytes 880207 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1860 bytes 96341 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1338175 bytes 172641938 jump ufw-not-local
		...
		counter packets 1338175 bytes 172641938 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 52266629 bytes 36254250677 accept
		ct state related,established counter packets 124171901 bytes 113724870855 accept
		counter packets 1535502 bytes 187721901 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 3709949 bytes 2632708689 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 185485 bytes 11135804 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 43942 bytes 3427476 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2151 bytes 491985 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 96 bytes 4644 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 618 bytes 29172 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 23406 bytes 7208868 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 160307 bytes 58392552 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 24996 bytes 1168768 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 24996 bytes 2837257 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 24995 bytes 1500692 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 899542 bytes 53998675 accept
		ip protocol udp ct state new counter packets 617999 bytes 126494633 accept
	}
	...
	chain INPUT {
		...
		counter packets 207980078 bytes 147726341829 jump ufw-before-logging-input
		counter packets 207980078 bytes 147726341829 jump ufw-before-input
		counter packets 525669 bytes 83762058 jump ufw-after-input
		counter packets 295144 bytes 14207221 jump ufw-after-logging-input
		counter packets 295144 bytes 14207221 jump ufw-reject-input
		counter packets 295144 bytes 14207221 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 177974032 bytes 150166843433 jump ufw-before-logging-output
		counter packets 177974032 bytes 150166843433 jump ufw-before-output
		counter packets 1535502 bytes 187721901 jump ufw-after-output
		counter packets 1535502 bytes 187721901 jump ufw-after-logging-output
		counter packets 1535502 bytes 187721901 jump ufw-reject-output
		counter packets 1535502 bytes 187721901 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 4676793 bytes 2910030842 jump DOCKER-USER
		counter packets 4676793 bytes 2910030842 jump DOCKER-FORWARD
		...
		counter packets 3895434 bytes 2643844493 jump ufw-before-logging-forward
		counter packets 3895434 bytes 2643844493 jump ufw-before-forward
		counter packets 185485 bytes 11135804 jump ufw-after-forward
		counter packets 185485 bytes 11135804 jump ufw-after-logging-forward
		counter packets 185485 bytes 11135804 jump ufw-reject-forward
		counter packets 185485 bytes 11135804 jump ufw-track-forward
		iifname "wg-home" counter packets 185485 bytes 11135804 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7551 bytes 446505 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7551 bytes 446505 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 230525 bytes 69554837 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1104439 bytes 102999891 return
		fib daddr type multicast counter packets 3998 bytes 127936 return
		fib daddr type broadcast counter packets 229738 bytes 69514111 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 473963 bytes 26837217 accept
		tcp dport 80 counter packets 268068 bytes 14875244 accept
		tcp dport 52000 counter packets 390 bytes 22868 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1034 bytes 62040 accept
		udp dport 443 counter packets 68994 bytes 47077425 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-11 22:08:44 |
