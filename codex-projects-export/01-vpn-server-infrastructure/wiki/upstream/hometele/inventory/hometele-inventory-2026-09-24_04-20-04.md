...
Generated: 2026-09-24T04:20:04+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:04 up 18 days, 59 min,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0                  *:47367            *:*    users:(("rw-core",pid=1619407,fd=9))                                                                                   
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=2187182,fd=3),("systemd",pid=1,fd=179))                                                             
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=2187182,fd=4),("systemd",pid=1,fd=180))                                                             
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 77949 bytes 10565090 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 77949 bytes 5974689 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 77948 bytes 4679936 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 184188132 bytes 147811650168 accept
		ct state related,established counter packets 469932514 bytes 363335358605 accept
		ct state invalid counter packets 40245 bytes 2521361 jump ufw-logging-deny
		ct state invalid counter packets 40245 bytes 2521361 drop
		...
		ip protocol icmp icmp type echo-request counter packets 6988 bytes 378048 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3670709 bytes 544994895 jump ufw-not-local
		...
		counter packets 3670709 bytes 544994895 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 184188132 bytes 147811650168 accept
		ct state related,established counter packets 364738487 bytes 369887449663 accept
		counter packets 3211366 bytes 361641915 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 12400401 bytes 8903692072 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 581567 bytes 34923548 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 113132 bytes 8824296 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 6390 bytes 1462365 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 254 bytes 11908 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 2041 bytes 94060 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 73706 bytes 22879793 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 16 bytes 448 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 500796 bytes 181641543 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 77949 bytes 3656373 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 77949 bytes 7360106 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 77948 bytes 4679936 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1810944 bytes 108874275 accept
		ip protocol udp ct state new counter packets 1363652 bytes 239631901 accept
	}
	...
	chain INPUT {
		...
		counter packets 657838588 bytes 511694903077 jump ufw-before-logging-input
		counter packets 657838588 bytes 511694903077 jump ufw-before-input
		counter packets 1571287 bytes 279672921 jump ufw-after-input
		counter packets 874952 bytes 64758508 jump ufw-after-logging-input
		counter packets 874952 bytes 64758508 jump ufw-reject-input
		counter packets 874952 bytes 64758508 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 552137985 bytes 518060741746 jump ufw-before-logging-output
		counter packets 552137985 bytes 518060741746 jump ufw-before-output
		counter packets 3211366 bytes 361641915 jump ufw-after-output
		counter packets 3211366 bytes 361641915 jump ufw-after-logging-output
		counter packets 3211366 bytes 361641915 jump ufw-reject-output
		counter packets 3211366 bytes 361641915 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 6720609 bytes 4267721776 jump DOCKER-USER
		counter packets 6720609 bytes 4267721776 jump DOCKER-FORWARD
		...
		counter packets 12981968 bytes 8938615620 jump ufw-before-logging-forward
		counter packets 12981968 bytes 8938615620 jump ufw-before-forward
		counter packets 581567 bytes 34923548 jump ufw-after-forward
		counter packets 581567 bytes 34923548 jump ufw-after-logging-forward
		counter packets 581567 bytes 34923548 jump ufw-reject-forward
		counter packets 581567 bytes 34923548 jump ufw-track-forward
		iifname "wg-home" counter packets 581567 bytes 34923548 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 19410 bytes 1247920 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 19410 bytes 1247920 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 696335 bytes 214914413 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2964414 bytes 329808546 return
		fib daddr type multicast counter packets 12469 bytes 399008 return
		fib daddr type broadcast counter packets 693826 bytes 214787341 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1394026 bytes 80187499 accept
		tcp dport 80 counter packets 479336 bytes 25711623 accept
		tcp dport 52000 counter packets 691 bytes 40386 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 132 bytes 7596 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2974 bytes 178440 accept
		udp dport 443 counter packets 222246 bytes 159191774 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 6720609 bytes 4267721776 jump DOCKER-CT
		counter packets 6262328 bytes 4018618504 jump DOCKER-INTERNAL
		counter packets 6262328 bytes 4018618504 jump DOCKER-BRIDGE
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-24 04:19:36 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-23 15:42:05 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 416K
drwxr-xr-x  2 root root   4.0K Sep 24 03:20 .
drwxrwxr-x 15 root syslog 4.0K Sep 22 06:07 ..
