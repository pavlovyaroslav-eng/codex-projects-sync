...
Generated: 2026-09-13T09:37:47+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 09:37:47 up 7 days,  6:17,  2 users,  load average: 0.03, 0.05, 0.00
```
...
udp   UNCONN 0      0                  *:51876            *:*    users:(("rw-core",pid=252273,fd=32))                                                                               
udp   UNCONN 0      0                  *:47206            *:*    users:(("rw-core",pid=252273,fd=63))                                                                               
udp   UNCONN 0      0                  *:38064            *:*    users:(("rw-core",pid=252273,fd=9))                                                                                
udp   UNCONN 0      0                  *:58620            *:*    users:(("rw-core",pid=252273,fd=41))                                                                               
udp   UNCONN 0      0                  *:54632            *:*    users:(("rw-core",pid=252273,fd=24))                                                                               
udp   UNCONN 0      0               [::]:59810         [::]:*    users:(("amneziawg-go",pid=905,fd=15))                                                                             
udp   UNCONN 0      0                  *:443              *:*    users:(("rw-core",pid=252273,fd=7))                                                                                
udp   UNCONN 0      0                  *:34252            *:*    users:(("rw-core",pid=252273,fd=40))                                                                               
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 31382 bytes 4032007 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 31382 bytes 2767323 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 31382 bytes 1884088 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 66610341 bytes 45901641485 accept
		ct state related,established counter packets 187542047 bytes 134803149528 accept
		ct state invalid counter packets 17578 bytes 1061946 jump ufw-logging-deny
		ct state invalid counter packets 17578 bytes 1061946 drop
		...
		counter packets 1533005 bytes 205376725 jump ufw-not-local
		...
		counter packets 1533005 bytes 205376725 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 66610341 bytes 45901641485 accept
		ct state related,established counter packets 151037157 bytes 137227877592 accept
		counter packets 1742074 bytes 211015443 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4862598 bytes 3486913704 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 233060 bytes 13991984 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 59998 bytes 4679844 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2615 bytes 598187 jump ufw-skip-to-policy-input
		...
		udp dport 67 counter packets 29388 bytes 9051288 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 6 bytes 168 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 201061 bytes 73194491 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 31382 bytes 1478263 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 31382 bytes 3549075 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 31382 bytes 1884088 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 999593 bytes 60017371 accept
		ip protocol udp ct state new counter packets 722137 bytes 142956035 accept
	}
	...
	chain INPUT {
		...
		counter packets 255705254 bytes 180911346416 jump ufw-before-logging-input
		counter packets 255705254 bytes 180911346416 jump ufw-before-input
		counter packets 639739 bytes 104313867 jump ufw-after-input
		counter packets 345813 bytes 16749457 jump ufw-after-logging-input
		counter packets 345813 bytes 16749457 jump ufw-reject-input
		counter packets 345813 bytes 16749457 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 219389572 bytes 183340534520 jump ufw-before-logging-output
		counter packets 219389572 bytes 183340534520 jump ufw-before-output
		counter packets 1742074 bytes 211015443 jump ufw-after-output
		counter packets 1742074 bytes 211015443 jump ufw-after-logging-output
		counter packets 1742074 bytes 211015443 jump ufw-reject-output
		counter packets 1742074 bytes 211015443 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 6075753 bytes 3835016469 jump DOCKER-USER
		counter packets 6075753 bytes 3835016469 jump DOCKER-FORWARD
		...
		counter packets 5095658 bytes 3500905688 jump ufw-before-logging-forward
		counter packets 5095658 bytes 3500905688 jump ufw-before-forward
		counter packets 233060 bytes 13991984 jump ufw-after-forward
		counter packets 233060 bytes 13991984 jump ufw-after-logging-forward
		counter packets 233060 bytes 13991984 jump ufw-reject-forward
		counter packets 233060 bytes 13991984 jump ufw-track-forward
		iifname "wg-home" counter packets 233060 bytes 13991984 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 9268 bytes 540660 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 9268 bytes 540660 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 293926 bytes 87564410 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1235010 bytes 117700923 return
		fib daddr type multicast counter packets 5019 bytes 160608 return
		fib daddr type broadcast counter packets 292976 bytes 87515194 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 530792 bytes 30236493 accept
		tcp dport 80 counter packets 278374 bytes 15295652 accept
		tcp dport 52000 counter packets 476 bytes 27904 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1308 bytes 78480 accept
		udp dport 443 counter packets 82256 bytes 55419091 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-13 09:37:38 |
