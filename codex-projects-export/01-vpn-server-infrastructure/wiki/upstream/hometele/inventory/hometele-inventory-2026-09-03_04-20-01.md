...
Generated: 2026-09-03T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-138-generic #138-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 31 22:41:49 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:02 up 13 days, 59 min,  0 user,  load average: 0.01, 0.05, 0.02
```
...
udp   UNCONN 0      0           10.8.1.2:57524      0.0.0.0:*    users:(("xray",pid=971,fd=6829))                                                                                   
udp   UNCONN 0      0           10.8.1.2:40157      0.0.0.0:*    users:(("xray",pid=971,fd=2115))                                                                                   
udp   UNCONN 0      0           10.8.1.2:59649      0.0.0.0:*    users:(("xray",pid=971,fd=2916))                                                                                   
udp   UNCONN 0      0           10.8.1.2:40281      0.0.0.0:*    users:(("xray",pid=971,fd=6841))                                                                                   
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=971,fd=7))                                                                                      
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                                       
udp   UNCONN 0      0           10.8.1.2:46752      0.0.0.0:*    users:(("xray",pid=971,fd=6400))                                                                                   
...
udp   UNCONN 0      0           10.8.1.2:43801      0.0.0.0:*    users:(("xray",pid=971,fd=6880))                                                                                   
udp   UNCONN 0      0            0.0.0.0:53062      0.0.0.0:*    users:(("openvpn",pid=833,fd=4))                                                                                   
udp   UNCONN 0      0           10.8.1.2:43915      0.0.0.0:*    users:(("xray",pid=971,fd=3811))                                                                                   
udp   UNCONN 0      0           10.8.1.2:55179      0.0.0.0:*    users:(("xray",pid=971,fd=3413))                                                                                   
udp   UNCONN 0      0           10.8.1.2:43964      0.0.0.0:*    users:(("xray",pid=971,fd=2780))                                                                                   
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=216073,fd=7),("nginx",pid=216072,fd=7),("nginx",pid=216071,fd=7),("nginx",pid=216070,fd=7))    
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1609,fd=13))                                                                                  
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=216073,fd=9),("nginx",pid=216072,fd=9),("nginx",pid=216071,fd=9),("nginx",pid=216070,fd=9))    
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=216067,fd=3),("systemd",pid=1,fd=136))                                                          
tcp   LISTEN 0      32           0.0.0.0:21197      0.0.0.0:*    users:(("openvpn",pid=860,fd=5))                                                                                   
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=971,fd=3))                                                                                      
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=216073,fd=8),("nginx",pid=216072,fd=8),("nginx",pid=216071,fd=8),("nginx",pid=216070,fd=8))    
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=216073,fd=10),("nginx",pid=216072,fd=10),("nginx",pid=216071,fd=10),("nginx",pid=216070,fd=10))
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=216067,fd=4),("systemd",pid=1,fd=137))                                                          
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 56349 bytes 5858901 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 56349 bytes 11460959 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 26301 bytes 1588796 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 23887109 bytes 10854356906 accept
		ct state related,established counter packets 419832213 bytes 525688857792 accept
		ct state invalid counter packets 42919 bytes 2485239 jump ufw-logging-deny
		ct state invalid counter packets 42919 bytes 2485239 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3935 bytes 213856 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3441483 bytes 340439922 jump ufw-not-local
		...
		counter packets 3441483 bytes 340439922 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 23887109 bytes 10854356906 accept
		ct state related,established counter packets 323168024 bytes 321217392345 accept
		counter packets 3049906 bytes 1283773295 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 7420102 bytes 5050796993 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 173168 bytes 10405232 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 132374 bytes 10325161 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 6107 bytes 1398503 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 185 bytes 8616 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 996 bytes 47992 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 53148 bytes 16467842 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 2 bytes 56 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 329191 bytes 125228020 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 56349 bytes 2582756 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 56349 bytes 16942606 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 26303 bytes 1588900 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1856282 bytes 112796627 accept
		ip protocol udp ct state new counter packets 1171029 bytes 1168445361 accept
	}
	...
	chain INPUT {
		...
		counter packets 447207659 bytes 536886353715 jump ufw-before-logging-input
		counter packets 447207659 bytes 536886353715 jump ufw-before-input
		counter packets 1316897 bytes 214107062 jump ufw-after-input
		counter packets 794894 bytes 60630872 jump ufw-after-logging-input
		counter packets 794894 bytes 60630872 jump ufw-reject-input
		counter packets 794894 bytes 60630872 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 350105039 bytes 333355522546 jump ufw-before-logging-output
		counter packets 350105039 bytes 333355522546 jump ufw-before-output
		counter packets 3049906 bytes 1283773295 jump ufw-after-output
		counter packets 3049906 bytes 1283773295 jump ufw-after-logging-output
		counter packets 3049906 bytes 1283773295 jump ufw-reject-output
		counter packets 3049906 bytes 1283773295 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 7593270 bytes 5061202225 jump ufw-before-logging-forward
		counter packets 7593270 bytes 5061202225 jump ufw-before-forward
		counter packets 173168 bytes 10405232 jump ufw-after-forward
		counter packets 173168 bytes 10405232 jump ufw-after-logging-forward
		counter packets 173168 bytes 10405232 jump ufw-reject-forward
		counter packets 173168 bytes 10405232 jump ufw-track-forward
		iifname "wg-home" counter packets 173168 bytes 10405232 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 20591 bytes 1224666 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 20591 bytes 1224666 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 522003 bytes 153476190 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2911766 bytes 186740921 return
		fib daddr type multicast counter packets 9012 bytes 288384 return
		fib daddr type broadcast counter packets 520705 bytes 153410617 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1951516 bytes 116467579 accept
		tcp dport 80 counter packets 172744 bytes 9842696 accept
		tcp dport 52000 counter packets 228 bytes 12862 accept
		udp dport 21195 counter packets 1 bytes 439 accept
		udp dport 21196 counter packets 1 bytes 439 accept
		tcp dport 21197 counter packets 66 bytes 3660 accept
		udp dport 21198 counter packets 1 bytes 439 accept
		udp dport 21199 counter packets 1 bytes 439 accept
		udp dport 51820 counter packets 28 bytes 4307 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-09-03 04:19:54 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-03 01:04:08 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 312K
drwxr-xr-x  2 root root   4.0K Sep  3 03:20 .
drwxrwxr-x 16 root syslog 4.0K Sep  2 20:53 ..
