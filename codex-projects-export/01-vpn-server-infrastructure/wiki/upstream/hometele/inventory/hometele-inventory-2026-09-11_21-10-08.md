...
Generated: 2026-09-11T21:10:08+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 21:10:08 up 5 days, 17:49,  1 user,  load average: 0.04, 0.09, 0.13
```
...
udp   UNCONN 0      0                  *:52027            *:*    users:(("rw-core",pid=252273,fd=15))                                                                               
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 24819 bytes 3156992 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 24819 bytes 2196955 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 24819 bytes 1490132 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 50852512 bytes 35409337990 accept
		ct state related,established counter packets 151505917 bytes 109092187400 accept
		...
		ip protocol icmp icmp type echo-request counter packets 1803 bytes 90154 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1329375 bytes 171435601 jump ufw-not-local
		...
		counter packets 1329375 bytes 171435601 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 50852512 bytes 35409337990 accept
		ct state related,established counter packets 122027415 bytes 111535893587 accept
		counter packets 1528288 bytes 186736768 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 3700480 bytes 2626410503 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 184180 bytes 11057488 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 43551 bytes 3396978 jump ufw-skip-to-policy-input
		...
		udp dport 67 counter packets 23240 bytes 7157740 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 159119 bytes 57976246 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 24819 bytes 1160494 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 24819 bytes 2815550 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 24819 bytes 1490132 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 895942 bytes 53782675 accept
		ip protocol udp ct state new counter packets 614476 bytes 125766558 accept
	}
	...
	chain INPUT {
		...
		counter packets 203703761 bytes 144673917895 jump ufw-before-logging-input
		counter packets 203703761 bytes 144673917895 jump ufw-before-input
		counter packets 522419 bytes 83187985 jump ufw-after-input
		counter packets 293658 bytes 14134691 jump ufw-after-logging-input
		counter packets 293658 bytes 14134691 jump ufw-reject-input
		counter packets 293658 bytes 14134691 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 174408215 bytes 147131968345 jump ufw-before-logging-output
		counter packets 174408215 bytes 147131968345 jump ufw-before-output
		counter packets 1528288 bytes 186736768 jump ufw-after-output
		counter packets 1528288 bytes 186736768 jump ufw-after-logging-output
		counter packets 1528288 bytes 186736768 jump ufw-reject-output
		counter packets 1528288 bytes 186736768 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 4660533 bytes 2901760609 jump DOCKER-USER
		counter packets 4660533 bytes 2901760609 jump DOCKER-FORWARD
		...
		counter packets 3884660 bytes 2637467991 jump ufw-before-logging-forward
		counter packets 3884660 bytes 2637467991 jump ufw-before-forward
		counter packets 184180 bytes 11057488 jump ufw-after-forward
		counter packets 184180 bytes 11057488 jump ufw-after-logging-forward
		counter packets 184180 bytes 11057488 jump ufw-reject-forward
		counter packets 184180 bytes 11057488 jump ufw-track-forward
		iifname "wg-home" counter packets 184180 bytes 11057488 accept
	...
	chain ufw-skip-to-policy-input {
		counter packets 228761 bytes 69053294 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1097427 bytes 102295771 return
		fib daddr type multicast counter packets 3969 bytes 127008 return
		fib daddr type broadcast counter packets 227979 bytes 69012822 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 469574 bytes 26573807 accept
		tcp dport 80 counter packets 267497 bytes 14846420 accept
		tcp dport 52000 counter packets 315 bytes 18388 accept
		...
		udp dport 443 counter packets 68486 bytes 46742295 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-11 21:10:03 |
