...
Generated: 2026-09-15T04:20:03+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:03 up 9 days, 59 min,  0 user,  load average: 0.24, 0.05, 0.02
```
...
udp   UNCONN 0      0                  *:53496            *:*    users:(("rw-core",pid=252273,fd=9))                                                                                
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 39069 bytes 5145656 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 39069 bytes 3360111 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 39069 bytes 2345612 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 89263431 bytes 69234415179 accept
		ct state related,established counter packets 241217525 bytes 188371293706 accept
		ct state invalid counter packets 21900 bytes 1346230 jump ufw-logging-deny
		ct state invalid counter packets 21900 bytes 1346230 drop
		...
		ip protocol icmp icmp type echo-request counter packets 2743 bytes 138421 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1843162 bytes 260646385 jump ufw-not-local
		...
		counter packets 1843162 bytes 260646385 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 89263431 bytes 69234415179 accept
		ct state related,established counter packets 192744347 bytes 192121255645 accept
		counter packets 2757526 bytes 323269087 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6167748 bytes 4416527597 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 290383 bytes 17433396 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 84055 bytes 6556290 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3186 bytes 728919 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 134 bytes 6384 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 906 bytes 42256 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 36854 bytes 11419966 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 8 bytes 224 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 250949 bytes 91172806 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 39069 bytes 1852864 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 39069 bytes 4330978 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 39069 bytes 2345612 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1694333 bytes 101741703 accept
		ip protocol udp ct state new counter packets 1032910 bytes 209280717 accept
	}
	...
	chain INPUT {
		...
		counter packets 332348761 bytes 257867839921 jump ufw-before-logging-input
		counter packets 332348761 bytes 257867839921 jump ufw-before-input
		counter packets 788716 bytes 129934691 jump ufw-after-input
		counter packets 412624 bytes 20007846 jump ufw-after-logging-input
		counter packets 412624 bytes 20007846 jump ufw-reject-input
		counter packets 412624 bytes 20007846 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 284765304 bytes 261678939911 jump ufw-before-logging-output
		counter packets 284765304 bytes 261678939911 jump ufw-before-output
		counter packets 2757526 bytes 323269087 jump ufw-after-output
		counter packets 2757526 bytes 323269087 jump ufw-after-logging-output
		counter packets 2757526 bytes 323269087 jump ufw-reject-output
		counter packets 2757526 bytes 323269087 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 7677641 bytes 4850591667 jump DOCKER-USER
		counter packets 7677641 bytes 4850591667 jump DOCKER-FORWARD
		...
		counter packets 6458131 bytes 4433960993 jump ufw-before-logging-forward
		counter packets 6458131 bytes 4433960993 jump ufw-before-forward
		counter packets 290383 bytes 17433396 jump ufw-after-forward
		counter packets 290383 bytes 17433396 jump ufw-after-logging-forward
		counter packets 290383 bytes 17433396 jump ufw-reject-forward
		counter packets 290383 bytes 17433396 jump ufw-track-forward
		iifname "wg-home" counter packets 290383 bytes 17433396 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 11876 bytes 706335 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 11876 bytes 706335 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 376092 bytes 109926845 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1461967 bytes 150578500 return
		fib daddr type multicast counter packets 6249 bytes 199968 return
		fib daddr type broadcast counter packets 374946 bytes 109867917 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 652581 bytes 37553585 accept
		tcp dport 80 counter packets 290817 bytes 15811887 accept
		tcp dport 52000 counter packets 503 bytes 29488 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 67 bytes 3832 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1628 bytes 97680 accept
		udp dport 443 counter packets 108839 bytes 77212768 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 9 days (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
remnanode   remnawave/node:3.4.1         Up 9 days             
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-15 04:19:56 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-14 19:40:17 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 372K
drwxr-xr-x  2 root root   4.0K Sep 15 03:20 .
