...
Generated: 2026-09-17T04:20:04+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:04 up 11 days, 59 min,  0 user,  load average: 0.08, 0.02, 0.01
```
...
udp   UNCONN 0      0                  *:51151            *:*    users:(("rw-core",pid=1619407,fd=10))                                                                                  
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 47709 bytes 6511824 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 47709 bytes 3959514 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 47709 bytes 2864316 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 110365508 bytes 89004697366 accept
		ct state related,established counter packets 288691604 bytes 228918317778 accept
		ct state invalid counter packets 25532 bytes 1554478 jump ufw-logging-deny
		ct state invalid counter packets 25532 bytes 1554478 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3542 bytes 193776 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2316824 bytes 354175003 jump ufw-not-local
		...
		counter packets 2316824 bytes 354175003 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 110365508 bytes 89004697366 accept
		ct state related,established counter packets 228544378 bytes 233632683665 accept
		counter packets 2907853 bytes 338099323 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 7436789 bytes 5329786704 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 354857 bytes 21304044 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 106893 bytes 8337654 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3887 bytes 889394 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 164 bytes 7816 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1176 bytes 54548 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 44947 bytes 13912574 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 9 bytes 252 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 305396 bytes 111131597 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 47709 bytes 2254002 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 47709 bytes 5058006 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 47709 bytes 2864316 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1754968 bytes 105388181 accept
		ip protocol udp ct state new counter packets 1120782 bytes 220031191 accept
	}
	...
	chain INPUT {
		...
		counter packets 401403010 bytes 318278938401 jump ufw-before-logging-input
		counter packets 401403010 bytes 318278938401 jump ufw-before-input
		counter packets 1058222 bytes 185763539 jump ufw-after-input
		counter packets 595750 bytes 51429704 jump ufw-after-logging-input
		counter packets 595750 bytes 51429704 jump ufw-reject-input
		counter packets 595750 bytes 51429704 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 341817739 bytes 322975480354 jump ufw-before-logging-output
		counter packets 341817739 bytes 322975480354 jump ufw-before-output
		counter packets 2907853 bytes 338099323 jump ufw-after-output
		counter packets 2907853 bytes 338099323 jump ufw-after-logging-output
		counter packets 2907853 bytes 338099323 jump ufw-reject-output
		counter packets 2907853 bytes 338099323 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 586137 bytes 357580381 jump DOCKER-USER
		counter packets 586137 bytes 357580381 jump DOCKER-FORWARD
		...
		counter packets 7791646 bytes 5351090748 jump ufw-before-logging-forward
		counter packets 7791646 bytes 5351090748 jump ufw-before-forward
		counter packets 354857 bytes 21304044 jump ufw-after-forward
		counter packets 354857 bytes 21304044 jump ufw-after-logging-forward
		counter packets 354857 bytes 21304044 jump ufw-reject-forward
		counter packets 354857 bytes 21304044 jump ufw-track-forward
		iifname "wg-home" counter packets 354857 bytes 21304044 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 14167 bytes 837755 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 14167 bytes 837755 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 462472 bytes 134333835 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1848191 bytes 219671938 return
		fib daddr type multicast counter packets 7632 bytes 244224 return
		fib daddr type broadcast counter packets 461001 bytes 134258841 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 808585 bytes 46449596 accept
		tcp dport 80 counter packets 304717 bytes 16375748 accept
		tcp dport 52000 counter packets 612 bytes 35896 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 79 bytes 4512 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1941 bytes 116460 accept
		udp dport 443 counter packets 142652 bytes 105424772 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 586137 bytes 357580381 jump DOCKER-CT
		counter packets 539094 bytes 332061813 jump DOCKER-INTERNAL
		counter packets 539094 bytes 332061813 jump DOCKER-BRIDGE
```
...
headscale   headscale/headscale:0.29.3   Up 19 hours (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
remnanode   remnawave/node:3.4.1         Up 19 hours             
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-17 04:19:59 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-16 19:42:50 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 380K
drwxr-xr-x  2 root root   4.0K Sep 17 03:20 .
