...
Generated: 2026-09-18T04:20:04+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:04 up 12 days, 59 min,  0 user,  load average: 0.03, 0.03, 0.00
```
...
udp   UNCONN 0      0                  *:58965            *:*    users:(("rw-core",pid=1619407,fd=9))                                                                                   
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=788221,fd=3),("systemd",pid=1,fd=194))                                                              
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=788221,fd=4),("systemd",pid=1,fd=195))                                                              
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 52029 bytes 7044886 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 52029 bytes 4244377 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 52029 bytes 3123740 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 122181853 bytes 97910531546 accept
		ct state related,established counter packets 315391432 bytes 248229785950 accept
		ct state invalid counter packets 26390 bytes 1605707 jump ufw-logging-deny
		ct state invalid counter packets 26390 bytes 1605707 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3920 bytes 213823 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2521991 bytes 380641622 jump ufw-not-local
		...
		counter packets 2521991 bytes 380641622 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 122181853 bytes 97910531546 accept
		ct state related,established counter packets 249102465 bytes 253517460591 accept
		counter packets 2947374 bytes 341004341 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 7910763 bytes 5661397793 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 386880 bytes 23226512 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 107388 bytes 8376264 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 4229 bytes 967685 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 177 bytes 8416 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1325 bytes 61096 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 48992 bytes 15158398 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 10 bytes 280 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 332460 bytes 120956259 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 52029 bytes 2453852 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 52029 bytes 5379879 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 52029 bytes 3123740 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1760035 bytes 105699933 accept
		ip protocol udp ct state new counter packets 1154719 bytes 222579009 accept
	}
	...
	chain INPUT {
		...
		counter packets 440125586 bytes 346522778648 jump ufw-before-logging-input
		counter packets 440125586 bytes 346522778648 jump ufw-before-input
		counter packets 1131423 bytes 199003571 jump ufw-after-input
		counter packets 636842 bytes 53475173 jump ufw-after-logging-input
		counter packets 636842 bytes 53475173 jump ufw-reject-input
		counter packets 636842 bytes 53475173 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 374231692 bytes 351768996478 jump ufw-before-logging-output
		counter packets 374231692 bytes 351768996478 jump ufw-before-output
		counter packets 2947374 bytes 341004341 jump ufw-after-output
		counter packets 2947374 bytes 341004341 jump ufw-after-logging-output
		counter packets 2947374 bytes 341004341 jump ufw-reject-output
		counter packets 2947374 bytes 341004341 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1226585 bytes 737098100 jump DOCKER-USER
		counter packets 1226585 bytes 737098100 jump DOCKER-FORWARD
		...
		counter packets 8297643 bytes 5684624305 jump ufw-before-logging-forward
		counter packets 8297643 bytes 5684624305 jump ufw-before-forward
		counter packets 386880 bytes 23226512 jump ufw-after-forward
		counter packets 386880 bytes 23226512 jump ufw-after-logging-forward
		counter packets 386880 bytes 23226512 jump ufw-reject-forward
		counter packets 386880 bytes 23226512 jump ufw-track-forward
		iifname "wg-home" counter packets 386880 bytes 23226512 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 14769 bytes 876380 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 14769 bytes 876380 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 494581 bytes 145528398 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2020732 bytes 234930234 return
		fib daddr type multicast counter packets 8323 bytes 266336 return
		fib daddr type broadcast counter packets 492936 bytes 145445052 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 917735 bytes 52569313 accept
		tcp dport 80 counter packets 318044 bytes 17041592 accept
		tcp dport 52000 counter packets 614 bytes 36016 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 80 bytes 4572 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2067 bytes 124020 accept
		udp dport 443 counter packets 152012 bytes 111858058 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 1226585 bytes 737098100 jump DOCKER-CT
		counter packets 1120889 bytes 679753316 jump DOCKER-INTERNAL
		counter packets 1120889 bytes 679753316 jump DOCKER-BRIDGE
```
...
headscale   headscale/headscale:0.29.3   Up 43 hours (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
remnanode   remnawave/node:3.4.1         Up 43 hours             
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-18 04:19:43 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-17 22:28:05 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 384K
drwxr-xr-x  2 root root   4.0K Sep 18 03:20 .
