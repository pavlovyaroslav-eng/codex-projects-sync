...
Generated: 2026-09-11T21:27:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 21:27:01 up 5 days, 18:06,  1 user,  load average: 0.18, 0.21, 0.19
```
...
udp   UNCONN 0      0                  *:37477            *:*    users:(("rw-core",pid=252273,fd=100))                                                                              
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                                                                       
udp   UNCONN 0      0                  *:60042            *:*    users:(("rw-core",pid=252273,fd=91))                                                                               
udp   UNCONN 0      0                  *:45870            *:*    users:(("rw-core",pid=252273,fd=101))                                                                              
udp   UNCONN 0      0                  *:48975            *:*    users:(("rw-core",pid=252273,fd=77))                                                                               
udp   UNCONN 0      0                  *:32802            *:*    users:(("rw-core",pid=252273,fd=15))                                                                               
udp   UNCONN 0      0                  *:41026            *:*    users:(("rw-core",pid=252273,fd=60))                                                                               
udp   UNCONN 0      0                  *:55378            *:*    users:(("rw-core",pid=252273,fd=68))                                                                               
udp   UNCONN 0      0                  *:44138            *:*    users:(("rw-core",pid=252273,fd=10))                                                                               
udp   UNCONN 0      0                  *:32883            *:*    users:(("rw-core",pid=252273,fd=72))                                                                               
udp   UNCONN 0      0                  *:57641            *:*    users:(("rw-core",pid=252273,fd=26))                                                                               
...
udp   UNCONN 0      0                  *:42494            *:*    users:(("rw-core",pid=252273,fd=103))                                                                              
udp   UNCONN 0      0                  *:49715            *:*    users:(("rw-core",pid=252273,fd=58))                                                                               
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 24870 bytes 3163775 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 24870 bytes 2203119 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 24869 bytes 1493132 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 51313325 bytes 35680509526 accept
		ct state related,established counter packets 152837197 bytes 110223406258 accept
		ct state invalid counter packets 14196 bytes 869319 jump ufw-logging-deny
		ct state invalid counter packets 14196 bytes 869319 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1817 bytes 91036 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1331068 bytes 171729669 jump ufw-not-local
		...
		counter packets 1331068 bytes 171729669 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 51313325 bytes 35680509526 accept
		ct state related,established counter packets 123029206 bytes 112654884879 accept
		counter packets 1530775 bytes 187116163 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 3701025 bytes 2626531527 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 184536 bytes 11078848 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 43747 bytes 3412266 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2139 bytes 489237 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 95 bytes 4604 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 615 bytes 29036 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 23288 bytes 7172524 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 159459 bytes 58094006 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 24869 bytes 1162766 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 24870 bytes 2822533 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 24869 bytes 1493132 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 897066 bytes 53850115 accept
		ip protocol udp ct state new counter packets 615794 bytes 126056341 accept
	}
	...
	chain INPUT {
		...
		counter packets 205497603 bytes 146076605808 jump ufw-before-logging-input
		counter packets 205497603 bytes 146076605808 jump ufw-before-input
		counter packets 523386 bytes 83354849 jump ufw-after-input
		counter packets 294038 bytes 14153036 jump ufw-after-logging-input
		counter packets 294038 bytes 14153036 jump ufw-reject-input
		counter packets 294038 bytes 14153036 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 175873306 bytes 148522510568 jump ufw-before-logging-output
		counter packets 175873306 bytes 148522510568 jump ufw-before-output
		counter packets 1530775 bytes 187116163 jump ufw-after-output
		counter packets 1530775 bytes 187116163 jump ufw-after-logging-output
		counter packets 1530775 bytes 187116163 jump ufw-reject-output
		counter packets 1530775 bytes 187116163 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 4663021 bytes 2902428575 jump DOCKER-USER
		counter packets 4663021 bytes 2902428575 jump DOCKER-FORWARD
		...
		counter packets 3885561 bytes 2637610375 jump ufw-before-logging-forward
		counter packets 3885561 bytes 2637610375 jump ufw-before-forward
		counter packets 184536 bytes 11078848 jump ufw-after-forward
		counter packets 184536 bytes 11078848 jump ufw-after-logging-forward
		counter packets 184536 bytes 11078848 jump ufw-reject-forward
		counter packets 184536 bytes 11078848 jump ufw-track-forward
		iifname "wg-home" counter packets 184536 bytes 11078848 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7464 bytes 440949 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7464 bytes 440949 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 229348 bytes 69201813 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1098526 bytes 102441142 return
		fib daddr type multicast counter packets 3977 bytes 127264 return
		fib daddr type broadcast counter packets 228565 bytes 69161263 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 470073 bytes 26604100 accept
		tcp dport 80 counter packets 267574 bytes 14849520 accept
		tcp dport 52000 counter packets 337 bytes 19708 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1030 bytes 61800 accept
		udp dport 443 counter packets 68611 bytes 46834606 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-11 21:26:36 |
