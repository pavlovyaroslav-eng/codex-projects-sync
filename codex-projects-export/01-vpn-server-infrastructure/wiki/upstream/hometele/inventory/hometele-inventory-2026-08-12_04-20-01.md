...
Generated: 2026-08-12T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-137-generic #137-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 17 20:28:23 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 4 days, 59 min,  0 user,  load average: 0.00, 0.01, 0.00
```
...
udp   UNCONN 0      0           10.8.1.2:54682      0.0.0.0:*    users:(("xray",pid=67822,fd=173))                                                                              
udp   UNCONN 0      0           10.8.1.2:52708      0.0.0.0:*    users:(("xray",pid=67822,fd=134))                                                                              
udp   UNCONN 0      0           10.8.1.2:38426      0.0.0.0:*    users:(("xray",pid=67822,fd=21))                                                                               
udp   UNCONN 0      0           10.8.1.2:56866      0.0.0.0:*    users:(("xray",pid=67822,fd=105))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:60022      0.0.0.0:*    users:(("xray",pid=67822,fd=164))                                                                              
udp   UNCONN 0      0           10.8.1.2:43665      0.0.0.0:*    users:(("xray",pid=67822,fd=91))                                                                               
udp   UNCONN 0      0           10.8.1.2:45716      0.0.0.0:*    users:(("xray",pid=67822,fd=185))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:39783      0.0.0.0:*    users:(("xray",pid=67822,fd=64))                                                                               
udp   UNCONN 0      0            0.0.0.0:42910      0.0.0.0:*    users:(("openvpn",pid=827,fd=4))                                                                               
udp   UNCONN 0      0           10.8.1.2:39843      0.0.0.0:*    users:(("xray",pid=67822,fd=271))                                                                              
udp   UNCONN 0      0           10.8.1.2:49166      0.0.0.0:*    users:(("xray",pid=67822,fd=158))                                                                              
udp   UNCONN 0      0           10.8.1.2:46125      0.0.0.0:*    users:(("xray",pid=67822,fd=188))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:50237      0.0.0.0:*    users:(("xray",pid=67822,fd=49))                                                                               
udp   UNCONN 0      0           10.8.1.2:49242      0.0.0.0:*    users:(("xray",pid=67822,fd=190))                                                                              
udp   UNCONN 0      0           10.8.1.2:33961      0.0.0.0:*    users:(("xray",pid=67822,fd=33))                                                                               
udp   UNCONN 0      0           10.8.1.2:42209      0.0.0.0:*    users:(("xray",pid=67822,fd=124))                                                                              
udp   UNCONN 0      0           10.8.1.2:58624      0.0.0.0:*    users:(("xray",pid=67822,fd=54))                                                                               
udp   UNCONN 0      0           10.8.1.2:34109      0.0.0.0:*    users:(("xray",pid=67822,fd=179))                                                                              
udp   UNCONN 0      0           10.8.1.2:59710      0.0.0.0:*    users:(("xray",pid=67822,fd=28))                                                                               
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=73803,fd=3),("systemd",pid=1,fd=125))                                                       
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=74104,fd=13))                                                                             
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=73803,fd=4),("systemd",pid=1,fd=126))                                                       
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 17469 bytes 1880876 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 17469 bytes 3188221 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 3344 bytes 206116 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 9041092 bytes 4146114422 accept
		ct state related,established counter packets 135266397 bytes 163200341097 accept
		ct state invalid counter packets 32664 bytes 1557976 jump ufw-logging-deny
		ct state invalid counter packets 32664 bytes 1557976 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1270 bytes 63422 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1064661 bytes 98339535 jump ufw-not-local
		...
		counter packets 1064661 bytes 98339535 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 9041092 bytes 4146114422 accept
		ct state related,established counter packets 111264454 bytes 98241950991 accept
		counter packets 890012 bytes 354122000 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 2253644 bytes 1512308683 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 14218 bytes 858684 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 3662 bytes 285636 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2920 bytes 668680 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 48 bytes 2200 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 311 bytes 14968 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 16356 bytes 5037090 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 102508 bytes 38898825 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 17469 bytes 869805 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 17469 bytes 4746340 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 3346 bytes 206220 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 550727 bytes 33439789 accept
		ip protocol udp ct state new counter packets 330326 bytes 319847015 accept
	}
	...
	chain INPUT {
		...
		counter packets 145406084 bytes 167446416452 jump ufw-before-logging-input
		counter packets 145406084 bytes 167446416452 jump ufw-before-input
		counter packets 326799 bytes 55247709 jump ufw-after-input
		counter packets 200994 bytes 10340310 jump ufw-after-logging-input
		counter packets 200994 bytes 10340310 jump ufw-reject-input
		counter packets 200994 bytes 10340310 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 121195558 bytes 102742187413 jump ufw-before-logging-output
		counter packets 121195558 bytes 102742187413 jump ufw-before-output
		counter packets 890012 bytes 354122000 jump ufw-after-output
		counter packets 890012 bytes 354122000 jump ufw-after-logging-output
		counter packets 890012 bytes 354122000 jump ufw-reject-output
		counter packets 890012 bytes 354122000 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 2267862 bytes 1513167367 jump ufw-before-logging-forward
		counter packets 2267862 bytes 1513167367 jump ufw-before-forward
		counter packets 14218 bytes 858684 jump ufw-after-forward
		counter packets 14218 bytes 858684 jump ufw-after-logging-forward
		counter packets 14218 bytes 858684 jump ufw-reject-forward
		counter packets 14218 bytes 858684 jump ufw-track-forward
		iifname "wg-home" counter packets 14218 bytes 858684 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 10421 bytes 502881 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 10421 bytes 502881 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 125805 bytes 44907399 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 936443 bytes 53361514 return
		fib daddr type multicast counter packets 2794 bytes 89408 return
		fib daddr type broadcast counter packets 125424 bytes 44888613 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 736080 bytes 42991588 accept
		tcp dport 80 counter packets 1664 bytes 91728 accept
		tcp dport 52000 counter packets 86 bytes 5008 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-12 04:19:54 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-12 02:30:57 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 204K
drwxr-xr-x  2 root root   4.0K Aug 12 03:20 .
