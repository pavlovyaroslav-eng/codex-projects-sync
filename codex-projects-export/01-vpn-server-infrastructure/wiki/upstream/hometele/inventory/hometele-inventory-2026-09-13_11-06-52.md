...
Generated: 2026-09-13T11:06:52+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 11:06:52 up 7 days,  7:46,  2 users,  load average: 0.07, 0.13, 0.10
```
...
udp   UNCONN 0      0                  *:40600            *:*    users:(("rw-core",pid=252273,fd=108))                                                                              
udp   UNCONN 0      0                  *:47795            *:*    users:(("rw-core",pid=252273,fd=54))                                                                               
udp   UNCONN 0      0                  *:53971            *:*    users:(("rw-core",pid=252273,fd=130))                                                                              
udp   UNCONN 0      0                  *:45805            *:*    users:(("rw-core",pid=252273,fd=91))                                                                               
udp   UNCONN 0      0                  *:57149            *:*    users:(("rw-core",pid=252273,fd=81))                                                                               
udp   UNCONN 0      0                  *:60321            *:*    users:(("rw-core",pid=252273,fd=104))                                                                              
udp   UNCONN 0      0                  *:35827            *:*    users:(("rw-core",pid=252273,fd=97))                                                                               
udp   UNCONN 0      0                  *:38064            *:*    users:(("rw-core",pid=252273,fd=9))                                                                                
udp   UNCONN 0      0                  *:56536            *:*    users:(("rw-core",pid=252273,fd=111))                                                                              
udp   UNCONN 0      0               [::]:59810         [::]:*    users:(("amneziawg-go",pid=905,fd=15))                                                                             
udp   UNCONN 0      0                  *:443              *:*    users:(("rw-core",pid=252273,fd=7))                                                                                
udp   UNCONN 0      0                  *:44503            *:*    users:(("rw-core",pid=252273,fd=106))                                                                              
udp   UNCONN 0      0                  *:48608            *:*    users:(("rw-core",pid=252273,fd=35))                                                                               
udp   UNCONN 0      0                  *:51719            *:*    users:(("rw-core",pid=252273,fd=80))                                                                               
udp   UNCONN 0      0                  *:39436            *:*    users:(("rw-core",pid=252273,fd=58))                                                                               
udp   UNCONN 0      0                  *:33299            *:*    users:(("rw-core",pid=252273,fd=103))                                                                              
udp   UNCONN 0      0                  *:38429            *:*    users:(("rw-core",pid=252273,fd=22))                                                                               
udp   UNCONN 0      0                  *:49694            *:*    users:(("rw-core",pid=252273,fd=116))                                                                              
udp   UNCONN 0      0                  *:49717            *:*    users:(("rw-core",pid=252273,fd=114))                                                                              
udp   UNCONN 0      0                  *:56890            *:*    users:(("rw-core",pid=252273,fd=99))                                                                               
udp   UNCONN 0      0                  *:55872            *:*    users:(("rw-core",pid=252273,fd=88))                                                                               
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=788221,fd=3),("systemd",pid=1,fd=166))                                                          
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=788221,fd=4),("systemd",pid=1,fd=167))                                                          
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 31649 bytes 4063937 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 31649 bytes 2790361 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 31649 bytes 1900140 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 67422813 bytes 46820838800 accept
		ct state related,established counter packets 189692368 bytes 136919803434 accept
		ct state invalid counter packets 17633 bytes 1064482 jump ufw-logging-deny
		ct state invalid counter packets 17633 bytes 1064482 drop
		...
		ip protocol icmp icmp type echo-request counter packets 2298 bytes 117359 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1540787 bytes 206861691 jump ufw-not-local
		...
		counter packets 1540787 bytes 206861691 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 67422813 bytes 46820838800 accept
		ct state related,established counter packets 152677055 bytes 139360779801 accept
		counter packets 1753380 bytes 212501869 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4872240 bytes 3491727024 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 235008 bytes 14108944 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 60312 bytes 4704336 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2636 bytes 602996 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 117 bytes 5608 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 747 bytes 35096 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 29637 bytes 9127980 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 6 bytes 168 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 202913 bytes 73842900 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 31649 bytes 1491316 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 31649 bytes 3582847 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 31649 bytes 1900140 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1004525 bytes 60313299 accept
		ip protocol udp ct state new counter packets 728263 bytes 144016543 accept
	}
	...
	chain INPUT {
		...
		counter packets 258675901 bytes 183948688322 jump ufw-before-logging-input
		counter packets 258675901 bytes 183948688322 jump ufw-before-input
		counter packets 644479 bytes 105177630 jump ufw-after-input
		counter packets 348111 bytes 16858546 jump ufw-after-logging-input
		counter packets 348111 bytes 16858546 jump ufw-reject-input
		counter packets 348111 bytes 16858546 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 221853248 bytes 186394120470 jump ufw-before-logging-output
		counter packets 221853248 bytes 186394120470 jump ufw-before-output
		counter packets 1753380 bytes 212501869 jump ufw-after-output
		counter packets 1753380 bytes 212501869 jump ufw-after-logging-output
		counter packets 1753380 bytes 212501869 jump ufw-reject-output
		counter packets 1753380 bytes 212501869 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 6095666 bytes 3842838794 jump DOCKER-USER
		counter packets 6095666 bytes 3842838794 jump DOCKER-FORWARD
		...
		counter packets 5107248 bytes 3505835968 jump ufw-before-logging-forward
		counter packets 5107248 bytes 3505835968 jump ufw-before-forward
		counter packets 235008 bytes 14108944 jump ufw-after-forward
		counter packets 235008 bytes 14108944 jump ufw-after-logging-forward
		counter packets 235008 bytes 14108944 jump ufw-reject-forward
		counter packets 235008 bytes 14108944 jump ufw-track-forward
		iifname "wg-home" counter packets 235008 bytes 14108944 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 9323 bytes 543196 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 9323 bytes 543196 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 296368 bytes 88319084 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1240313 bytes 118430111 return
		fib daddr type multicast counter packets 5062 bytes 161984 return
		fib daddr type broadcast counter packets 295412 bytes 88269596 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 532606 bytes 30343717 accept
		tcp dport 80 counter packets 278806 bytes 15313200 accept
		tcp dport 52000 counter packets 487 bytes 28564 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 49 bytes 2784 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1318 bytes 79080 accept
		udp dport 443 counter packets 83031 bytes 55914262 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 7 days (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-13 05:55:16 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
drwxrwxr-x 15 root syslog 4.0K Sep 13 00:00 ..
