...
Generated: 2026-07-13T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-124-generic #124-Ubuntu SMP PREEMPT_DYNAMIC Tue May 26 13:00:45 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:02 up 12 days,  4:07,  0 user,  load average: 0.04, 0.03, 0.00
```
...
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=193019,fd=7))                                                                                   
...
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=193019,fd=6))                                                                                   
...
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=193054,fd=9),("nginx",pid=193053,fd=9),("nginx",pid=193052,fd=9),("nginx",pid=193051,fd=9))    
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=15))                                                                          
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=193347,fd=13))                                                                                
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=193054,fd=7),("nginx",pid=193053,fd=7),("nginx",pid=193052,fd=7),("nginx",pid=193051,fd=7))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1275,fd=4),("systemd",pid=1,fd=148))                                                            
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=193019,fd=3))                                                                                   
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=193054,fd=10),("nginx",pid=193053,fd=10),("nginx",pid=193052,fd=10),("nginx",pid=193051,fd=10))
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=193054,fd=8),("nginx",pid=193053,fd=8),("nginx",pid=193052,fd=8),("nginx",pid=193051,fd=8))    
```
...
table ip6 filter {
	...
	chain ufw6-before-output {
		...
		meta l4proto ipv6-icmp icmpv6 type echo-request counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type echo-reply counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type nd-router-solicit ip6 hoplimit 255 counter packets 2043 bytes 100400 accept
		meta l4proto ipv6-icmp icmpv6 type nd-neighbor-advert ip6 hoplimit 255 counter packets 0 bytes 0 accept
	...
	chain OUTPUT {
		...
		counter packets 2048 bytes 100776 jump ufw6-before-logging-output
		counter packets 2048 bytes 100776 jump ufw6-before-output
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-13 04:19:34 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-12 15:21:42 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
