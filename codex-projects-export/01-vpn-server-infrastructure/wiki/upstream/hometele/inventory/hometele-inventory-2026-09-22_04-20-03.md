...
Generated: 2026-09-22T04:20:03+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:03 up 16 days, 59 min,  0 user,  load average: 0.03, 0.07, 0.03
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 69309 bytes 9444524 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 69309 bytes 5389640 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 69309 bytes 4161276 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 161314405 bytes 130143695888 accept
		ct state related,established counter packets 418747958 bytes 325473108484 accept
		ct state invalid counter packets 37005 bytes 2262413 jump ufw-logging-deny
		ct state invalid counter packets 37005 bytes 2262413 drop
		...
		ip protocol icmp icmp type echo-request counter packets 6102 bytes 334559 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3313131 bytes 489784125 jump ufw-not-local
		...
		counter packets 3313131 bytes 489784125 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 161314405 bytes 130143695888 accept
		ct state related,established counter packets 325367095 bytes 331775294261 accept
		counter packets 3125086 bytes 353850602 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 11027525 bytes 7908734841 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 515861 bytes 30978980 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 110430 bytes 8613540 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 5667 bytes 1296879 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 228 bytes 10716 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1870 bytes 85780 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 65180 bytes 20144158 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 14 bytes 392 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 445110 bytes 161426466 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 69309 bytes 3259551 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 69309 bytes 6665290 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 69309 bytes 4161276 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1796115 bytes 107890143 accept
		ip protocol udp ct state new counter packets 1293655 bytes 232989070 accept
	}
	...
	chain INPUT {
		...
		counter packets 583418601 bytes 456109185469 jump ufw-before-logging-input
		counter packets 583418601 bytes 456109185469 jump ufw-before-input
		counter packets 1426587 bytes 252741887 jump ufw-after-input
		counter packets 798088 bytes 61163956 jump ufw-after-logging-input
		counter packets 798088 bytes 61163956 jump ufw-reject-input
		counter packets 798088 bytes 61163956 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 489806586 bytes 462272840751 jump ufw-before-logging-output
		counter packets 489806586 bytes 462272840751 jump ufw-before-output
		counter packets 3125086 bytes 353850602 jump ufw-after-output
		counter packets 3125086 bytes 353850602 jump ufw-after-logging-output
		counter packets 3125086 bytes 353850602 jump ufw-reject-output
		counter packets 3125086 bytes 353850602 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 5011726 bytes 3175841467 jump DOCKER-USER
		counter packets 5011726 bytes 3175841467 jump DOCKER-FORWARD
		...
		counter packets 11543386 bytes 7939713821 jump ufw-before-logging-forward
		counter packets 11543386 bytes 7939713821 jump ufw-before-forward
		counter packets 515861 bytes 30978980 jump ufw-after-forward
		counter packets 515861 bytes 30978980 jump ufw-after-logging-forward
		counter packets 515861 bytes 30978980 jump ufw-reject-forward
		counter packets 515861 bytes 30978980 jump ufw-track-forward
		iifname "wg-home" counter packets 515861 bytes 30978980 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 17875 bytes 1084926 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 17875 bytes 1084926 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 628499 bytes 191577931 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2675829 bytes 297966212 return
		fib daddr type multicast counter packets 11088 bytes 354816 return
		fib daddr type broadcast counter packets 626214 bytes 191463097 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1221622 bytes 70107085 accept
		tcp dport 80 counter packets 465317 bytes 25136395 accept
		tcp dport 52000 counter packets 645 bytes 37740 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 91 bytes 5188 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2625 bytes 157500 accept
		udp dport 443 counter packets 196227 bytes 141593674 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 5011726 bytes 3175841467 jump DOCKER-CT
		counter packets 4671027 bytes 2991472123 jump DOCKER-INTERNAL
		counter packets 4671027 bytes 2991472123 jump DOCKER-BRIDGE
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-22 04:20:04 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-22 03:14:53 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 408K
drwxr-xr-x  2 root root   4.0K Sep 22 03:20 .
drwxrwxr-x 15 root syslog 4.0K Sep 21 00:00 ..
