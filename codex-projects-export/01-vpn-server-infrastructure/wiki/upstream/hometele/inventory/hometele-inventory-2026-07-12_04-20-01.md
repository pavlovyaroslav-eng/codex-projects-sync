...
Generated: 2026-07-12T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-124-generic #124-Ubuntu SMP PREEMPT_DYNAMIC Tue May 26 13:00:45 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 11 days,  4:07,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0          10.79.0.2:50591      0.0.0.0:*    users:(("xray",pid=175416,fd=104))                                                                                 
udp   UNCONN 0      0          10.79.0.2:37361      0.0.0.0:*    users:(("xray",pid=175416,fd=106))                                                                                 
udp   UNCONN 0      0          10.79.0.2:37378      0.0.0.0:*    users:(("xray",pid=175416,fd=91))                                                                                  
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=175416,fd=7))                                                                                   
...
udp   UNCONN 0      0          10.79.0.2:59141      0.0.0.0:*    users:(("xray",pid=175416,fd=100))                                                                                 
udp   UNCONN 0      0          10.79.0.2:56166      0.0.0.0:*    users:(("xray",pid=175416,fd=103))                                                                                 
udp   UNCONN 0      0          10.79.0.2:51104      0.0.0.0:*    users:(("xray",pid=175416,fd=143))                                                                                 
...
udp   UNCONN 0      0          10.79.0.2:53429      0.0.0.0:*    users:(("xray",pid=175416,fd=82))                                                                                  
udp   UNCONN 0      0          10.79.0.2:54498      0.0.0.0:*    users:(("xray",pid=175416,fd=142))                                                                                 
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                                                                       
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=175416,fd=6))                                                                                   
tcp   LISTEN 0      4096      127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=17))                                                                          
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=1275,fd=3),("systemd",pid=1,fd=147))                                                            
tcp   LISTEN 0      32           0.0.0.0:21197      0.0.0.0:*    users:(("openvpn",pid=849,fd=5))                                                                                   
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=175441,fd=9),("nginx",pid=175440,fd=9),("nginx",pid=175439,fd=9),("nginx",pid=175438,fd=9))    
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=15))                                                                          
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=175732,fd=13))                                                                                
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=175441,fd=7),("nginx",pid=175440,fd=7),("nginx",pid=175439,fd=7),("nginx",pid=175438,fd=7))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1275,fd=4),("systemd",pid=1,fd=148))                                                            
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=175416,fd=3))                                                                                   
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=175441,fd=10),("nginx",pid=175440,fd=10),("nginx",pid=175439,fd=10),("nginx",pid=175438,fd=10))
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=175441,fd=8),("nginx",pid=175440,fd=8),("nginx",pid=175439,fd=8),("nginx",pid=175438,fd=8))    
```
...
table ip6 filter {
	...
	chain ufw6-before-output {
		...
		meta l4proto ipv6-icmp icmpv6 type echo-request counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type echo-reply counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type nd-router-solicit ip6 hoplimit 255 counter packets 1879 bytes 92336 accept
		meta l4proto ipv6-icmp icmpv6 type nd-neighbor-advert ip6 hoplimit 255 counter packets 0 bytes 0 accept
	...
	chain OUTPUT {
		...
		counter packets 1884 bytes 92712 jump ufw6-before-logging-output
		counter packets 1884 bytes 92712 jump ufw6-before-output
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-12 04:19:48 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-12 02:43:42 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
drwxrwxr-x 16 root syslog 4.0K Jul 12 00:00 ..
