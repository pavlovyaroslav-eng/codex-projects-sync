...
Generated: 2026-08-29T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-138-generic #138-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 31 22:41:49 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 8 days, 59 min,  0 user,  load average: 0.01, 0.03, 0.00
```
...
udp   UNCONN 0      0           10.8.1.2:46051      0.0.0.0:*    users:(("xray",pid=971,fd=3580))                                                                               
udp   UNCONN 0      0           10.8.1.2:55280      0.0.0.0:*    users:(("xray",pid=971,fd=3798))                                                                               
...
udp   UNCONN 0      0           10.8.1.2:55364      0.0.0.0:*    users:(("xray",pid=971,fd=3882))                                                                               
udp   UNCONN 0      0           10.8.1.2:34912      0.0.0.0:*    users:(("xray",pid=971,fd=3839))                                                                               
udp   UNCONN 0      0           10.8.1.2:50322      0.0.0.0:*    users:(("xray",pid=971,fd=3960))                                                                               
udp   UNCONN 0      0           10.8.1.2:39123      0.0.0.0:*    users:(("xray",pid=971,fd=3820))                                                                               
udp   UNCONN 0      0           10.8.1.2:44253      0.0.0.0:*    users:(("xray",pid=971,fd=3659))                                                                               
udp   UNCONN 0      0           10.8.1.2:57674      0.0.0.0:*    users:(("xray",pid=971,fd=3936))                                                                               
udp   UNCONN 0      0           10.8.1.2:55645      0.0.0.0:*    users:(("xray",pid=971,fd=3760))                                                                               
udp   UNCONN 0      0           10.8.1.2:36191      0.0.0.0:*    users:(("xray",pid=971,fd=3944))                                                                               
udp   UNCONN 0      0           10.8.1.2:41376      0.0.0.0:*    users:(("xray",pid=971,fd=4105))                                                                               
udp   UNCONN 0      0           10.8.1.2:36359      0.0.0.0:*    users:(("xray",pid=971,fd=3103))                                                                               
udp   UNCONN 0      0           10.8.1.2:57882      0.0.0.0:*    users:(("xray",pid=971,fd=3796))                                                                               
udp   UNCONN 0      0           10.8.1.2:49694      0.0.0.0:*    users:(("xray",pid=971,fd=1116))                                                                               
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=971,fd=7))                                                                                  
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                                   
udp   UNCONN 0      0           10.8.1.2:48812      0.0.0.0:*    users:(("xray",pid=971,fd=3500))                                                                               
udp   UNCONN 0      0           10.8.1.2:35503      0.0.0.0:*    users:(("xray",pid=971,fd=3816))                                                                               
...
udp   UNCONN 0      0           10.8.1.2:42824      0.0.0.0:*    users:(("xray",pid=971,fd=3437))                                                                               
udp   UNCONN 0      0           10.8.1.2:52071      0.0.0.0:*    users:(("xray",pid=971,fd=3890))                                                                               
udp   UNCONN 0      0           10.8.1.2:58264      0.0.0.0:*    users:(("xray",pid=971,fd=2235))                                                                               
udp   UNCONN 0      0           10.8.1.2:40879      0.0.0.0:*    users:(("xray",pid=971,fd=3811))                                                                               
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 34749 bytes 3467671 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 34749 bytes 7238641 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 7629 bytes 467004 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 15789943 bytes 7212596865 accept
		ct state related,established counter packets 282943579 bytes 353978273013 accept
		ct state invalid counter packets 29787 bytes 1682692 jump ufw-logging-deny
		ct state invalid counter packets 29787 bytes 1682692 drop
		...
		ip protocol icmp icmp type echo-request counter packets 2547 bytes 138827 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2276007 bytes 227148781 jump ufw-not-local
		...
		counter packets 2276007 bytes 227148781 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 15789943 bytes 7212596865 accept
		ct state related,established counter packets 218675250 bytes 219388611402 accept
		counter packets 2081535 bytes 853162989 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4549821 bytes 3022613105 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 35427 bytes 2135076 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 89094 bytes 6949325 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3728 bytes 853712 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 115 bytes 5312 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 594 bytes 28552 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 32919 bytes 10237590 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 202626 bytes 77182277 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 34749 bytes 1568344 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 34749 bytes 10344541 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 7631 bytes 467108 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1312253 bytes 79626096 accept
		ip protocol udp ct state new counter packets 758252 bytes 772146318 accept
	}
	...
	chain INPUT {
		...
		counter packets 301041863 bytes 361419840178 jump ufw-before-logging-input
		counter packets 301041863 bytes 361419840178 jump ufw-before-input
		counter packets 880559 bytes 144285003 jump ufw-after-input
		counter packets 551482 bytes 49028207 jump ufw-after-logging-input
		counter packets 551482 bytes 49028207 jump ufw-reject-input
		counter packets 551482 bytes 49028207 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 236546728 bytes 227454371256 jump ufw-before-logging-output
		counter packets 236546728 bytes 227454371256 jump ufw-before-output
		counter packets 2081535 bytes 853162989 jump ufw-after-output
		counter packets 2081535 bytes 853162989 jump ufw-after-logging-output
		counter packets 2081535 bytes 853162989 jump ufw-reject-output
		counter packets 2081535 bytes 853162989 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 4585248 bytes 3024748181 jump ufw-before-logging-forward
		counter packets 4585248 bytes 3024748181 jump ufw-before-forward
		counter packets 35427 bytes 2135076 jump ufw-after-forward
		counter packets 35427 bytes 2135076 jump ufw-after-logging-forward
		counter packets 35427 bytes 2135076 jump ufw-reject-forward
		counter packets 35427 bytes 2135076 jump ufw-track-forward
		iifname "wg-home" counter packets 35427 bytes 2135076 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 14421 bytes 851329 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 14421 bytes 851329 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 329077 bytes 95256796 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1942147 bytes 131753038 return
		fib daddr type multicast counter packets 5557 bytes 177824 return
		fib daddr type broadcast counter packets 328303 bytes 95217919 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1282289 bytes 76321823 accept
		tcp dport 80 counter packets 113017 bytes 6530640 accept
		tcp dport 52000 counter packets 76 bytes 4072 accept
		udp dport 21195 counter packets 1 bytes 439 accept
		udp dport 21196 counter packets 1 bytes 439 accept
		tcp dport 21197 counter packets 40 bytes 2236 accept
		udp dport 21198 counter packets 1 bytes 439 accept
		udp dport 21199 counter packets 1 bytes 439 accept
		udp dport 51820 counter packets 22 bytes 3251 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 47 | 2026-08-29 04:19:45 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-29 01:08:56 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 284K
drwxr-xr-x  2 root root   4.0K Aug 29 03:20 .
