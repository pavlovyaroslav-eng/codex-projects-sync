...
Generated: 2026-08-22T04:20:01+03:00  
Host: hometele  
...
udp   UNCONN 0      0           10.8.1.2:55324      0.0.0.0:*    users:(("xray",pid=971,fd=586))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:45235      0.0.0.0:*    users:(("xray",pid=971,fd=521))                                                                            
udp   UNCONN 0      0           10.8.1.2:44233      0.0.0.0:*    users:(("xray",pid=971,fd=293))                                                                            
udp   UNCONN 0      0           10.8.1.2:59600      0.0.0.0:*    users:(("xray",pid=971,fd=596))                                                                            
udp   UNCONN 0      0           10.8.1.2:38148      0.0.0.0:*    users:(("xray",pid=971,fd=545))                                                                            
udp   UNCONN 0      0           10.8.1.2:51492      0.0.0.0:*    users:(("xray",pid=971,fd=242))                                                                            
udp   UNCONN 0      0           10.8.1.2:34145      0.0.0.0:*    users:(("xray",pid=971,fd=337))                                                                            
udp   UNCONN 0      0           10.8.1.2:34221      0.0.0.0:*    users:(("xray",pid=971,fd=246))                                                                            
udp   UNCONN 0      0           10.8.1.2:57801      0.0.0.0:*    users:(("xray",pid=971,fd=361))                                                                            
udp   UNCONN 0      0           10.8.1.2:43513      0.0.0.0:*    users:(("xray",pid=971,fd=88))                                                                             
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=971,fd=7))                                                                              
udp   UNCONN 0      0           10.8.1.2:46671      0.0.0.0:*    users:(("xray",pid=971,fd=294))                                                                            
udp   UNCONN 0      0           10.8.1.2:49764      0.0.0.0:*    users:(("xray",pid=971,fd=316))                                                                            
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                               
udp   UNCONN 0      0           10.8.1.2:51901      0.0.0.0:*    users:(("xray",pid=971,fd=206))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:37650      0.0.0.0:*    users:(("xray",pid=971,fd=171))                                                                            
udp   UNCONN 0      0           10.8.1.2:33558      0.0.0.0:*    users:(("xray",pid=971,fd=314))                                                                            
udp   UNCONN 0      0           10.8.1.2:58160      0.0.0.0:*    users:(("xray",pid=971,fd=255))                                                                            
udp   UNCONN 0      0            0.0.0.0:53062      0.0.0.0:*    users:(("openvpn",pid=833,fd=4))                                                                           
udp   UNCONN 0      0           10.8.1.2:35724      0.0.0.0:*    users:(("xray",pid=971,fd=265))                                                                            
udp   UNCONN 0      0           10.8.1.2:48044      0.0.0.0:*    users:(("xray",pid=971,fd=524))                                                                            
udp   UNCONN 0      0           10.8.1.2:41906      0.0.0.0:*    users:(("xray",pid=971,fd=436))                                                                            
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=1941,fd=3),("systemd",pid=1,fd=81))                                                     
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1941,fd=4),("systemd",pid=1,fd=82))                                                     
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 4509 bytes 423939 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 4509 bytes 819984 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 1027 bytes 62740 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 2220191 bytes 1028136676 accept
		ct state related,established counter packets 35943334 bytes 47604763735 accept
		ct state invalid counter packets 3858 bytes 193011 jump ufw-logging-deny
		ct state invalid counter packets 3858 bytes 193011 drop
		...
		ip protocol icmp icmp type echo-request counter packets 388 bytes 22507 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 298223 bytes 26607849 jump ufw-not-local
		...
		counter packets 298223 bytes 26607849 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 2220191 bytes 1028136676 accept
		ct state related,established counter packets 27466813 bytes 27229256689 accept
		counter packets 252944 bytes 115786305 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 412282 bytes 249006855 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 4400 bytes 265184 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 11145 bytes 869310 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 500 bytes 114500 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 12 bytes 516 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 87 bytes 4180 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 4215 bytes 1298220 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 26741 bytes 10111352 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 4509 bytes 204995 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 4509 bytes 1467494 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 1029 bytes 62844 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 151527 bytes 9151967 accept
		ip protocol udp ct state new counter packets 100286 bytes 106475068 accept
	}
	...
	chain INPUT {
		...
		counter packets 38465994 bytes 48659723778 jump ufw-before-logging-input
		counter packets 38465994 bytes 48659723778 jump ufw-before-input
		counter packets 113980 bytes 15788658 jump ufw-after-input
		counter packets 71280 bytes 3390580 jump ufw-after-logging-input
		counter packets 71280 bytes 3390580 jump ufw-reject-input
		counter packets 71280 bytes 3390580 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 29939948 bytes 28373179670 jump ufw-before-logging-output
		counter packets 29939948 bytes 28373179670 jump ufw-before-output
		counter packets 252944 bytes 115786305 jump ufw-after-output
		counter packets 252944 bytes 115786305 jump ufw-after-logging-output
		counter packets 252944 bytes 115786305 jump ufw-reject-output
		counter packets 252944 bytes 115786305 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 416682 bytes 249272039 jump ufw-before-logging-forward
		counter packets 416682 bytes 249272039 jump ufw-before-forward
		counter packets 4400 bytes 265184 jump ufw-after-forward
		counter packets 4400 bytes 265184 jump ufw-after-logging-forward
		counter packets 4400 bytes 265184 jump ufw-reject-forward
		counter packets 4400 bytes 265184 jump ufw-track-forward
		iifname "wg-home" counter packets 4400 bytes 265184 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 2409 bytes 122175 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 2409 bytes 122175 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 42700 bytes 12398078 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 254912 bytes 14192207 return
		fib daddr type multicast counter packets 720 bytes 23040 return
		fib daddr type broadcast counter packets 42591 bytes 12392602 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 179856 bytes 10557175 accept
		tcp dport 80 counter packets 4359 bytes 259240 accept
		tcp dport 52000 counter packets 9 bytes 440 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 45 | 2026-08-22 04:19:40 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-21 22:38:17 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 248K
drwxr-xr-x  2 root root   4.0K Aug 22 03:20 .
drwxrwxr-x 16 root syslog 4.0K Aug 22 00:00 ..
