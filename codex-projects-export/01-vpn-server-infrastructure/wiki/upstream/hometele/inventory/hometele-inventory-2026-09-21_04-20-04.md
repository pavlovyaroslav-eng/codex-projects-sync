...
Generated: 2026-09-21T04:20:04+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:04 up 15 days, 59 min,  0 user,  load average: 0.10, 0.08, 0.03
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 64989 bytes 8762308 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 64989 bytes 5100457 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 64989 bytes 3901836 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 153927964 bytes 123670948388 accept
		ct state related,established counter packets 394529690 bytes 304952588340 accept
		ct state invalid counter packets 33428 bytes 2058348 jump ufw-logging-deny
		ct state invalid counter packets 33428 bytes 2058348 drop
		...
		ip protocol icmp icmp type echo-request counter packets 5667 bytes 311103 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3168992 bytes 463110055 jump ufw-not-local
		...
		counter packets 3168992 bytes 463110055 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 153927964 bytes 123670948388 accept
		ct state related,established counter packets 308353634 bytes 311102329516 accept
		counter packets 3085525 bytes 350948827 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 10116727 bytes 7241232509 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 483023 bytes 28998516 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 109836 bytes 8567208 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 5307 bytes 1214439 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 212 bytes 9988 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1789 bytes 81808 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 61135 bytes 18898334 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 13 bytes 364 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 417616 bytes 151374149 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 64989 bytes 3056476 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 64989 bytes 6339962 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 64989 bytes 3901836 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1790802 bytes 107559537 accept
		ip protocol udp ct state new counter packets 1260049 bytes 230485710 accept
	}
	...
	chain INPUT {
		...
		counter packets 551665741 bytes 429089016234 jump ufw-before-logging-input
		counter packets 551665741 bytes 429089016234 jump ufw-before-input
		counter packets 1351600 bytes 239247648 jump ufw-after-input
		counter packets 755692 bytes 59101358 jump ufw-after-logging-input
		counter packets 755692 bytes 59101358 jump ufw-reject-input
		counter packets 755692 bytes 59101358 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 465367123 bytes 435124226731 jump ufw-before-logging-output
		counter packets 465367123 bytes 435124226731 jump ufw-before-output
		counter packets 3085525 bytes 350948827 jump ufw-after-output
		counter packets 3085525 bytes 350948827 jump ufw-after-logging-output
		counter packets 3085525 bytes 350948827 jump ufw-reject-output
		counter packets 3085525 bytes 350948827 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 3931717 bytes 2460555150 jump DOCKER-USER
		counter packets 3931717 bytes 2460555150 jump DOCKER-FORWARD
		...
		counter packets 10599750 bytes 7270231025 jump ufw-before-logging-forward
		counter packets 10599750 bytes 7270231025 jump ufw-before-forward
		counter packets 483023 bytes 28998516 jump ufw-after-forward
		counter packets 483023 bytes 28998516 jump ufw-after-logging-forward
		counter packets 483023 bytes 28998516 jump ufw-reject-forward
		counter packets 483023 bytes 28998516 jump ufw-track-forward
		iifname "wg-home" counter packets 483023 bytes 28998516 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 17208 bytes 1043198 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 17208 bytes 1043198 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 595908 bytes 180146290 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2564863 bytes 282740115 return
		fib daddr type multicast counter packets 10397 bytes 332704 return
		fib daddr type broadcast counter packets 593732 bytes 180037236 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1177218 bytes 67427395 accept
		tcp dport 80 counter packets 454251 bytes 24606036 accept
		tcp dport 52000 counter packets 639 bytes 37396 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 89 bytes 5068 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2458 bytes 147480 accept
		udp dport 443 counter packets 182720 bytes 131634376 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 3931717 bytes 2460555150 jump DOCKER-CT
		counter packets 3650307 bytes 2307817534 jump DOCKER-INTERNAL
		counter packets 3650307 bytes 2307817534 jump DOCKER-BRIDGE
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-21 04:20:01 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-20 16:05:01 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 404K
drwxr-xr-x  2 root root   4.0K Sep 21 03:20 .
