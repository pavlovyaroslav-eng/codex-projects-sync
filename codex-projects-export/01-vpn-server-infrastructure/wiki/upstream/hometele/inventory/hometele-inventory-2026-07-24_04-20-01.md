...
Generated: 2026-07-24T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-136-generic #136-Ubuntu SMP PREEMPT_DYNAMIC Wed Jul  1 21:53:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 6 days, 59 min,  1 user,  load average: 0.00, 0.00, 0.00
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 26109 bytes 3256037 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 26108 bytes 4235608 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 26077 bytes 1565777 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 7827008 bytes 3561286407 accept
		ct state related,established counter packets 145288988 bytes 174335533315 accept
		ct state invalid counter packets 81777 bytes 4189401 jump ufw-logging-deny
		ct state invalid counter packets 81777 bytes 4189401 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1846 bytes 97420 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1283674 bytes 148824416 jump ufw-not-local
		...
		counter packets 1283674 bytes 148824416 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 7827008 bytes 3561286407 accept
		ct state related,established counter packets 114803499 bytes 104752535945 accept
		counter packets 1172048 bytes 394475176 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4113542 bytes 2766652178 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 4 bytes 112 accept
		counter packets 214002 bytes 12847201 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 28930 bytes 2256450 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3111 bytes 712419 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 59 bytes 2680 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 473 bytes 22920 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 41887 bytes 17575678 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 206898 bytes 68885495 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 26109 bytes 1267455 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 26108 bytes 6270512 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 26077 bytes 1565761 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 796314 bytes 48246620 accept
		ip protocol udp ct state new counter packets 368081 bytes 345232895 accept
	}
	...
	chain INPUT {
		...
		counter packets 154483293 bytes 178049930959 jump ufw-before-logging-input
		counter packets 154483293 bytes 178049930959 jump ufw-before-input
		counter packets 634482 bytes 109968192 jump ufw-after-input
		counter packets 353124 bytes 20512550 jump ufw-after-logging-input
		counter packets 353124 bytes 20512550 jump ufw-reject-input
		counter packets 353124 bytes 20512550 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 123802555 bytes 108708297528 jump ufw-before-logging-output
		counter packets 123802555 bytes 108708297528 jump ufw-before-output
		counter packets 1172048 bytes 394475176 jump ufw-after-output
		counter packets 1172048 bytes 394475176 jump ufw-after-logging-output
		counter packets 1172048 bytes 394475176 jump ufw-reject-output
		counter packets 1172048 bytes 394475176 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 4327548 bytes 2779499491 jump ufw-before-logging-forward
		counter packets 4327548 bytes 2779499491 jump ufw-before-forward
		counter packets 214002 bytes 12847201 jump ufw-after-forward
		counter packets 214002 bytes 12847201 jump ufw-after-logging-forward
		counter packets 214002 bytes 12847201 jump ufw-reject-forward
		counter packets 214002 bytes 12847201 jump ufw-track-forward
		iifname "wg-home" counter packets 209649 bytes 12585860 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 13255 bytes 761388 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 13255 bytes 761388 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 281358 bytes 89455642 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 998736 bytes 59265552 return
		fib daddr type multicast counter packets 4174 bytes 133568 return
		fib daddr type broadcast counter packets 280764 bytes 89425296 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 642111 bytes 38432057 accept
		tcp dport 80 counter packets 6731 bytes 386607 accept
		tcp dport 52000 counter packets 120 bytes 7016 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 32 bytes 1760 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-24 04:19:34 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-23 18:55:49 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 116K
drwxr-xr-x  2 root root   4.0K Jul 24 03:20 .
