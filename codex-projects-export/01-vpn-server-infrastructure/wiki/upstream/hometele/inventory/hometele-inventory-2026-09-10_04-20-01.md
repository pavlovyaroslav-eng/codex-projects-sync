...
Generated: 2026-09-10T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:02 up 4 days, 59 min,  0 user,  load average: 0.17, 0.07, 0.07
```
...
udp   UNCONN 0      0         127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=678,fd=16))                                                                       
udp   UNCONN 0      0      127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=678,fd=14))                                                                       
...
udp   UNCONN 0      0                  *:59459            *:*    users:(("rw-core",pid=252273,fd=9))                                                                             
...
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=678,fd=15))                                                                       
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=2684,fd=3),("systemd",pid=1,fd=89))                                                          
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=252707,fd=21),("nginx",pid=252706,fd=21),("nginx",pid=252705,fd=21),("nginx",pid=967,fd=21))
tcp   LISTEN 0      4096       127.0.0.1:10443      0.0.0.0:*    users:(("rw-core",pid=252273,fd=8))                                                                             
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=252707,fd=7),("nginx",pid=252706,fd=7),("nginx",pid=252705,fd=7),("nginx",pid=967,fd=7))    
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1712,fd=13))                                                                               
tcp   LISTEN 0      4096      127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=678,fd=17))                                                                       
tcp   LISTEN 0      511          0.0.0.0:443        0.0.0.0:*    users:(("nginx",pid=252707,fd=9),("nginx",pid=252706,fd=9),("nginx",pid=252705,fd=9),("nginx",pid=967,fd=9))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=2684,fd=4),("systemd",pid=1,fd=90))                                                          
tcp   LISTEN 0      511                *:2222             *:*    users:(("rw-node",pid=2128,fd=21))                                                                              
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=252707,fd=8),("nginx",pid=252706,fd=8),("nginx",pid=252705,fd=8),("nginx",pid=967,fd=8))    
tcp   LISTEN 0      511             [::]:443           [::]:*    users:(("nginx",pid=252707,fd=10),("nginx",pid=252706,fd=10),("nginx",pid=252705,fd=10),("nginx",pid=967,fd=10))
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 17469 bytes 2164070 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 17469 bytes 1622268 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 17469 bytes 1048876 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 34982255 bytes 24296286384 accept
		ct state related,established counter packets 116132217 bytes 82206930143 accept
		ct state invalid counter packets 10292 bytes 613072 jump ufw-logging-deny
		ct state invalid counter packets 10292 bytes 613072 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1375 bytes 68095 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1003921 bytes 124208699 jump ufw-not-local
		...
		counter packets 1003921 bytes 124208699 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 34982255 bytes 24296286384 accept
		ct state related,established counter packets 93240901 bytes 84164529135 accept
		counter packets 945073 bytes 121363335 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 2610637 bytes 1846699227 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 129369 bytes 7766812 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 24760 bytes 1931280 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 1523 bytes 348200 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 69 bytes 3268 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 386 bytes 18656 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 16354 bytes 5036924 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 84 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 112114 bytes 40767897 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 17468 bytes 806721 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 17469 bytes 2070787 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 17469 bytes 1048876 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 544396 bytes 32679273 accept
		ip protocol udp ct state new counter packets 390570 bytes 84824569 accept
	}
	...
	chain INPUT {
		...
		counter packets 152130060 bytes 106628106393 jump ufw-before-logging-input
		counter packets 152130060 bytes 106628106393 jump ufw-before-input
		counter packets 381227 bytes 58875053 jump ufw-after-input
		counter packets 226018 bytes 10768744 jump ufw-after-logging-input
		counter packets 226018 bytes 10768744 jump ufw-reject-input
		counter packets 226018 bytes 10768744 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 129168229 bytes 108582178854 jump ufw-before-logging-output
		counter packets 129168229 bytes 108582178854 jump ufw-before-output
		counter packets 945073 bytes 121363335 jump ufw-after-output
		counter packets 945073 bytes 121363335 jump ufw-after-logging-output
		counter packets 945073 bytes 121363335 jump ufw-reject-output
		counter packets 945073 bytes 121363335 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 3283913 bytes 2040489519 jump DOCKER-USER
		counter packets 3283913 bytes 2040489519 jump DOCKER-FORWARD
		...
		counter packets 2740006 bytes 1854466039 jump ufw-before-logging-forward
		counter packets 2740006 bytes 1854466039 jump ufw-before-forward
		counter packets 129369 bytes 7766812 jump ufw-after-forward
		counter packets 129369 bytes 7766812 jump ufw-after-logging-forward
		counter packets 129369 bytes 7766812 jump ufw-reject-forward
		counter packets 129369 bytes 7766812 jump ufw-track-forward
		iifname "wg-home" counter packets 129369 bytes 7766812 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 5150 bytes 299187 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 5150 bytes 299187 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 155209 bytes 48106309 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 846422 bytes 76039486 return
		fib daddr type multicast counter packets 2793 bytes 89376 return
		fib daddr type broadcast counter packets 154706 bytes 48079837 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 325249 bytes 18396446 accept
		tcp dport 80 counter packets 245928 bytes 13789393 accept
		tcp dport 52000 counter packets 196 bytes 11388 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 22 bytes 1240 accept
		udp dport 21198 counter packets 1 bytes 1110 accept
		udp dport 21199 counter packets 0 bytes 0 accept
		udp dport 51820 counter packets 9 bytes 1168 accept
		ip saddr 91.242.163.206 udp dport 51822 counter packets 0 bytes 0 accept
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 692 bytes 41520 accept
		udp dport 443 counter packets 50597 bytes 33091381 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 4 days (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-10 04:19:35 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-10 01:19:20 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 344K
drwxr-xr-x  2 root root   4.0K Sep 10 03:20 .
