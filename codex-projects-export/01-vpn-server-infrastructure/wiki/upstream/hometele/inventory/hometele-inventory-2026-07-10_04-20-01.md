...
Generated: 2026-07-10T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-124-generic #124-Ubuntu SMP PREEMPT_DYNAMIC Tue May 26 13:00:45 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 9 days,  4:07,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0          10.79.0.2:60795      0.0.0.0:*    users:(("xray",pid=141115,fd=73))                                                                                  
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=141115,fd=7))                                                                                   
...
udp   UNCONN 0      0          10.79.0.2:46845      0.0.0.0:*    users:(("xray",pid=141115,fd=45))                                                                                  
...
udp   UNCONN 0      0          10.79.0.2:37987      0.0.0.0:*    users:(("xray",pid=141115,fd=52))                                                                                  
udp   UNCONN 0      0          10.79.0.2:39040      0.0.0.0:*    users:(("xray",pid=141115,fd=54))                                                                                  
udp   UNCONN 0      0          10.79.0.2:55471      0.0.0.0:*    users:(("xray",pid=141115,fd=53))                                                                                  
udp   UNCONN 0      0          10.79.0.2:43250      0.0.0.0:*    users:(("xray",pid=141115,fd=32))                                                                                  
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                                                                       
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=141115,fd=6))                                                                                   
...
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=141144,fd=9),("nginx",pid=141143,fd=9),("nginx",pid=141142,fd=9),("nginx",pid=141141,fd=9))    
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=15))                                                                          
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=141439,fd=13))                                                                                
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=141144,fd=7),("nginx",pid=141143,fd=7),("nginx",pid=141142,fd=7),("nginx",pid=141141,fd=7))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1275,fd=4),("systemd",pid=1,fd=171))                                                            
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=141115,fd=3))                                                                                   
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=141144,fd=10),("nginx",pid=141143,fd=10),("nginx",pid=141142,fd=10),("nginx",pid=141141,fd=10))
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=141144,fd=8),("nginx",pid=141143,fd=8),("nginx",pid=141142,fd=8),("nginx",pid=141141,fd=8))    
```
...
table ip6 filter {
	...
	chain ufw6-before-output {
		...
		meta l4proto ipv6-icmp icmpv6 type echo-request counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type echo-reply counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type nd-router-solicit ip6 hoplimit 255 counter packets 1557 bytes 76512 accept
		meta l4proto ipv6-icmp icmpv6 type nd-neighbor-advert ip6 hoplimit 255 counter packets 0 bytes 0 accept
	...
	chain OUTPUT {
		...
		counter packets 1562 bytes 76888 jump ufw6-before-logging-output
		counter packets 1562 bytes 76888 jump ufw6-before-output
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-10 04:19:45 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-10 01:54:12 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
