...
Generated: 2026-09-12T04:20:03+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:03 up 6 days, 59 min,  0 user,  load average: 0.00, 0.00, 0.00
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 26109 bytes 3326278 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 26109 bytes 2308057 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 26109 bytes 1567548 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 56361083 bytes 38357178287 accept
		ct state related,established counter packets 161487109 bytes 115699357750 accept
		ct state invalid counter packets 15479 bytes 947939 jump ufw-logging-deny
		ct state invalid counter packets 15479 bytes 947939 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1966 bytes 102138 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1368707 bytes 177678619 jump ufw-not-local
		...
		counter packets 1368707 bytes 177678619 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 56361083 bytes 38357178287 accept
		ct state related,established counter packets 129719471 bytes 118047195749 accept
		counter packets 1563982 bytes 191160230 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 3920542 bytes 2794749005 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 193729 bytes 11630732 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 45893 bytes 3579654 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2181 bytes 498855 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 100 bytes 4820 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 633 bytes 29832 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 24447 bytes 7529496 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 167672 bytes 61001174 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 26109 bytes 1221900 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 26109 bytes 2960302 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 26109 bytes 1567548 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 911532 bytes 54718091 accept
		ip protocol udp ct state new counter packets 634111 bytes 129141957 accept
	}
	...
	chain INPUT {
		...
		counter packets 219234344 bytes 154235264733 jump ufw-before-logging-input
		counter packets 219234344 bytes 154235264733 jump ufw-before-input
		counter packets 544945 bytes 87291801 jump ufw-after-input
		counter packets 304014 bytes 14647830 jump ufw-after-logging-input
		counter packets 304014 bytes 14647830 jump ufw-reject-input
		counter packets 304014 bytes 14647830 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 187644536 bytes 156595534266 jump ufw-before-logging-output
		counter packets 187644536 bytes 156595534266 jump ufw-before-output
		counter packets 1563982 bytes 191160230 jump ufw-after-output
		counter packets 1563982 bytes 191160230 jump ufw-after-logging-output
		counter packets 1563982 bytes 191160230 jump ufw-reject-output
		counter packets 1563982 bytes 191160230 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 4930306 bytes 3084396604 jump DOCKER-USER
		counter packets 4930306 bytes 3084396604 jump DOCKER-FORWARD
		...
		counter packets 4114271 bytes 2806379737 jump ufw-before-logging-forward
		counter packets 4114271 bytes 2806379737 jump ufw-before-forward
		counter packets 193729 bytes 11630732 jump ufw-after-forward
		counter packets 193729 bytes 11630732 jump ufw-after-logging-forward
		counter packets 193729 bytes 11630732 jump ufw-reject-forward
		counter packets 193729 bytes 11630732 jump ufw-track-forward
		iifname "wg-home" counter packets 193729 bytes 11630732 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7991 bytes 470457 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7991 bytes 470457 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 240931 bytes 72643971 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1124407 bytes 104942656 return
		fib daddr type multicast counter packets 4176 bytes 133632 return
		fib daddr type broadcast counter packets 240124 bytes 72602331 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 481696 bytes 27299249 accept
		tcp dport 80 counter packets 269907 bytes 14950920 accept
		tcp dport 52000 counter packets 426 bytes 24924 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1090 bytes 65400 accept
		udp dport 443 counter packets 70586 bytes 48041239 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 6 days (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-12 04:20:02 |
...
total 352K
drwxr-xr-x  2 root root   4.0K Sep 12 03:20 .
