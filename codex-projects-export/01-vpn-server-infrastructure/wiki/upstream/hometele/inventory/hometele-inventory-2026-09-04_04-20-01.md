...
Generated: 2026-09-04T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-138-generic #138-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 31 22:41:49 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 14 days, 59 min,  0 user,  load average: 0.00, 0.01, 0.00
```
...
br-be53f5c116d2  UP             172.18.0.1/16 fe80::e4ec:efff:fe04:9d33/64 
veth347c89a@if2  UP             fe80::ac71:6bff:fe45:6049/64 
```
...
fe80::/64 dev veth347c89a proto kernel metric 256 pref medium
```

## Listening ports
```text
Netid State  Recv-Q Send-Q Local Address:Port  Peer Address:PortProcess                                                                                                             
udp   UNCONN 0      0         127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=224756,fd=16))                                                                       
udp   UNCONN 0      0      127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=224756,fd=14))                                                                       
...
udp   UNCONN 0      0                  *:46412            *:*    users:(("rw-core",pid=293592,fd=24))                                                                               
udp   UNCONN 0      0                  *:443              *:*    users:(("rw-core",pid=293592,fd=7))                                                                                
udp   UNCONN 0      0                  *:57837            *:*    users:(("rw-core",pid=293592,fd=9))                                                                                
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                                                                       
udp   UNCONN 0      0               [::]:37619         [::]:*    users:(("amneziawg-go",pid=837,fd=15))                                                                             
tcp   LISTEN 0      511          0.0.0.0:443        0.0.0.0:*    users:(("nginx",pid=245830,fd=15),("nginx",pid=245829,fd=15),("nginx",pid=245828,fd=15),("nginx",pid=216070,fd=15))
tcp   LISTEN 0      4096      127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=224756,fd=17))                                                                       
tcp   LISTEN 0      4096       127.0.0.1:8081       0.0.0.0:*    users:(("docker-proxy",pid=242149,fd=8))                                                                           
tcp   LISTEN 0      4096       127.0.0.1:9091       0.0.0.0:*    users:(("docker-proxy",pid=242165,fd=8))                                                                           
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=224756,fd=15))                                                                       
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=245830,fd=7),("nginx",pid=245829,fd=7),("nginx",pid=245828,fd=7),("nginx",pid=216070,fd=7))    
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1609,fd=13))                                                                                  
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=216067,fd=3),("systemd",pid=1,fd=156))                                                          
tcp   LISTEN 0      32           0.0.0.0:21197      0.0.0.0:*    users:(("openvpn",pid=860,fd=5))                                                                                   
tcp   LISTEN 0      511             [::]:443           [::]:*    users:(("nginx",pid=245830,fd=16),("nginx",pid=245829,fd=16),("nginx",pid=245828,fd=16),("nginx",pid=216070,fd=16))
tcp   LISTEN 0      511                *:2222             *:*    users:(("rw-node",pid=238713,fd=21))                                                                               
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=245830,fd=8),("nginx",pid=245829,fd=8),("nginx",pid=245828,fd=8),("nginx",pid=216070,fd=8))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=216067,fd=4),("systemd",pid=1,fd=157))                                                          
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 3665 bytes 427353 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 3665 bytes 296512 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 3665 bytes 219916 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 133464 bytes 28350156 accept
		ct state related,established counter packets 15738698 bytes 10320726749 accept
		ct state invalid counter packets 4785 bytes 210165 jump ufw-logging-deny
		ct state invalid counter packets 4785 bytes 210165 drop
		...
		ip protocol icmp icmp type echo-request counter packets 218 bytes 10343 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 610321 bytes 49756119 jump ufw-not-local
		...
		counter packets 610321 bytes 49756119 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 133464 bytes 28350156 accept
		ct state related,established counter packets 13178851 bytes 12680339338 accept
		counter packets 195446 bytes 22778141 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 20698 bytes 16038915 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 102642 bytes 6160000 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 3761 bytes 293307 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 407 bytes 93203 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 10 bytes 480 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 77 bytes 3684 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 3422 bytes 1053976 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 22712 bytes 8389127 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 3665 bytes 163221 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 3665 bytes 341886 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 3665 bytes 219916 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 97806 bytes 5873232 accept
		ip protocol udp ct state new counter packets 71321 bytes 14859028 accept
	}
	...
	chain INPUT {
		...
		counter packets 466251649 bytes 550345984609 jump ufw-before-logging-input
		counter packets 466251649 bytes 550345984609 jump ufw-before-input
		counter packets 1415448 bytes 228584833 jump ufw-after-input
		counter packets 857811 bytes 63506358 jump ufw-after-logging-input
		counter packets 857811 bytes 63506358 jump ufw-reject-input
		counter packets 857811 bytes 63506358 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 365555317 bytes 347855964473 jump ufw-before-logging-output
		counter packets 365555317 bytes 347855964473 jump ufw-before-output
		counter packets 3268184 bytes 1319674416 jump ufw-after-output
		counter packets 3268184 bytes 1319674416 jump ufw-after-logging-output
		counter packets 3268184 bytes 1319674416 jump ufw-reject-output
		counter packets 3268184 bytes 1319674416 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 236705 bytes 61013738 jump DOCKER-USER
		counter packets 236705 bytes 61013738 jump DOCKER-FORWARD
		...
		counter packets 7815014 bytes 5148788969 jump ufw-before-logging-forward
		counter packets 7815014 bytes 5148788969 jump ufw-before-forward
		counter packets 280728 bytes 16860456 jump ufw-after-forward
		counter packets 280728 bytes 16860456 jump ufw-after-logging-forward
		counter packets 280728 bytes 16860456 jump ufw-reject-forward
		counter packets 280728 bytes 16860456 jump ufw-track-forward
		iifname "wg-home" counter packets 280728 bytes 16860456 accept
	...
	chain DOCKER-FORWARD {
		counter packets 236705 bytes 61013738 jump DOCKER-CT
		counter packets 187279 bytes 34139069 jump DOCKER-INTERNAL
		counter packets 187279 bytes 34139069 jump DOCKER-BRIDGE
		iifname "docker0" counter packets 0 bytes 0 accept
		iifname "br-be53f5c116d2" counter packets 63929 bytes 11938776 accept
	}

	chain DOCKER-BRIDGE {
		oifname "docker0" counter packets 0 bytes 0 jump DOCKER
		oifname "br-be53f5c116d2" counter packets 0 bytes 0 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "docker0" ct state related,established counter packets 0 bytes 0 accept
		oifname "br-be53f5c116d2" ct state related,established counter packets 49426 bytes 26874669 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 437 bytes 28622 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 437 bytes 28622 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 30389 bytes 9833777 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 579450 bytes 39908983 return
		fib daddr type multicast counter packets 585 bytes 18720 return
		fib daddr type broadcast counter packets 30286 bytes 9828416 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 500645 bytes 31539292 accept
		tcp dport 80 counter packets 17009 bytes 882932 accept
		tcp dport 52000 counter packets 127 bytes 7556 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 4 bytes 216 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 110 bytes 6600 accept
		udp dport 443 counter packets 9494 bytes 5076031 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 20 hours (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-04 04:19:51 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-03 13:19:45 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 316K
drwxr-xr-x  2 root root   4.0K Sep  4 03:20 .
drwxrwxr-x 15 root syslog 4.0K Sep  3 14:59 ..
