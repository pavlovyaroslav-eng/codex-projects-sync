...
Generated: 2026-09-09T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 3 days, 59 min,  0 user,  load average: 0.02, 0.04, 0.00
```
...
udp   UNCONN 0      0                  *:47315            *:*    users:(("rw-core",pid=252273,fd=48))                                                                            
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 13149 bytes 1628294 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 13149 bytes 1259571 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 13149 bytes 789484 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 15150244 bytes 10756843264 accept
		ct state related,established counter packets 75625509 bytes 55681113843 accept
		ct state invalid counter packets 8046 bytes 442404 jump ufw-logging-deny
		ct state invalid counter packets 8046 bytes 442404 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1003 bytes 50455 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 682033 bytes 89371998 jump ufw-not-local
		...
		counter packets 682033 bytes 89371998 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 15150244 bytes 10756843264 accept
		ct state related,established counter packets 62241349 bytes 57309510044 accept
		counter packets 775838 bytes 96437466 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 2106165 bytes 1507808314 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 97501 bytes 5853644 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 16023 bytes 1249794 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 1200 bytes 274773 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 54 bytes 2560 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 247 bytes 12160 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 12308 bytes 3790792 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 2 bytes 56 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 84444 bytes 30721196 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 13149 bytes 604213 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 13149 bytes 1528738 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 13149 bytes 789484 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 461578 bytes 27710017 accept
		ip protocol udp ct state new counter packets 307332 bytes 66097649 accept
	}
	...
	chain INPUT {
		...
		counter packets 91466835 bytes 66527821964 jump ufw-before-logging-input
		counter packets 91466835 bytes 66527821964 jump ufw-before-input
		counter packets 296207 bytes 44680371 jump ufw-after-input
		counter packets 181929 bytes 8629040 jump ufw-after-logging-input
		counter packets 181929 bytes 8629040 jump ufw-reject-input
		counter packets 181929 bytes 8629040 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 78167431 bytes 68162790774 jump ufw-before-logging-output
		counter packets 78167431 bytes 68162790774 jump ufw-before-output
		counter packets 775838 bytes 96437466 jump ufw-after-output
		counter packets 775838 bytes 96437466 jump ufw-after-logging-output
		counter packets 775838 bytes 96437466 jump ufw-reject-output
		counter packets 775838 bytes 96437466 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 2613148 bytes 1653602352 jump DOCKER-USER
		counter packets 2613148 bytes 1653602352 jump DOCKER-FORWARD
		...
		counter packets 2203666 bytes 1513661958 jump ufw-before-logging-forward
		counter packets 2203666 bytes 1513661958 jump ufw-before-forward
		counter packets 97501 bytes 5853644 jump ufw-after-forward
		counter packets 97501 bytes 5853644 jump ufw-after-logging-forward
		counter packets 97501 bytes 5853644 jump ufw-reject-forward
		counter packets 97501 bytes 5853644 jump ufw-track-forward
		iifname "wg-home" counter packets 97501 bytes 5853644 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 4059 bytes 232921 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 4059 bytes 232921 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 114278 bytes 36051331 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 565985 bytes 53270953 return
		fib daddr type multicast counter packets 2102 bytes 67264 return
		fib daddr type broadcast counter packets 113946 bytes 36033781 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 178838 bytes 10088551 accept
		tcp dport 80 counter packets 167086 bytes 9328997 accept
		tcp dport 52000 counter packets 184 bytes 10720 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 7 bytes 384 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 539 bytes 32340 accept
		udp dport 443 counter packets 39162 bytes 25228357 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-09 04:19:35 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-09 01:59:17 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 340K
drwxr-xr-x  2 root root   4.0K Sep  9 03:20 .
