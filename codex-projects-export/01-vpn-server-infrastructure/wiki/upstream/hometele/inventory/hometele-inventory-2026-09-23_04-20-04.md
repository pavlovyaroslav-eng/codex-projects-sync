...
Generated: 2026-09-23T04:20:04+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:04 up 17 days, 59 min,  0 user,  load average: 0.00, 0.00, 0.00
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 73629 bytes 9990956 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 73629 bytes 5691908 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 73629 bytes 4420588 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 172005268 bytes 138603482286 accept
		ct state related,established counter packets 444178824 bytes 343606253803 accept
		ct state invalid counter packets 38211 bytes 2339637 jump ufw-logging-deny
		ct state invalid counter packets 38211 bytes 2339637 drop
		...
		ip protocol icmp icmp type echo-request counter packets 6462 bytes 353409 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3482155 bytes 515640161 jump ufw-not-local
		...
		counter packets 3482155 bytes 515640161 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 172005268 bytes 138603482286 accept
		ct state related,established counter packets 344942856 bytes 350030093738 accept
		counter packets 3166088 bytes 358320474 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 11710002 bytes 8411941678 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 549406 bytes 32992784 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 110918 bytes 8651604 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 6029 bytes 1379723 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 241 bytes 11304 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1954 bytes 89828 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 69661 bytes 21633969 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 16 bytes 448 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 472973 bytes 171488979 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 73629 bytes 3456663 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 73629 bytes 7027988 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 73629 bytes 4420588 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1801896 bytes 108286499 accept
		ip protocol udp ct state new counter packets 1328147 bytes 236983038 accept
	}
	...
	chain INPUT {
		...
		counter packets 619710920 bytes 482728069296 jump ufw-before-logging-input
		counter packets 619710920 bytes 482728069296 jump ufw-before-input
		counter packets 1498752 bytes 266233709 jump ufw-after-input
		counter packets 836960 bytes 62977854 jump ufw-after-logging-input
		counter packets 836960 bytes 62977854 jump ufw-reject-input
		counter packets 836960 bytes 62977854 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 520114212 bytes 488991896498 jump ufw-before-logging-output
		counter packets 520114212 bytes 488991896498 jump ufw-before-output
		counter packets 3166088 bytes 358320474 jump ufw-after-output
		counter packets 3166088 bytes 358320474 jump ufw-after-logging-output
		counter packets 3166088 bytes 358320474 jump ufw-reject-output
		counter packets 3166088 bytes 358320474 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 5862908 bytes 3726810004 jump DOCKER-USER
		counter packets 5862908 bytes 3726810004 jump DOCKER-FORWARD
		...
		counter packets 12259408 bytes 8444934462 jump ufw-before-logging-forward
		counter packets 12259408 bytes 8444934462 jump ufw-before-forward
		counter packets 549406 bytes 32992784 jump ufw-after-forward
		counter packets 549406 bytes 32992784 jump ufw-after-logging-forward
		counter packets 549406 bytes 32992784 jump ufw-reject-forward
		counter packets 549406 bytes 32992784 jump ufw-track-forward
		iifname "wg-home" counter packets 549406 bytes 32992784 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 18544 bytes 1131946 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 18544 bytes 1131946 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 661792 bytes 203255855 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2810983 bytes 312128470 return
		fib daddr type multicast counter packets 11778 bytes 376896 return
		fib daddr type broadcast counter packets 659394 bytes 203134795 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1299682 bytes 74792297 accept
		tcp dport 80 counter packets 472218 bytes 25418323 accept
		tcp dport 52000 counter packets 674 bytes 39480 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 104 bytes 5940 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2788 bytes 167280 accept
		udp dport 443 counter packets 207920 bytes 148978476 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 5862908 bytes 3726810004 jump DOCKER-CT
		counter packets 5463361 bytes 3510756082 jump DOCKER-INTERNAL
		counter packets 5463361 bytes 3510756082 jump DOCKER-BRIDGE
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-23 04:20:05 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-23 01:48:05 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 412K
drwxr-xr-x  2 root root   4.0K Sep 23 03:20 .
