...
Generated: 2026-09-15T14:19:58+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 14:19:58 up 9 days, 10:59,  2 users,  load average: 0.04, 0.08, 0.13
```
...
udp   UNCONN 0      0                  *:37857            *:*    users:(("rw-core",pid=1482976,fd=16))                                                                              
udp   UNCONN 0      0               [::]:59810         [::]:*    users:(("amneziawg-go",pid=905,fd=15))                                                                             
udp   UNCONN 0      0                  *:443              *:*    users:(("rw-core",pid=1482976,fd=7))                                                                               
...
tcp   LISTEN 0      4096       127.0.0.1:10443      0.0.0.0:*    users:(("rw-core",pid=1482976,fd=8))                                                                               
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 40869 bytes 5610507 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 40869 bytes 3495312 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 40868 bytes 2453568 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 91915909 bytes 74644750067 accept
		ct state related,established counter packets 249368236 bytes 199775411173 accept
		ct state invalid counter packets 22436 bytes 1375939 jump ufw-logging-deny
		ct state invalid counter packets 22436 bytes 1375939 drop
		...
		ip protocol icmp icmp type echo-request counter packets 2870 bytes 154607 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1974055 bytes 307432074 jump ufw-not-local
		...
		counter packets 1974055 bytes 307432074 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 91915909 bytes 74644750067 accept
		ct state related,established counter packets 198849102 bytes 203852700117 accept
		counter packets 2843640 bytes 333203949 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6434309 bytes 4617292245 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 303758 bytes 18236344 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 89358 bytes 6969924 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3337 bytes 763471 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 138 bytes 6568 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 962 bytes 44856 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 38540 bytes 11939254 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 8 bytes 224 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 262215 bytes 95313668 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 40868 bytes 1936480 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 40869 bytes 4525846 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 40868 bytes 2453568 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1746071 bytes 104848359 accept
		ip protocol udp ct state new counter packets 1066351 bytes 215744721 accept
	}
	...
	chain INPUT {
		...
		counter packets 343283506 bytes 274729123860 jump ufw-before-logging-input
		counter packets 343283506 bytes 274729123860 jump ufw-before-input
		counter packets 888076 bytes 161642260 jump ufw-after-input
		counter packets 493518 bytes 46604295 jump ufw-after-logging-input
		counter packets 493518 bytes 46604295 jump ufw-reject-input
		counter packets 493518 bytes 46604295 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 293608651 bytes 278830654133 jump ufw-before-logging-output
		counter packets 293608651 bytes 278830654133 jump ufw-before-output
		counter packets 2843640 bytes 333203949 jump ufw-after-output
		counter packets 2843640 bytes 333203949 jump ufw-after-logging-output
		counter packets 2843640 bytes 333203949 jump ufw-reject-output
		counter packets 2843640 bytes 333203949 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 8013677 bytes 5071330329 jump DOCKER-USER
		counter packets 8013677 bytes 5071330329 jump DOCKER-FORWARD
		...
		counter packets 6738067 bytes 4635528589 jump ufw-before-logging-forward
		counter packets 6738067 bytes 4635528589 jump ufw-before-forward
		counter packets 303758 bytes 18236344 jump ufw-after-forward
		counter packets 303758 bytes 18236344 jump ufw-after-logging-forward
		counter packets 303758 bytes 18236344 jump ufw-reject-forward
		counter packets 303758 bytes 18236344 jump ufw-track-forward
		iifname "wg-home" counter packets 303758 bytes 18236344 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 12309 bytes 731020 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 12309 bytes 731020 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 394558 bytes 115037965 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1574171 bytes 192247151 return
		fib daddr type multicast counter packets 6537 bytes 209184 return
		fib daddr type broadcast counter packets 393347 bytes 114975739 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 666739 bytes 38400350 accept
		tcp dport 80 counter packets 293461 bytes 15919039 accept
		tcp dport 52000 counter packets 543 bytes 31888 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 70 bytes 3996 accept
		udp dport 21198 counter packets 2 bytes 1518 accept
		udp dport 21199 counter packets 1 bytes 399 accept
		udp dport 51820 counter packets 11 bytes 1747 accept
		ip saddr 91.242.163.206 udp dport 51822 counter packets 0 bytes 0 accept
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1708 bytes 102480 accept
		udp dport 443 counter packets 123442 bytes 91327581 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-15 14:19:42 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-15 06:21:04 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
