...
Generated: 2026-07-16T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-134-generic #134-Ubuntu SMP PREEMPT_DYNAMIC Fri Jun 26 18:43:11 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:02 up 1 day, 20:24,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0          10.79.0.2:53622      0.0.0.0:*    users:(("xray",pid=30133,fd=32))                                                                           
udp   UNCONN 0      0          10.79.0.2:54657      0.0.0.0:*    users:(("xray",pid=30133,fd=19))                                                                           
udp   UNCONN 0      0          10.79.0.2:55746      0.0.0.0:*    users:(("xray",pid=30133,fd=26))                                                                           
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=30133,fd=7))                                                                            
...
udp   UNCONN 0      0          10.79.0.2:42745      0.0.0.0:*    users:(("xray",pid=30133,fd=48))                                                                           
udp   UNCONN 0      0          10.79.0.2:40953      0.0.0.0:*    users:(("xray",pid=30133,fd=34))                                                                           
...
udp   UNCONN 0      0          10.79.0.2:60520      0.0.0.0:*    users:(("xray",pid=30133,fd=13))                                                                           
udp   UNCONN 0      0          10.79.0.2:57476      0.0.0.0:*    users:(("xray",pid=30133,fd=44))                                                                           
udp   UNCONN 0      0          10.79.0.2:53405      0.0.0.0:*    users:(("xray",pid=30133,fd=53))                                                                           
...
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=30154,fd=9),("nginx",pid=30153,fd=9),("nginx",pid=30152,fd=9),("nginx",pid=30151,fd=9))
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=1598,fd=3),("systemd",pid=1,fd=213))                                                    
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=30446,fd=13))                                                                         
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=30133,fd=6))                                                                            
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=30154,fd=7),("nginx",pid=30153,fd=7),("nginx",pid=30152,fd=7),("nginx",pid=30151,fd=7))
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=30154,fd=8),("nginx",pid=30153,fd=8),("nginx",pid=30152,fd=8),("nginx",pid=30151,fd=8))
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=30133,fd=3))                                                                            
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=30154,fd=10),("nginx",pid=30153,fd=10),("nginx",pid=30152,fd=10),("nginx",pid=30151,fd=10))
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 8002 bytes 948856 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 8002 bytes 1142582 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 8002 bytes 480280 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 3298969 bytes 1509124959 accept
		ct state related,established counter packets 63307255 bytes 62629115507 accept
		ct state invalid counter packets 18933 bytes 1096743 jump ufw-logging-deny
		ct state invalid counter packets 18933 bytes 1096743 drop
		...
		ip protocol icmp icmp type echo-request counter packets 371 bytes 16591 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 588566 bytes 55126464 jump ufw-not-local
		...
		counter packets 588566 bytes 55126464 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 3298969 bytes 1509124959 accept
		ct state related,established counter packets 53465959 bytes 47129183080 accept
		counter packets 389342 bytes 120551913 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 1699595 bytes 1198898134 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 20 bytes 560 accept
		counter packets 69651 bytes 4191976 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 15357 bytes 1198027 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 891 bytes 204039 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 24 bytes 1128 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 148 bytes 7256 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 11265 bytes 4480207 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 65955 bytes 21385291 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 8002 bytes 382950 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 8002 bytes 1782475 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 8002 bytes 480408 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 275013 bytes 16583526 accept
		ip protocol udp ct state new counter packets 110660 bytes 103610415 accept
	}
	...
	chain INPUT {
		...
		counter packets 67214094 bytes 64194480264 jump ufw-before-logging-input
		counter packets 67214094 bytes 64194480264 jump ufw-before-input
		counter packets 316411 bytes 38832250 jump ufw-after-input
		counter packets 222771 bytes 11556302 jump ufw-after-logging-input
		counter packets 222771 bytes 11556302 jump ufw-reject-input
		counter packets 222771 bytes 11556302 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 57154270 bytes 48758859952 jump ufw-before-logging-output
		counter packets 57154270 bytes 48758859952 jump ufw-before-output
		counter packets 389342 bytes 120551913 jump ufw-after-output
		counter packets 389342 bytes 120551913 jump ufw-after-logging-output
		counter packets 389342 bytes 120551913 jump ufw-reject-output
		counter packets 389342 bytes 120551913 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		ip daddr 10.91.0.0/24 iifname "tun79" oifname "tun91" ct state related,established counter packets 3810698 bytes 4566082115 accept
		ip saddr 10.91.0.0/24 iifname "tun91" oifname "tun79" counter packets 2175796 bytes 276336403 accept
		...
		counter packets 1769266 bytes 1203090670 jump ufw-before-logging-forward
		counter packets 1769266 bytes 1203090670 jump ufw-before-forward
		counter packets 69651 bytes 4191976 jump ufw-after-forward
		counter packets 69651 bytes 4191976 jump ufw-after-logging-forward
		counter packets 69651 bytes 4191976 jump ufw-reject-forward
		counter packets 69651 bytes 4191976 jump ufw-track-forward
		ip saddr 10.77.77.0/24 iifname "wg-home" oifname "tun79" counter packets 37768 bytes 2267312 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 2897 bytes 188793 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 2897 bytes 188793 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 93640 bytes 27275948 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 493843 bytes 27819717 return
		fib daddr type multicast counter packets 1277 bytes 40864 return
		fib daddr type broadcast counter packets 93446 bytes 27265883 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 271250 bytes 16244662 accept
		tcp dport 80 counter packets 838 bytes 45858 accept
		tcp dport 52000 counter packets 32 bytes 1728 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 16 bytes 900 accept
		udp dport 21198 counter packets 17 bytes 714 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-16 04:19:48 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-16 01:22:45 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
