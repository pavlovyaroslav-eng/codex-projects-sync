...
Generated: 2026-09-19T04:20:03+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:03 up 13 days, 59 min,  0 user,  load average: 0.01, 0.02, 0.00
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 56349 bytes 7610449 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 56349 bytes 4527824 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 56349 bytes 3383084 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 134144348 bytes 107409513162 accept
		ct state related,established counter packets 343533551 bytes 267366272297 accept
		ct state invalid counter packets 31255 bytes 1904698 jump ufw-logging-deny
		ct state invalid counter packets 31255 bytes 1904698 drop
		...
		ip protocol icmp icmp type echo-request counter packets 4373 bytes 239008 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2810810 bytes 412229849 jump ufw-not-local
		...
		counter packets 2810810 bytes 412229849 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 134144348 bytes 107409513162 accept
		ct state related,established counter packets 270133163 bytes 273107642116 accept
		counter packets 2989981 bytes 344089575 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 8452804 bytes 6043084437 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 418725 bytes 25138316 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 108903 bytes 8494434 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 4588 bytes 1049842 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 184 bytes 8724 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1493 bytes 68576 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 53039 bytes 16404874 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 12 bytes 336 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 360605 bytes 131058812 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 56349 bytes 2660556 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 56349 bytes 5700184 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 56349 bytes 3383084 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1766902 bytes 106116305 accept
		ip protocol udp ct state new counter packets 1189852 bytes 225196228 accept
	}
	...
	chain INPUT {
		...
		counter packets 480524337 bytes 375190159014 jump ufw-before-logging-input
		counter packets 480524337 bytes 375190159014 jump ufw-before-input
		counter packets 1204909 bytes 212442640 jump ufw-after-input
		counter packets 676085 bytes 55357042 jump ufw-after-logging-input
		counter packets 676085 bytes 55357042 jump ufw-reject-input
		counter packets 676085 bytes 55357042 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 407267492 bytes 380861244853 jump ufw-before-logging-output
		counter packets 407267492 bytes 380861244853 jump ufw-before-output
		counter packets 2989981 bytes 344089575 jump ufw-after-output
		counter packets 2989981 bytes 344089575 jump ufw-after-logging-output
		counter packets 2989981 bytes 344089575 jump ufw-reject-output
		counter packets 2989981 bytes 344089575 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1934801 bytes 1166672082 jump DOCKER-USER
		counter packets 1934801 bytes 1166672082 jump DOCKER-FORWARD
		...
		counter packets 8871529 bytes 6068222753 jump ufw-before-logging-forward
		counter packets 8871529 bytes 6068222753 jump ufw-before-forward
		counter packets 418725 bytes 25138316 jump ufw-after-forward
		counter packets 418725 bytes 25138316 jump ufw-after-logging-forward
		counter packets 418725 bytes 25138316 jump ufw-reject-forward
		counter packets 418725 bytes 25138316 jump ufw-track-forward
		iifname "wg-home" counter packets 418725 bytes 25138316 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 16006 bytes 958739 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 16006 bytes 958739 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 528824 bytes 157085598 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2274804 bytes 254948021 return
		fib daddr type multicast counter packets 9014 bytes 288448 return
		fib daddr type broadcast counter packets 526992 bytes 156993380 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1058624 bytes 60343986 accept
		tcp dport 80 counter packets 382230 bytes 20655900 accept
		tcp dport 52000 counter packets 627 bytes 36760 accept
		udp dport 21195 counter packets 1 bytes 403 accept
		udp dport 21196 counter packets 1 bytes 413 accept
		tcp dport 21197 counter packets 86 bytes 4888 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 2194 bytes 131640 accept
		udp dport 443 counter packets 162123 bytes 118609379 accept
	}
	...
	chain DOCKER-FORWARD {
		counter packets 1934801 bytes 1166672082 jump DOCKER-CT
		counter packets 1770516 bytes 1077505156 jump DOCKER-INTERNAL
		counter packets 1770516 bytes 1077505156 jump DOCKER-BRIDGE
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-19 04:19:35 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-18 13:12:56 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 388K
drwxr-xr-x  2 root root   4.0K Sep 19 03:20 .
