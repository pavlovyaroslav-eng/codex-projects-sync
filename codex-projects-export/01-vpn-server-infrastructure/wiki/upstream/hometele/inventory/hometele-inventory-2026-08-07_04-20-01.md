...
Generated: 2026-08-07T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-136-generic #136-Ubuntu SMP PREEMPT_DYNAMIC Wed Jul  1 21:53:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:02 up 20 days, 59 min,  1 user,  load average: 0.02, 0.02, 0.00
```
...
udp   UNCONN 0      0           10.8.1.2:52853      0.0.0.0:*    users:(("xray",pid=326671,fd=524))                                                                                 
udp   UNCONN 0      0           10.8.1.2:54924      0.0.0.0:*    users:(("xray",pid=326671,fd=291))                                                                                 
...
udp   UNCONN 0      0           10.8.1.2:42076      0.0.0.0:*    users:(("xray",pid=326671,fd=518))                                                                                 
udp   UNCONN 0      0           10.8.1.2:39140      0.0.0.0:*    users:(("xray",pid=326671,fd=1211))                                                                                
...
udp   UNCONN 0      0           10.8.1.2:52723      0.0.0.0:*    users:(("xray",pid=326671,fd=108))                                                                                 
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 86589 bytes 10232112 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 86589 bytes 15064909 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 73220 bytes 4400485 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 35647805 bytes 16333230748 accept
		ct state related,established counter packets 561684014 bytes 690042079793 accept
		ct state invalid counter packets 160252 bytes 8162599 jump ufw-logging-deny
		ct state invalid counter packets 160252 bytes 8162599 drop
		...
		ip protocol icmp icmp type echo-request counter packets 5631 bytes 281930 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 4806752 bytes 490181692 jump ufw-not-local
		...
		counter packets 4806752 bytes 490181692 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 35647805 bytes 16333230748 accept
		ct state related,established counter packets 444790708 bytes 413556800299 accept
		counter packets 4458353 bytes 1513973203 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 13481846 bytes 8986555032 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 4 bytes 112 accept
		counter packets 578953 bytes 34780593 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 88595 bytes 6910471 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 13622 bytes 3119573 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 188 bytes 8528 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1630 bytes 79220 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 98540 bytes 35026208 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 611048 bytes 213387039 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 86589 bytes 4189740 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 86589 bytes 22494014 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 73220 bytes 4400469 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 3040253 bytes 185049782 accept
		ip protocol udp ct state new counter packets 1386176 bytes 1325286861 accept
	}
	...
	chain INPUT {
		...
		counter packets 602304454 bytes 706873936762 jump ufw-before-logging-input
		counter packets 602304454 bytes 706873936762 jump ufw-before-input
		counter packets 1905856 bytes 319576325 jump ufw-after-input
		counter packets 1092233 bytes 61045286 jump ufw-after-logging-input
		counter packets 1092233 bytes 61045286 jump ufw-reject-input
		counter packets 1092233 bytes 61045286 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 484896866 bytes 431404004250 jump ufw-before-logging-output
		counter packets 484896866 bytes 431404004250 jump ufw-before-output
		counter packets 4458353 bytes 1513973203 jump ufw-after-output
		counter packets 4458353 bytes 1513973203 jump ufw-after-logging-output
		counter packets 4458353 bytes 1513973203 jump ufw-reject-output
		counter packets 4458353 bytes 1513973203 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 14060803 bytes 9021335737 jump ufw-before-logging-forward
		counter packets 14060803 bytes 9021335737 jump ufw-before-forward
		counter packets 578953 bytes 34780593 jump ufw-after-forward
		counter packets 578953 bytes 34780593 jump ufw-after-logging-forward
		counter packets 578953 bytes 34780593 jump ufw-reject-forward
		counter packets 578953 bytes 34780593 jump ufw-track-forward
		iifname "wg-home" counter packets 574600 bytes 34519252 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 39812 bytes 2207658 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 39812 bytes 2207658 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 813623 bytes 258531039 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 3981263 bytes 231307806 return
		fib daddr type multicast counter packets 13847 bytes 443104 return
		fib daddr type broadcast counter packets 811642 bytes 258430782 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 2877246 bytes 169243994 accept
		tcp dport 80 counter packets 23075 bytes 1310801 accept
		tcp dport 52000 counter packets 296 bytes 17100 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 79 bytes 4336 accept
		udp dport 21198 counter packets 49 bytes 2325 accept
		udp dport 21199 counter packets 0 bytes 0 accept
		udp dport 51820 counter packets 151 bytes 26811 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 47 | 2026-08-07 04:19:38 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-06 21:11:01 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 180K
drwxr-xr-x  2 root root   4.0K Aug  7 03:20 .
