...
Generated: 2026-09-02T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-138-generic #138-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 31 22:41:49 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 12 days, 59 min,  0 user,  load average: 0.04, 0.05, 0.01
```
...
udp   UNCONN 0      0           10.8.1.2:58325      0.0.0.0:*    users:(("xray",pid=971,fd=5225))                                                                               
udp   UNCONN 0      0           10.8.1.2:55256      0.0.0.0:*    users:(("xray",pid=971,fd=4551))                                                                               
udp   UNCONN 0      0           10.8.1.2:42021      0.0.0.0:*    users:(("xray",pid=971,fd=4614))                                                                               
udp   UNCONN 0      0         127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=147540,fd=16))                                                                   
udp   UNCONN 0      0      127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=147540,fd=14))                                                                   
udp   UNCONN 0      0           10.8.1.2:54326      0.0.0.0:*    users:(("xray",pid=971,fd=3396))                                                                               
udp   UNCONN 0      0           10.8.1.2:52296      0.0.0.0:*    users:(("xray",pid=971,fd=3376))                                                                               
udp   UNCONN 0      0           10.8.1.2:57519      0.0.0.0:*    users:(("xray",pid=971,fd=2833))                                                                               
udp   UNCONN 0      0           10.8.1.2:43240      0.0.0.0:*    users:(("xray",pid=971,fd=2535))                                                                               
udp   UNCONN 0      0           10.8.1.2:41193      0.0.0.0:*    users:(("xray",pid=971,fd=3168))                                                                               
udp   UNCONN 0      0           10.8.1.2:55554      0.0.0.0:*    users:(("xray",pid=971,fd=4056))                                                                               
udp   UNCONN 0      0           10.8.1.2:46392      0.0.0.0:*    users:(("xray",pid=971,fd=1716))                                                                               
udp   UNCONN 0      0           10.8.1.2:37181      0.0.0.0:*    users:(("xray",pid=971,fd=5229))                                                                               
udp   UNCONN 0      0           10.8.1.2:49514      0.0.0.0:*    users:(("xray",pid=971,fd=4109))                                                                               
udp   UNCONN 0      0           10.8.1.2:56757      0.0.0.0:*    users:(("xray",pid=971,fd=2013))                                                                               
udp   UNCONN 0      0           10.8.1.2:45568      0.0.0.0:*    users:(("xray",pid=971,fd=5310))                                                                               
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=971,fd=7))                                                                                  
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                                   
udp   UNCONN 0      0           10.8.1.2:36535      0.0.0.0:*    users:(("xray",pid=971,fd=4316))                                                                               
...
udp   UNCONN 0      0           10.8.1.2:39808      0.0.0.0:*    users:(("xray",pid=971,fd=3076))                                                                               
udp   UNCONN 0      0           10.8.1.2:55215      0.0.0.0:*    users:(("xray",pid=971,fd=3723))                                                                               
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                                                                   
udp   UNCONN 0      0               [::]:37619         [::]:*    users:(("amneziawg-go",pid=837,fd=15))                                                                         
tcp   LISTEN 0      4096      127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=147540,fd=17))                                                                   
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=971,fd=6))                                                                                  
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=147540,fd=15))                                                                   
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=147535,fd=3),("systemd",pid=1,fd=215))                                                      
...
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=147535,fd=4),("systemd",pid=1,fd=216))                                                      
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 52029 bytes 5443429 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 52029 bytes 10680583 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 22004 bytes 1330848 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 21520668 bytes 9761889137 accept
		ct state related,established counter packets 388950913 bytes 486508752962 accept
		ct state invalid counter packets 39750 bytes 2275654 jump ufw-logging-deny
		ct state invalid counter packets 39750 bytes 2275654 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3692 bytes 201250 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3138210 bytes 314592841 jump ufw-not-local
		...
		counter packets 3138210 bytes 314592841 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 21520668 bytes 9761889137 accept
		ct state related,established counter packets 299107858 bytes 297524160004 accept
		counter packets 2829087 bytes 1177700572 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6890502 bytes 4677274815 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 141109 bytes 8480524 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 129136 bytes 10072598 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 5627 bytes 1288583 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 177 bytes 8216 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 903 bytes 43616 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 49100 bytes 15221338 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 303516 bytes 115529794 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 52029 bytes 2383560 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 52029 bytes 15737667 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 22006 bytes 1330952 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1737784 bytes 105613996 accept
		ip protocol udp ct state new counter packets 1070078 bytes 1069726425 accept
	}
	...
	chain INPUT {
		...
		counter packets 413653233 bytes 496587711844 jump ufw-before-logging-input
		counter packets 413653233 bytes 496587711844 jump ufw-before-input
		counter packets 1219389 bytes 199925243 jump ufw-after-input
		counter packets 730929 bytes 57761070 jump ufw-after-logging-input
		counter packets 730929 bytes 57761070 jump ufw-reject-input
		counter packets 730929 bytes 57761070 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 323457613 bytes 308463749713 jump ufw-before-logging-output
		counter packets 323457613 bytes 308463749713 jump ufw-before-output
		counter packets 2829087 bytes 1177700572 jump ufw-after-output
		counter packets 2829087 bytes 1177700572 jump ufw-after-logging-output
		counter packets 2829087 bytes 1177700572 jump ufw-reject-output
		counter packets 2829087 bytes 1177700572 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 7031611 bytes 4685755339 jump ufw-before-logging-forward
		counter packets 7031611 bytes 4685755339 jump ufw-before-forward
		counter packets 141109 bytes 8480524 jump ufw-after-forward
		counter packets 141109 bytes 8480524 jump ufw-after-logging-forward
		counter packets 141109 bytes 8480524 jump ufw-reject-forward
		counter packets 141109 bytes 8480524 jump ufw-track-forward
		iifname "wg-home" counter packets 141109 bytes 8480524 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 19225 bytes 1137373 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 19225 bytes 1137373 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 488460 bytes 142164173 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2642609 bytes 172221968 return
		fib daddr type multicast counter packets 8321 bytes 266272 return
		fib daddr type broadcast counter packets 487280 bytes 142104601 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1761300 bytes 105583480 accept
		tcp dport 80 counter packets 157285 bytes 9067141 accept
		tcp dport 52000 counter packets 151 bytes 8310 accept
		udp dport 21195 counter packets 1 bytes 439 accept
		udp dport 21196 counter packets 1 bytes 439 accept
		tcp dport 21197 counter packets 56 bytes 3132 accept
		udp dport 21198 counter packets 1 bytes 439 accept
		udp dport 21199 counter packets 1 bytes 439 accept
		udp dport 51820 counter packets 25 bytes 3779 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-02 04:19:40 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-01 18:01:08 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 308K
drwxr-xr-x  2 root root   4.0K Sep  2 03:20 .
drwxrwxr-x 16 root syslog 4.0K Sep  1 00:00 ..
