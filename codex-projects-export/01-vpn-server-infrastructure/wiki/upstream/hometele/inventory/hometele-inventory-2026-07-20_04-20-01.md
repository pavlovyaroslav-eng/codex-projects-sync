...
Generated: 2026-07-20T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-136-generic #136-Ubuntu SMP PREEMPT_DYNAMIC Wed Jul  1 21:53:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 2 days, 59 min,  1 user,  load average: 0.06, 0.05, 0.02
```
...
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=11123,fd=7))                                                                        
udp   UNCONN 0      0           10.8.1.2:33347      0.0.0.0:*    users:(("xray",pid=11123,fd=406))                                                                      
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                           
udp   UNCONN 0      0           10.8.1.2:44662      0.0.0.0:*    users:(("xray",pid=11123,fd=176))                                                                      
udp   UNCONN 0      0           10.8.1.2:49832      0.0.0.0:*    users:(("xray",pid=11123,fd=451))                                                                      
udp   UNCONN 0      0           10.8.1.2:48826      0.0.0.0:*    users:(("xray",pid=11123,fd=321))                                                                      
...
udp   UNCONN 0      0           10.8.1.2:47834      0.0.0.0:*    users:(("xray",pid=11123,fd=666))                                                                      
udp   UNCONN 0      0           10.8.1.2:57077      0.0.0.0:*    users:(("xray",pid=11123,fd=730))                                                                      
udp   UNCONN 0      0           10.8.1.2:43776      0.0.0.0:*    users:(("xray",pid=11123,fd=232))                                                                      
udp   UNCONN 0      0           10.8.1.2:59189      0.0.0.0:*    users:(("xray",pid=11123,fd=620))                                                                      
udp   UNCONN 0      0           10.8.1.2:53188      0.0.0.0:*    users:(("xray",pid=11123,fd=308))                                                                      
udp   UNCONN 0      0           10.8.1.2:50125      0.0.0.0:*    users:(("xray",pid=11123,fd=676))                                                                      
udp   UNCONN 0      0           10.8.1.2:51171      0.0.0.0:*    users:(("xray",pid=11123,fd=369))                                                                      
...
udp   UNCONN 0      0           10.8.1.2:35901      0.0.0.0:*    users:(("xray",pid=11123,fd=709))                                                                      
udp   UNCONN 0      0           10.8.1.2:60582      0.0.0.0:*    users:(("xray",pid=11123,fd=667))                                                                      
udp   UNCONN 0      0           10.8.1.2:46294      0.0.0.0:*    users:(("xray",pid=11123,fd=147))                                                                      
udp   UNCONN 0      0           10.8.1.2:55545      0.0.0.0:*    users:(("xray",pid=11123,fd=643))                                                                      
udp   UNCONN 0      0           10.8.1.2:48472      0.0.0.0:*    users:(("xray",pid=11123,fd=82))                                                                       
...
udp   UNCONN 0      0           10.8.1.2:48627      0.0.0.0:*    users:(("xray",pid=11123,fd=516))                                                                      
...
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=11123,fd=6))                                                                        
...
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=11123,fd=3))                                                                        
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 8829 bytes 1194456 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 8829 bytes 1436626 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 8797 bytes 528273 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 2906709 bytes 1325436878 accept
		ct state related,established counter packets 59501897 bytes 65827138149 accept
		ct state invalid counter packets 42138 bytes 2225048 jump ufw-logging-deny
		ct state invalid counter packets 42138 bytes 2225048 drop
		...
		ip protocol icmp icmp type echo-request counter packets 582 bytes 31002 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 445381 bytes 52113213 jump ufw-not-local
		...
		counter packets 445381 bytes 52113213 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 2906709 bytes 1325436878 accept
		ct state related,established counter packets 47762587 bytes 39215089340 accept
		counter packets 328991 bytes 119007192 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 1520231 bytes 1055739975 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 4 bytes 112 accept
		counter packets 74196 bytes 4454329 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 735 bytes 57275 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 980 bytes 224420 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 20 bytes 916 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 120 bytes 5712 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 19512 bytes 9025500 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 70186 bytes 23013633 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 8829 bytes 430789 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 8829 bytes 2096518 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 8797 bytes 528257 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 210092 bytes 12683604 accept
		ip protocol udp ct state new counter packets 116388 bytes 106023880 accept
	}
	...
	chain INPUT {
		...
		counter packets 62896707 bytes 67206944290 jump ufw-before-logging-input
		counter packets 62896707 bytes 67206944290 jump ufw-before-input
		counter packets 204111 bytes 37941530 jump ufw-after-input
		counter packets 112558 bytes 5614074 jump ufw-after-logging-input
		counter packets 112558 bytes 5614074 jump ufw-reject-input
		counter packets 112558 bytes 5614074 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 50998287 bytes 40659533410 jump ufw-before-logging-output
		counter packets 50998287 bytes 40659533410 jump ufw-before-output
		counter packets 328991 bytes 119007192 jump ufw-after-output
		counter packets 328991 bytes 119007192 jump ufw-after-logging-output
		counter packets 328991 bytes 119007192 jump ufw-reject-output
		counter packets 328991 bytes 119007192 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 1594431 bytes 1060194416 jump ufw-before-logging-forward
		counter packets 1594431 bytes 1060194416 jump ufw-before-forward
		counter packets 74196 bytes 4454329 jump ufw-after-forward
		counter packets 74196 bytes 4454329 jump ufw-after-logging-forward
		counter packets 74196 bytes 4454329 jump ufw-reject-forward
		counter packets 74196 bytes 4454329 jump ufw-track-forward
		iifname "wg-home" counter packets 69843 bytes 4192988 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 5786 bytes 323951 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 5786 bytes 323951 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 91553 bytes 32327456 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 352590 bytes 19749706 return
		fib daddr type multicast counter packets 1410 bytes 45120 return
		fib daddr type broadcast counter packets 91381 bytes 32318387 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 239931 bytes 14079790 accept
		tcp dport 80 counter packets 1032 bytes 56701 accept
		tcp dport 52000 counter packets 97 bytes 5760 accept
		udp dport 21195 counter packets 0 bytes 0 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 12 bytes 648 accept
...
|---|---:|---:|---:|---:|---:|
| `/usr/local/etc/xray/config.json` | regular file | root:root | 644 | 14652 | 2026-07-18 08:59:07 |
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-20 04:19:36 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-20 04:06:01 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 100K
drwxr-xr-x  2 root root   4.0K Jul 20 03:20 .
