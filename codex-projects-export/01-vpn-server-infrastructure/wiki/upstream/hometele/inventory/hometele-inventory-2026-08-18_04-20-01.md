...
Generated: 2026-08-18T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-137-generic #137-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 17 20:28:23 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 10 days, 59 min,  0 user,  load average: 0.20, 0.11, 0.05
```
...
udp   UNCONN 0      0           10.8.1.2:53735      0.0.0.0:*    users:(("xray",pid=116591,fd=2239))                                                                            
udp   UNCONN 0      0           10.8.1.2:33303      0.0.0.0:*    users:(("xray",pid=116591,fd=2267))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:35435      0.0.0.0:*    users:(("xray",pid=116591,fd=1677))                                                                            
udp   UNCONN 0      0           10.8.1.2:42603      0.0.0.0:*    users:(("xray",pid=116591,fd=1839))                                                                            
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                                   
udp   UNCONN 0      0           10.8.1.2:36488      0.0.0.0:*    users:(("xray",pid=116591,fd=2067))                                                                            
udp   UNCONN 0      0           10.8.1.2:52887      0.0.0.0:*    users:(("xray",pid=116591,fd=2185))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:49901      0.0.0.0:*    users:(("xray",pid=116591,fd=2178))                                                                            
udp   UNCONN 0      0           10.8.1.2:58113      0.0.0.0:*    users:(("xray",pid=116591,fd=2382))                                                                            
udp   UNCONN 0      0           10.8.1.2:56071      0.0.0.0:*    users:(("xray",pid=116591,fd=2011))                                                                            
udp   UNCONN 0      0           10.8.1.2:37670      0.0.0.0:*    users:(("xray",pid=116591,fd=2255))                                                                            
udp   UNCONN 0      0            0.0.0.0:42910      0.0.0.0:*    users:(("openvpn",pid=827,fd=4))                                                                               
udp   UNCONN 0      0           10.8.1.2:36775      0.0.0.0:*    users:(("xray",pid=116591,fd=2179))                                                                            
udp   UNCONN 0      0           10.8.1.2:51162      0.0.0.0:*    users:(("xray",pid=116591,fd=1276))                                                                            
udp   UNCONN 0      0           10.8.1.2:38883      0.0.0.0:*    users:(("xray",pid=116591,fd=2036))                                                                            
udp   UNCONN 0      0           10.8.1.2:59425      0.0.0.0:*    users:(("xray",pid=116591,fd=1917))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:35897      0.0.0.0:*    users:(("xray",pid=116591,fd=2100))                                                                            
udp   UNCONN 0      0           10.8.1.2:34985      0.0.0.0:*    users:(("xray",pid=116591,fd=1226))                                                                            
udp   UNCONN 0      0           10.8.1.2:56547      0.0.0.0:*    users:(("xray",pid=116591,fd=1892))                                                                            
udp   UNCONN 0      0           10.8.1.2:54523      0.0.0.0:*    users:(("xray",pid=116591,fd=1883))                                                                            
udp   UNCONN 0      0           10.8.1.2:37148      0.0.0.0:*    users:(("xray",pid=116591,fd=2331))                                                                            
udp   UNCONN 0      0           10.8.1.2:57678      0.0.0.0:*    users:(("xray",pid=116591,fd=2303))                                                                            
udp   UNCONN 0      0           10.8.1.2:47460      0.0.0.0:*    users:(("xray",pid=116591,fd=1981))                                                                            
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 43389 bytes 4401067 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 43389 bytes 7381149 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 8330 bytes 511868 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 20623586 bytes 9425024403 accept
		ct state related,established counter packets 370032166 bytes 465143544103 accept
		ct state invalid counter packets 59091 bytes 2825404 jump ufw-logging-deny
		ct state invalid counter packets 59091 bytes 2825404 drop
		...
		ip protocol icmp icmp type echo-request counter packets 2843 bytes 142736 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2618734 bytes 244178861 jump ufw-not-local
		...
		counter packets 2618734 bytes 244178861 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 20623586 bytes 9425024403 accept
		ct state related,established counter packets 293036186 bytes 277325846798 accept
		counter packets 2708574 bytes 939933906 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6199055 bytes 4172386661 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 37290 bytes 2249852 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 38475 bytes 3001050 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 6270 bytes 1435830 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 110 bytes 5012 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 741 bytes 35680 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 40733 bytes 12571012 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 259512 bytes 97485293 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 43389 bytes 2063643 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 43389 bytes 10747749 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 8332 bytes 511972 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1803287 bytes 109288206 accept
		ip protocol udp ct state new counter packets 885286 bytes 828650206 accept
	}
	...
	chain INPUT {
		...
		counter packets 393336420 bytes 474815715507 jump ufw-before-logging-input
		counter packets 393336420 bytes 474815715507 jump ufw-before-input
		counter packets 937970 bytes 143878243 jump ufw-after-input
		counter packets 592129 bytes 29344366 jump ufw-after-logging-input
		counter packets 592129 bytes 29344366 jump ufw-reject-input
		counter packets 592129 bytes 29344366 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 316368346 bytes 287690805107 jump ufw-before-logging-output
		counter packets 316368346 bytes 287690805107 jump ufw-before-output
		counter packets 2708574 bytes 939933906 jump ufw-after-output
		counter packets 2708574 bytes 939933906 jump ufw-after-logging-output
		counter packets 2708574 bytes 939933906 jump ufw-reject-output
		counter packets 2708574 bytes 939933906 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 6236345 bytes 4174636513 jump ufw-before-logging-forward
		counter packets 6236345 bytes 4174636513 jump ufw-before-forward
		counter packets 37290 bytes 2249852 jump ufw-after-forward
		counter packets 37290 bytes 2249852 jump ufw-after-logging-forward
		counter packets 37290 bytes 2249852 jump ufw-reject-forward
		counter packets 37290 bytes 2249852 jump ufw-track-forward
		iifname "wg-home" counter packets 37290 bytes 2249852 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 22834 bytes 1133233 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 22834 bytes 1133233 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 345841 bytes 114533877 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2266870 bytes 129468646 return
		fib daddr type multicast counter packets 6940 bytes 222080 return
		fib daddr type broadcast counter packets 344924 bytes 114488135 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1673570 bytes 99899005 accept
		tcp dport 80 counter packets 6891 bytes 382487 accept
		tcp dport 52000 counter packets 245 bytes 14208 accept
		udp dport 21195 counter packets 1 bytes 54 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 36 bytes 2000 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-18 04:20:00 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-18 01:54:19 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 232K
drwxr-xr-x  2 root root   4.0K Aug 18 03:20 .
