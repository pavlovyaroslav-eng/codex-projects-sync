...
Generated: 2026-08-13T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-137-generic #137-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 17 20:28:23 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 5 days, 59 min,  0 user,  load average: 0.01, 0.03, 0.00
```
...
udp   UNCONN 0      0           10.8.1.2:39455      0.0.0.0:*    users:(("xray",pid=67822,fd=543))                                                                              
udp   UNCONN 0      0           10.8.1.2:33317      0.0.0.0:*    users:(("xray",pid=67822,fd=423))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:60057      0.0.0.0:*    users:(("xray",pid=67822,fd=486))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:55001      0.0.0.0:*    users:(("xray",pid=67822,fd=435))                                                                              
udp   UNCONN 0      0           10.8.1.2:38643      0.0.0.0:*    users:(("xray",pid=67822,fd=594))                                                                              
udp   UNCONN 0      0           10.8.1.2:48902      0.0.0.0:*    users:(("xray",pid=67822,fd=403))                                                                              
udp   UNCONN 0      0            0.0.0.0:42910      0.0.0.0:*    users:(("openvpn",pid=827,fd=4))                                                                               
udp   UNCONN 0      0           10.8.1.2:59302      0.0.0.0:*    users:(("xray",pid=67822,fd=382))                                                                              
udp   UNCONN 0      0           10.8.1.2:52148      0.0.0.0:*    users:(("xray",pid=67822,fd=483))                                                                              
udp   UNCONN 0      0           10.8.1.2:49086      0.0.0.0:*    users:(("xray",pid=67822,fd=422))                                                                              
udp   UNCONN 0      0           10.8.1.2:53188      0.0.0.0:*    users:(("xray",pid=67822,fd=589))                                                                              
...
udp   UNCONN 0      0           10.8.1.2:46139      0.0.0.0:*    users:(("xray",pid=67822,fd=502))                                                                              
udp   UNCONN 0      0           10.8.1.2:32916      0.0.0.0:*    users:(("xray",pid=67822,fd=623))                                                                              
udp   UNCONN 0      0           10.8.1.2:35076      0.0.0.0:*    users:(("xray",pid=67822,fd=576))                                                                              
udp   UNCONN 0      0           10.8.1.2:48434      0.0.0.0:*    users:(("xray",pid=67822,fd=518))                                                                              
udp   UNCONN 0      0           10.8.1.2:58679      0.0.0.0:*    users:(("xray",pid=67822,fd=280))                                                                              
udp   UNCONN 0      0           10.8.1.2:48512      0.0.0.0:*    users:(("xray",pid=67822,fd=535))                                                                              
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 21789 bytes 2315143 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 21789 bytes 4127343 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 4218 bytes 259708 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 10877579 bytes 4972017534 accept
		ct state related,established counter packets 164197141 bytes 198193583725 accept
		ct state invalid counter packets 41436 bytes 1930566 jump ufw-logging-deny
		ct state invalid counter packets 41436 bytes 1930566 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1507 bytes 74785 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1302018 bytes 121545650 jump ufw-not-local
		...
		counter packets 1302018 bytes 121545650 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 10877579 bytes 4972017534 accept
		ct state related,established counter packets 134816609 bytes 119757788685 accept
		counter packets 1276496 bytes 482439409 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 3055775 bytes 2076462804 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 17899 bytes 1080744 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 7229 bytes 563862 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3687 bytes 844323 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 60 bytes 2780 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 388 bytes 18700 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 20504 bytes 6340480 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 128077 bytes 48623992 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 21789 bytes 1066120 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 21789 bytes 6061783 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 4220 bytes 259812 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 801319 bytes 48597845 accept
		ip protocol udp ct state new counter packets 463832 bytes 432745122 accept
	}
	...
	chain INPUT {
		...
		counter packets 176419681 bytes 203289152260 jump ufw-before-logging-input
		counter packets 176419681 bytes 203289152260 jump ufw-before-input
		counter packets 418286 bytes 69565772 jump ufw-after-input
		counter packets 258341 bytes 13171635 jump ufw-after-logging-input
		counter packets 258341 bytes 13171635 jump ufw-reject-input
		counter packets 258341 bytes 13171635 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 146970684 bytes 125212245628 jump ufw-before-logging-output
		counter packets 146970684 bytes 125212245628 jump ufw-before-output
		counter packets 1276496 bytes 482439409 jump ufw-after-output
		counter packets 1276496 bytes 482439409 jump ufw-after-logging-output
		counter packets 1276496 bytes 482439409 jump ufw-reject-output
		counter packets 1276496 bytes 482439409 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 3073674 bytes 2077543548 jump ufw-before-logging-forward
		counter packets 3073674 bytes 2077543548 jump ufw-before-forward
		counter packets 17899 bytes 1080744 jump ufw-after-forward
		counter packets 17899 bytes 1080744 jump ufw-after-logging-forward
		counter packets 17899 bytes 1080744 jump ufw-reject-forward
		counter packets 17899 bytes 1080744 jump ufw-track-forward
		iifname "wg-home" counter packets 17899 bytes 1080744 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 14625 bytes 680242 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 14625 bytes 680242 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 159945 bytes 56394137 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1139067 bytes 65063793 return
		fib daddr type multicast counter packets 3485 bytes 111520 return
		fib daddr type broadcast counter packets 159466 bytes 56370337 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 881442 bytes 51851520 accept
		tcp dport 80 counter packets 2157 bytes 119032 accept
		tcp dport 52000 counter packets 89 bytes 5148 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-13 04:19:54 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-12 13:18:26 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 208K
drwxr-xr-x  2 root root   4.0K Aug 13 03:20 .
