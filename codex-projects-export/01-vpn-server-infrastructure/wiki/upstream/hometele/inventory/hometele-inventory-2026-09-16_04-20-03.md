...
Generated: 2026-09-16T04:20:03+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:03 up 10 days, 59 min,  0 user,  load average: 0.03, 0.03, 0.00
```
...
udp   UNCONN 0      0                  *:34457            *:*    users:(("rw-core",pid=1482976,fd=10))                                                                              
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 43389 bytes 6038381 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 43389 bytes 3668087 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 43389 bytes 2604908 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 100577135 bytes 81161607652 accept
		ct state related,established counter packets 270811656 bytes 215300433414 accept
		ct state invalid counter packets 23640 bytes 1442590 jump ufw-logging-deny
		ct state invalid counter packets 23640 bytes 1442590 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3162 bytes 172515 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2063174 bytes 325263391 jump ufw-not-local
		...
		counter packets 2063174 bytes 325263391 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 100577135 bytes 81161607652 accept
		ct state related,established counter packets 215197003 bytes 219620521627 accept
		counter packets 2867390 bytes 335035292 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6823879 bytes 4889830150 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 322711 bytes 19374132 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 97073 bytes 7571694 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3517 bytes 804664 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 146 bytes 6976 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1022 bytes 47524 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 40900 bytes 12666098 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 9 bytes 252 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 277899 bytes 101084340 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 43389 bytes 2054730 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 43389 bytes 4722810 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 43389 bytes 2604908 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1749613 bytes 105060879 accept
		ip protocol udp ct state new counter packets 1086266 bytes 217341374 accept
	}
	...
	chain INPUT {
		...
		counter packets 373478767 bytes 296788919562 jump ufw-before-logging-input
		counter packets 373478767 bytes 296788919562 jump ufw-before-input
		counter packets 935231 bytes 169805413 jump ufw-after-input
		counter packets 514665 bytes 47623865 jump ufw-after-logging-input
		counter packets 514665 bytes 47623865 jump ufw-reject-input
		counter packets 514665 bytes 47623865 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 318641528 bytes 301117164571 jump ufw-before-logging-output
		counter packets 318641528 bytes 301117164571 jump ufw-before-output
		counter packets 2867390 bytes 335035292 jump ufw-after-output
		counter packets 2867390 bytes 335035292 jump ufw-after-logging-output
		counter packets 2867390 bytes 335035292 jump ufw-reject-output
		counter packets 2867390 bytes 335035292 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 8501634 bytes 5371767052 jump DOCKER-USER
		counter packets 8501634 bytes 5371767052 jump DOCKER-FORWARD
		...
		counter packets 7146590 bytes 4909204282 jump ufw-before-logging-forward
		counter packets 7146590 bytes 4909204282 jump ufw-before-forward
		counter packets 322711 bytes 19374132 jump ufw-after-forward
		counter packets 322711 bytes 19374132 jump ufw-after-logging-forward
		counter packets 322711 bytes 19374132 jump ufw-reject-forward
		counter packets 322711 bytes 19374132 jump ufw-track-forward
		iifname "wg-home" counter packets 322711 bytes 19374132 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 13113 bytes 778219 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 13113 bytes 778219 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 420566 bytes 122181548 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1636956 bytes 202926081 return
		fib daddr type multicast counter packets 6941 bytes 222112 return
		fib daddr type broadcast counter packets 419277 bytes 122115198 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 695154 bytes 40107689 accept
		tcp dport 80 counter packets 297457 bytes 16080971 accept
		tcp dport 52000 counter packets 597 bytes 35060 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 1811 bytes 108660 accept
		udp dport 443 counter packets 132838 bytes 99117122 accept
	}
...
headscale   headscale/headscale:0.29.3   Up 10 days (healthy)   127.0.0.1:8081->8080/tcp, 127.0.0.1:9091->9090/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-16 04:19:41 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-16 00:41:38 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 376K
drwxr-xr-x  2 root root   4.0K Sep 16 03:20 .
