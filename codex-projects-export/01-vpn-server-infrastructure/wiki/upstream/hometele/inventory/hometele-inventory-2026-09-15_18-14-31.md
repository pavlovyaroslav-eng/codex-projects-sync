...
Generated: 2026-09-15T18:14:31+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 18:14:31 up 9 days, 14:54,  1 user,  load average: 0.06, 0.07, 0.08
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 41572 bytes 5785326 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 41572 bytes 3541333 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 41572 bytes 2495824 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 94114510 bytes 76960735378 accept
		ct state related,established counter packets 254560081 bytes 204875626819 accept
		...
		counter packets 2003363 bytes 315293517 jump ufw-not-local
		...
		counter packets 2003363 bytes 315293517 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 94114510 bytes 76960735378 accept
		ct state related,established counter packets 202714472 bytes 209280947029 accept
		counter packets 2850340 bytes 333688061 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6519057 bytes 4679013529 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 308933 bytes 18547020 jump ufw-user-forward
	}
	...
	chain ufw-after-input {
		...
		udp dport 67 counter packets 39199 bytes 12142226 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 9 bytes 252 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 266500 bytes 96914419 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 41572 bytes 1969814 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 41572 bytes 4577535 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 41572 bytes 2495824 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1747126 bytes 104911659 accept
		ip protocol udp ct state new counter packets 1071899 bytes 216157860 accept
	}
	...
	chain INPUT {
		...
		counter packets 350703680 bytes 282153211993 jump ufw-before-logging-input
		counter packets 350703680 bytes 282153211993 jump ufw-before-input
		counter packets 901339 bytes 163924727 jump ufw-after-input
		counter packets 499403 bytes 46888084 jump ufw-after-logging-input
		counter packets 499403 bytes 46888084 jump ufw-reject-input
		counter packets 499403 bytes 46888084 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 299679322 bytes 286575370468 jump ufw-before-logging-output
		counter packets 299679322 bytes 286575370468 jump ufw-before-output
		counter packets 2850340 bytes 333688061 jump ufw-after-output
		counter packets 2850340 bytes 333688061 jump ufw-after-logging-output
		counter packets 2850340 bytes 333688061 jump ufw-reject-output
		counter packets 2850340 bytes 333688061 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 8125909 bytes 5140854565 jump DOCKER-USER
		counter packets 8125909 bytes 5140854565 jump DOCKER-FORWARD
		...
		counter packets 6827990 bytes 4697560549 jump ufw-before-logging-forward
		counter packets 6827990 bytes 4697560549 jump ufw-before-forward
		counter packets 308933 bytes 18547020 jump ufw-after-forward
		counter packets 308933 bytes 18547020 jump ufw-after-logging-forward
		counter packets 308933 bytes 18547020 jump ufw-reject-forward
		counter packets 308933 bytes 18547020 jump ufw-track-forward
		iifname "wg-home" counter packets 308933 bytes 18547020 accept
	...
	chain ufw-skip-to-policy-input {
		counter packets 401936 bytes 117036643 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1596012 bytes 198107386 return
		fib daddr type multicast counter packets 6650 bytes 212800 return
		fib daddr type broadcast counter packets 400701 bytes 116973331 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 676360 bytes 38981504 accept
		tcp dport 80 counter packets 294573 bytes 15964035 accept
		tcp dport 52000 counter packets 568 bytes 33388 accept
		...
		udp dport 443 counter packets 128698 bytes 96277047 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-15 18:14:17 |
