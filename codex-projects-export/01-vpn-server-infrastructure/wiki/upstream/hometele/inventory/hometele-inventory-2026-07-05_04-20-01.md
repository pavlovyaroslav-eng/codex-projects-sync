...
Generated: 2026-07-05T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-124-generic #124-Ubuntu SMP PREEMPT_DYNAMIC Tue May 26 13:00:45 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 4 days,  4:07,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=54549,fd=7))                                                                                
...
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=54549,fd=6))                                                                                
...
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=54571,fd=9),("nginx",pid=54570,fd=9),("nginx",pid=54569,fd=9),("nginx",pid=54568,fd=9))    
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=15))                                                                      
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=54864,fd=13))                                                                             
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=54571,fd=7),("nginx",pid=54570,fd=7),("nginx",pid=54569,fd=7),("nginx",pid=54568,fd=7))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1275,fd=4),("systemd",pid=1,fd=171))                                                        
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=54549,fd=3))                                                                                
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=54571,fd=10),("nginx",pid=54570,fd=10),("nginx",pid=54569,fd=10),("nginx",pid=54568,fd=10))
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=54571,fd=8),("nginx",pid=54570,fd=8),("nginx",pid=54569,fd=8),("nginx",pid=54568,fd=8))    
```
...
table ip6 filter {
	...
	chain ufw6-before-output {
		...
		meta l4proto ipv6-icmp icmpv6 type echo-request counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type echo-reply counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type nd-router-solicit ip6 hoplimit 255 counter packets 743 bytes 36504 accept
		meta l4proto ipv6-icmp icmpv6 type nd-neighbor-advert ip6 hoplimit 255 counter packets 0 bytes 0 accept
	...
	chain OUTPUT {
		...
		counter packets 748 bytes 36880 jump ufw6-before-logging-output
		counter packets 748 bytes 36880 jump ufw6-before-output
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 41 | 2026-07-05 04:19:48 |
