...
Generated: 2026-09-13T09:30:12+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 09:30:13 up 7 days,  6:10,  2 users,  load average: 0.08, 0.04, 0.01
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 31359 bytes 4028139 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 31359 bytes 2765766 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 31359 bytes 1882708 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 66552857 bytes 45845464952 accept
		ct state related,established counter packets 187441313 bytes 134705304391 accept
		ct state invalid counter packets 17574 bytes 1061786 jump ufw-logging-deny
		ct state invalid counter packets 17574 bytes 1061786 drop
		...
		counter packets 1532274 bytes 205227021 jump ufw-not-local
		...
		counter packets 1532274 bytes 205227021 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 66552857 bytes 45845464952 accept
		ct state related,established counter packets 150958263 bytes 137125428549 accept
		counter packets 1741663 bytes 210974008 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4862359 bytes 3486862216 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 232902 bytes 13982504 jump ufw-user-forward
	}
	...
	chain ufw-after-input {
		...
		udp dport 67 counter packets 29367 bytes 9044820 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 6 bytes 168 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 200913 bytes 73143507 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 31359 bytes 1477279 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 31359 bytes 3547382 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 31359 bytes 1882708 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 999476 bytes 60010351 accept
		ip protocol udp ct state new counter packets 721844 bytes 142921704 accept
	}
	...
	chain INPUT {
		...
		counter packets 255546301 bytes 180757174882 jump ufw-before-logging-input
		counter packets 255546301 bytes 180757174882 jump ufw-before-input
		counter packets 639346 bytes 104245133 jump ufw-after-input
		counter packets 345593 bytes 16738906 jump ufw-after-logging-input
		counter packets 345593 bytes 16738906 jump ufw-reject-input
		counter packets 345593 bytes 16738906 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 219252783 bytes 183181867509 jump ufw-before-logging-output
		counter packets 219252783 bytes 183181867509 jump ufw-before-output
		counter packets 1741663 bytes 210974008 jump ufw-after-output
		counter packets 1741663 bytes 210974008 jump ufw-after-logging-output
		counter packets 1741663 bytes 210974008 jump ufw-reject-output
		counter packets 1741663 bytes 210974008 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 6074646 bytes 3834727424 jump DOCKER-USER
		counter packets 6074646 bytes 3834727424 jump DOCKER-FORWARD
		...
		counter packets 5095261 bytes 3500844720 jump ufw-before-logging-forward
		counter packets 5095261 bytes 3500844720 jump ufw-before-forward
		counter packets 232902 bytes 13982504 jump ufw-after-forward
		counter packets 232902 bytes 13982504 jump ufw-after-logging-forward
		counter packets 232902 bytes 13982504 jump ufw-reject-forward
		counter packets 232902 bytes 13982504 jump ufw-track-forward
		iifname "wg-home" counter packets 232902 bytes 13982504 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 9264 bytes 540500 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 9264 bytes 540500 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 293753 bytes 87506227 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1234454 bytes 117609454 return
		fib daddr type multicast counter packets 5016 bytes 160512 return
		fib daddr type broadcast counter packets 292804 bytes 87457055 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 530634 bytes 30227053 accept
		tcp dport 80 counter packets 278340 bytes 15294268 accept
		tcp dport 52000 counter packets 466 bytes 27304 accept
		...
		udp dport 443 counter packets 82120 bytes 55349545 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-13 09:30:02 |
