...
Generated: 2026-09-13T09:39:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-139-generic #139-Ubuntu SMP PREEMPT_DYNAMIC Sat Aug  1 03:52:05 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 09:39:01 up 7 days,  6:18,  2 users,  load average: 0.07, 0.06, 0.01
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 31386 bytes 4032359 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 31386 bytes 2767574 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 31385 bytes 1884268 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 66617519 bytes 45913108558 accept
		ct state related,established counter packets 187558826 bytes 134820891722 accept
		...
		counter packets 1533114 bytes 205401901 jump ufw-not-local
		...
		counter packets 1533114 bytes 205401901 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 66617519 bytes 45913108558 accept
		ct state related,established counter packets 151050807 bytes 137246535022 accept
		counter packets 1742142 bytes 211020271 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 4862633 bytes 3486921250 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 233085 bytes 13993484 jump ufw-user-forward
	}
	...
	chain ufw-after-input {
		...
		tcp dport 445 counter packets 742 bytes 34864 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 29391 bytes 9052212 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 6 bytes 168 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 201088 bytes 73205365 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 31386 bytes 1478427 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 31386 bytes 3549353 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 31385 bytes 1884268 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 999617 bytes 60018811 accept
		ip protocol udp ct state new counter packets 722181 bytes 142959423 accept
	}
	...
	chain INPUT {
		...
		counter packets 255729320 bytes 180940580859 jump ufw-before-logging-input
		counter packets 255729320 bytes 180940580859 jump ufw-before-input
		counter packets 639814 bytes 104327817 jump ufw-after-input
		counter packets 345857 bytes 16751569 jump ufw-after-logging-input
		counter packets 345857 bytes 16751569 jump ufw-reject-input
		counter packets 345857 bytes 16751569 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 219410468 bytes 183370663851 jump ufw-before-logging-output
		counter packets 219410468 bytes 183370663851 jump ufw-before-output
		counter packets 1742142 bytes 211020271 jump ufw-after-output
		counter packets 1742142 bytes 211020271 jump ufw-after-logging-output
		counter packets 1742142 bytes 211020271 jump ufw-reject-output
		counter packets 1742142 bytes 211020271 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 6075932 bytes 3835065473 jump DOCKER-USER
		counter packets 6075932 bytes 3835065473 jump DOCKER-FORWARD
		...
		counter packets 5095718 bytes 3500914734 jump ufw-before-logging-forward
		counter packets 5095718 bytes 3500914734 jump ufw-before-forward
		counter packets 233085 bytes 13993484 jump ufw-after-forward
		counter packets 233085 bytes 13993484 jump ufw-after-logging-forward
		counter packets 233085 bytes 13993484 jump ufw-reject-forward
		counter packets 233085 bytes 13993484 jump ufw-track-forward
		iifname "wg-home" counter packets 233085 bytes 13993484 accept
	...
	chain ufw-skip-to-policy-input {
		counter packets 293957 bytes 87576248 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1235088 bytes 117714269 return
		fib daddr type multicast counter packets 5020 bytes 160640 return
		fib daddr type broadcast counter packets 293006 bytes 87526992 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 530803 bytes 30237137 accept
		tcp dport 80 counter packets 278380 bytes 15295892 accept
		tcp dport 52000 counter packets 481 bytes 28204 accept
		...
		udp dport 443 counter packets 82268 bytes 55429133 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-13 09:38:38 |
