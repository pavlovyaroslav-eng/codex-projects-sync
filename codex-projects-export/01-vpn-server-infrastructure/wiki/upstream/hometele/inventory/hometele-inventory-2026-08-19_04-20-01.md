...
Generated: 2026-08-19T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-137-generic #137-Ubuntu SMP PREEMPT_DYNAMIC Fri Jul 17 20:28:23 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 11 days, 59 min,  0 user,  load average: 0.05, 0.08, 0.02
```
...
udp   UNCONN 0      0           10.8.1.2:53727      0.0.0.0:*    users:(("xray",pid=116591,fd=1980))                                                                            
udp   UNCONN 0      0           10.8.1.2:50720      0.0.0.0:*    users:(("xray",pid=116591,fd=2722))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:44652      0.0.0.0:*    users:(("xray",pid=116591,fd=2191))                                                                            
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                                                                   
udp   UNCONN 0      0           10.8.1.2:51827      0.0.0.0:*    users:(("xray",pid=116591,fd=1894))                                                                            
udp   UNCONN 0      0           10.8.1.2:53877      0.0.0.0:*    users:(("xray",pid=116591,fd=2690))                                                                            
udp   UNCONN 0      0           10.8.1.2:43639      0.0.0.0:*    users:(("xray",pid=116591,fd=1915))                                                                            
udp   UNCONN 0      0           10.8.1.2:45731      0.0.0.0:*    users:(("xray",pid=116591,fd=2793))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:45803      0.0.0.0:*    users:(("xray",pid=116591,fd=2664))                                                                            
udp   UNCONN 0      0           10.8.1.2:55070      0.0.0.0:*    users:(("xray",pid=116591,fd=1970))                                                                            
udp   UNCONN 0      0            0.0.0.0:42910      0.0.0.0:*    users:(("openvpn",pid=827,fd=4))                                                                               
udp   UNCONN 0      0           10.8.1.2:35751      0.0.0.0:*    users:(("xray",pid=116591,fd=2812))                                                                            
udp   UNCONN 0      0           10.8.1.2:46023      0.0.0.0:*    users:(("xray",pid=116591,fd=2542))                                                                            
udp   UNCONN 0      0           10.8.1.2:50136      0.0.0.0:*    users:(("xray",pid=116591,fd=2149))                                                                            
udp   UNCONN 0      0           10.8.1.2:55329      0.0.0.0:*    users:(("xray",pid=116591,fd=2300))                                                                            
...
udp   UNCONN 0      0           10.8.1.2:47158      0.0.0.0:*    users:(("xray",pid=116591,fd=2143))                                                                            
udp   UNCONN 0      0           10.8.1.2:39199      0.0.0.0:*    users:(("xray",pid=116591,fd=2419))                                                                            
udp   UNCONN 0      0           10.8.1.2:56658      0.0.0.0:*    users:(("xray",pid=116591,fd=2581))                                                                            
udp   UNCONN 0      0           10.8.1.2:57701      0.0.0.0:*    users:(("xray",pid=116591,fd=2699))                                                                            
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 47709 bytes 4833711 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 47709 bytes 8655643 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-forward {
		ct state new limit rate 3/minute burst 10 packets counter packets 9209 bytes 565760 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-input {
		iifname "lo" counter packets 22113366 bytes 10102693087 accept
		ct state related,established counter packets 415059359 bytes 527404446089 accept
		ct state invalid counter packets 63083 bytes 3023599 jump ufw-logging-deny
		ct state invalid counter packets 63083 bytes 3023599 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3078 bytes 154088 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2853023 bytes 266919208 jump ufw-not-local
		...
		counter packets 2853023 bytes 266919208 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 22113366 bytes 10102693087 accept
		ct state related,established counter packets 325572035 bytes 311911315961 accept
		counter packets 2939106 bytes 1071361804 jump ufw-user-output
	}

	chain ufw-before-forward {
		ct state related,established counter packets 6760588 bytes 4552276751 accept
		ip protocol icmp icmp type destination-unreachable counter packets 0 bytes 0 accept
		ip protocol icmp icmp type time-exceeded counter packets 0 bytes 0 accept
		ip protocol icmp icmp type parameter-problem counter packets 0 bytes 0 accept
		ip protocol icmp icmp type echo-request counter packets 0 bytes 0 accept
		counter packets 40901 bytes 2467712 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 48227 bytes 3761706 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 6750 bytes 1545750 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 121 bytes 5512 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 858 bytes 41024 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 44780 bytes 13817488 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 284202 bytes 107017289 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 47709 bytes 2262252 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 47709 bytes 12804904 log prefix "[UFW ALLOW] "
	}

	chain ufw-after-logging-forward {
		limit rate 3/minute burst 10 packets counter packets 9211 bytes 565864 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1914319 bytes 116066880 accept
		ip protocol udp ct state new counter packets 1002883 bytes 953093129 accept
	}
	...
	chain INPUT {
		...
		counter packets 440091909 bytes 537777236071 jump ufw-before-logging-input
		counter packets 440091909 bytes 537777236071 jump ufw-before-input
		counter packets 1045187 bytes 158925667 jump ufw-after-input
		counter packets 660249 bytes 32736898 jump ufw-after-logging-input
		counter packets 660249 bytes 32736898 jump ufw-reject-input
		counter packets 660249 bytes 32736898 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		counter packets 350624507 bytes 323085370852 jump ufw-before-logging-output
		counter packets 350624507 bytes 323085370852 jump ufw-before-output
		counter packets 2939106 bytes 1071361804 jump ufw-after-output
		counter packets 2939106 bytes 1071361804 jump ufw-after-logging-output
		counter packets 2939106 bytes 1071361804 jump ufw-reject-output
		counter packets 2939106 bytes 1071361804 jump ufw-track-output
	}
	...
	chain FORWARD {
		...
		counter packets 6801489 bytes 4554744463 jump ufw-before-logging-forward
		counter packets 6801489 bytes 4554744463 jump ufw-before-forward
		counter packets 40901 bytes 2467712 jump ufw-after-forward
		counter packets 40901 bytes 2467712 jump ufw-after-logging-forward
		counter packets 40901 bytes 2467712 jump ufw-reject-forward
		counter packets 40901 bytes 2467712 jump ufw-track-forward
		iifname "wg-home" counter packets 40901 bytes 2467712 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 24034 bytes 1204675 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 24034 bytes 1204675 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 384938 bytes 126188769 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2461506 bytes 140538379 return
		fib daddr type multicast counter packets 7631 bytes 244192 return
		fib daddr type broadcast counter packets 383886 bytes 126136637 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 1800076 bytes 107561748 accept
		tcp dport 80 counter packets 7443 bytes 411923 accept
		tcp dport 52000 counter packets 258 bytes 14912 accept
		udp dport 21195 counter packets 1 bytes 54 accept
		udp dport 21196 counter packets 0 bytes 0 accept
		tcp dport 21197 counter packets 37 bytes 2040 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-19 04:19:37 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-18 21:28:26 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 236K
drwxr-xr-x  2 root root   4.0K Aug 19 03:20 .
