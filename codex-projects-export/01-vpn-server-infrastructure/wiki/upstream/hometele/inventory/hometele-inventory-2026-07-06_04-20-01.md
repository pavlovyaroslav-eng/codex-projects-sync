...
Generated: 2026-07-06T04:20:01+03:00  
Host: hometele  
...
Linux hometele 6.8.0-124-generic #124-Ubuntu SMP PREEMPT_DYNAMIC Tue May 26 13:00:45 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:20:01 up 5 days,  4:07,  0 user,  load average: 0.00, 0.00, 0.00
```
...
udp   UNCONN 0      0          127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=71887,fd=6))                                                                                
...
tcp   LISTEN 0      4096       127.0.0.1:10808      0.0.0.0:*    users:(("xray",pid=71887,fd=3))                                                                                
...
tcp   LISTEN 0      511        127.0.0.1:8443       0.0.0.0:*    users:(("nginx",pid=71909,fd=9),("nginx",pid=71908,fd=9),("nginx",pid=71907,fd=9),("nginx",pid=71906,fd=9))    
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=587,fd=15))                                                                      
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=72203,fd=13))                                                                             
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=71909,fd=7),("nginx",pid=71908,fd=7),("nginx",pid=71907,fd=7),("nginx",pid=71906,fd=7))    
tcp   LISTEN 0      4096            [::]:52000         [::]:*    users:(("sshd",pid=1275,fd=4),("systemd",pid=1,fd=171))                                                        
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray",pid=71887,fd=7))                                                                                
tcp   LISTEN 0      511            [::1]:8443          [::]:*    users:(("nginx",pid=71909,fd=10),("nginx",pid=71908,fd=10),("nginx",pid=71907,fd=10),("nginx",pid=71906,fd=10))
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=71909,fd=8),("nginx",pid=71908,fd=8),("nginx",pid=71907,fd=8),("nginx",pid=71906,fd=8))    
```
...
table ip6 filter {
	...
	chain ufw6-before-output {
		...
		meta l4proto ipv6-icmp icmpv6 type echo-request counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type echo-reply counter packets 0 bytes 0 accept
		meta l4proto ipv6-icmp icmpv6 type nd-router-solicit ip6 hoplimit 255 counter packets 906 bytes 44512 accept
		meta l4proto ipv6-icmp icmpv6 type nd-neighbor-advert ip6 hoplimit 255 counter packets 0 bytes 0 accept
	...
	chain OUTPUT {
		...
		counter packets 911 bytes 44888 jump ufw6-before-logging-output
		counter packets 911 bytes 44888 jump ufw6-before-output
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 41 | 2026-07-06 04:19:49 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-07-05 12:51:04 |
| `/root/cert` | missing | - | - | - | - |
| `/etc/x-ui` | missing | - | - | - | - |
| `/etc/3x-ui` | missing | - | - | - | - |
