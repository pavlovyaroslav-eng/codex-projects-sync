...
Generated: 2026-07-09T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 32 days, 17:09,  0 user,  load average: 0.27, 0.38, 0.39
```
...
veth05bcdec@if2  UP             fe80::14f1:62ff:fef2:12b2/64 
vethbc2820d@if2  UP             fe80::906f:83ff:fe0d:c787/64 
veth92960f1@if3  UP             fe80::10:d2ff:fed1:b5a/64 
vethbc48588@if2  UP             fe80::40b3:46ff:fe96:fc61/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::7c7e:d688:f47f:3e1/64 
...
fe80::/64 dev veth05bcdec proto kernel metric 256 pref medium
fe80::/64 dev vethbc2820d proto kernel metric 256 pref medium
fe80::/64 dev veth92960f1 proto kernel metric 256 pref medium
fe80::/64 dev vethbc48588 proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1327000,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0              *%wg0:35990            *:*    users:(("xray-linux-amd6",pid=1327329,fd=28))                
udp   UNCONN 0      0                  *:50424            *:*    users:(("xray-linux-amd6",pid=1327329,fd=26))                
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1327329,fd=16))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1327004,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1091930,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1326737,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1327329,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1327329,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1327290,fd=5),("nginx",pid=1327289,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1327620,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1327272,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1326743,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1327329,fd=15))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1327290,fd=6),("nginx",pid=1327289,fd=6))
```
...
-A f2b-ufw-portscan -s 93.186.227.133/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.79.23.43/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 81.24.93.181/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 78.156.232.237/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 73.232.56.77/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 54.255.202.70/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 50.7.234.86/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.196.164/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 44.192.202.45/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 44.192.201.138/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 39.100.72.232/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.36.192.126/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.23.97.82/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 195.178.30.195/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.190.208.80/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.253.40.9/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.253.40.74/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 178.248.233.148/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 178.130.128.39/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.67.158.53/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.217.171.174/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.217.17.78/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.43.52.201/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.40.43.26/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.40.42.45/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.83.5.152/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.102.62.132/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 42392 bytes 10290546 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 42392 bytes 2842362 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 11132840 bytes 6282362179 accept
		ct state related,established counter packets 211361480 bytes 156641533667 accept
		ct state invalid counter packets 9969 bytes 723053 jump ufw-logging-deny
		ct state invalid counter packets 9969 bytes 723053 drop
		...
		ip protocol icmp icmp type echo-request counter packets 38733 bytes 2228770 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2040276 bytes 473040691 jump ufw-not-local
		...
		counter packets 2040276 bytes 473040691 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 11132844 bytes 6282362395 accept
		ct state related,established counter packets 247787835 bytes 289538992725 accept
		counter packets 1548834 bytes 205364183 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 210 bytes 11018 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 172 bytes 15198 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 140 bytes 7336 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 755 bytes 38348 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 784614 bytes 257354038 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 131125 bytes 39918034 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 42392 bytes 2642955 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 42019 bytes 3346521 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 218112 bytes 14530657 accept
		ip protocol udp ct state new counter packets 1309957 bytes 189096210 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 74295 bytes 24889781 jump f2b-ufw-portscan
		iifname "tun79" counter packets 643253 bytes 801010230 accept
		counter packets 598658773 bytes 529838869963 jump ufw-before-logging-input
		counter packets 598658773 bytes 529838869963 jump ufw-before-input
		counter packets 5505009 bytes 1066716867 jump ufw-after-input
		counter packets 2666935 bytes 147024593 jump ufw-after-logging-input
		counter packets 2666935 bytes 147024593 jump ufw-reject-input
		counter packets 2666935 bytes 147024593 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 18692 bytes 3587509 accept
		counter packets 578626263 bytes 574534646087 jump ufw-before-logging-output
		counter packets 578626263 bytes 574534646087 jump ufw-before-output
		counter packets 5052533 bytes 708891261 jump ufw-after-output
		counter packets 5052533 bytes 708891261 jump ufw-after-logging-output
		counter packets 5052533 bytes 708891261 jump ufw-reject-output
		counter packets 5052533 bytes 708891261 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 86878120 bytes 208882491492 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 102532788 bytes 19115195401 accept
		...
		counter packets 324975706 bytes 357423961244 jump DOCKER-USER
		counter packets 324975706 bytes 357423961244 jump DOCKER-FORWARD
		counter packets 434 bytes 25078 jump ufw-before-logging-forward
		counter packets 434 bytes 25078 jump ufw-before-forward
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 94 bytes 12311 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 125 bytes 7504 accept
	...
	chain DOCKER-FORWARD {
		counter packets 324975706 bytes 357423961244 jump DOCKER-CT
		counter packets 163733167 bytes 180165180526 jump DOCKER-INTERNAL
		counter packets 163733167 bytes 180165180526 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 140088748 bytes 167709189541 accept
		iifname "docker0" counter packets 23583154 bytes 12449499270 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 28717 bytes 4502992 jump DOCKER
		oifname "docker0" counter packets 32114 bytes 1963645 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 140905130 bytes 162664382066 accept
		oifname "docker0" ct state related,established counter packets 20337409 bytes 14594398652 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 8854 bytes 649203 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 8854 bytes 649203 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 916806 bytes 297332954 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1124436 bytes 175758959 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 915840 bytes 297281732 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 165264 bytes 10415119 accept
		udp dport 46539 counter packets 83908 bytes 101504251 accept
		udp dport 39425 counter packets 107 bytes 10702 accept
		tcp dport 80 counter packets 101945 bytes 6092712 accept
		udp dport 1194 counter packets 61 bytes 3412 accept
		tcp dport 8443 counter packets 3141 bytes 177600 accept
		...
		tcp dport 52000 counter packets 187 bytes 10062 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1408 bytes 80800 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-09 04:29:50 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-09 04:30:16 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 40K
drwxr-xr-x  2 root root   4.0K Jul  9 03:00 .
