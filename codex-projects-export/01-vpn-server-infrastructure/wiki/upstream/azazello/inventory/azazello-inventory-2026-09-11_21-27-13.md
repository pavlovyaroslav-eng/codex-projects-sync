...
Generated: 2026-09-11T21:27:13+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 21:27:14 up 40 days, 18:14,  1 user,  load average: 1.51, 1.34, 1.40
```
...
udp   UNCONN 0      0                  *:44690            *:*    users:(("rw-core",pid=2921938,fd=42))                        
udp   UNCONN 0      0                  *:50853            *:*    users:(("rw-core",pid=2921938,fd=54))                        
udp   UNCONN 0      0                  *:52955            *:*    users:(("rw-core",pid=2921938,fd=89))                        
udp   UNCONN 0      0                  *:59127            *:*    users:(("rw-core",pid=2921938,fd=19))                        
udp   UNCONN 0      0                  *:53091            *:*    users:(("rw-core",pid=2921938,fd=44))                        
udp   UNCONN 0      0                  *:34671            *:*    users:(("rw-core",pid=2921938,fd=88))                        
udp   UNCONN 0      0                  *:24443            *:*    users:(("rw-core",pid=2921938,fd=7))                         
udp   UNCONN 0      0                  *:36803            *:*    users:(("rw-core",pid=2921938,fd=81))                        
udp   UNCONN 0      0                  *:43007            *:*    users:(("rw-core",pid=2921938,fd=86))                        
udp   UNCONN 0      0                  *:38992            *:*    users:(("rw-core",pid=2921938,fd=57))                        
udp   UNCONN 0      0                  *:51316            *:*    users:(("rw-core",pid=2921938,fd=38))                        
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1113,fd=7))                          
udp   UNCONN 0      0                  *:53445            *:*    users:(("rw-core",pid=2921938,fd=62))                        
udp   UNCONN 0      0                  *:51400            *:*    users:(("rw-core",pid=2921938,fd=85))                        
udp   UNCONN 0      0                  *:37194            *:*    users:(("rw-core",pid=2921938,fd=35))                        
udp   UNCONN 0      0                  *:59759            *:*    users:(("rw-core",pid=2921938,fd=58))                        
udp   UNCONN 0      0                  *:59805            *:*    users:(("rw-core",pid=2921938,fd=56))                        
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0                  *:59907            *:*    users:(("rw-core",pid=2921938,fd=73))                        
udp   UNCONN 0      0                  *:39440            *:*    users:(("rw-core",pid=2921938,fd=48))                        
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:60143            *:*    users:(("rw-core",pid=2921938,fd=76))                        
udp   UNCONN 0      0                  *:56077            *:*    users:(("rw-core",pid=2921938,fd=30))                        
udp   UNCONN 0      0                  *:35727            *:*    users:(("rw-core",pid=2921938,fd=23))                        
udp   UNCONN 0      0                  *:41999            *:*    users:(("rw-core",pid=2921938,fd=32))                        
udp   UNCONN 0      0                  *:40030            *:*    users:(("rw-core",pid=2921938,fd=70))                        
udp   UNCONN 0      0                  *:48253            *:*    users:(("rw-core",pid=2921938,fd=9))                         
udp   UNCONN 0      0                  *:54510            *:*    users:(("rw-core",pid=2921938,fd=63))                        
udp   UNCONN 0      0                  *:50525            *:*    users:(("rw-core",pid=2921938,fd=71))                        
udp   UNCONN 0      0                  *:60944            *:*    users:(("rw-core",pid=2921938,fd=83))                        
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 36984 bytes 8635345 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 36983 bytes 2885496 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 112404182 bytes 109439617238 accept
		...
		counter packets 1858798 bytes 570493408 jump ufw-not-local
		...
		counter packets 1858798 bytes 570493408 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 123664493 bytes 112758639444 accept
		counter packets 2319070 bytes 272413953 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		udp dport 67 counter packets 644141 bytes 211277628 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 107262 bytes 32554097 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 36983 bytes 2257391 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 36984 bytes 2900440 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1033276 bytes 61999104 accept
		ip protocol udp ct state new counter packets 1282766 bytes 210098231 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 5768 bytes 1231079 jump f2b-sshd
		ip protocol tcp counter packets 26403412 bytes 57868535316 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 422767283 bytes 431776922617 jump ufw-before-logging-input
		counter packets 422767283 bytes 431776922617 jump ufw-before-input
		counter packets 4738960 bytes 1241328455 jump ufw-after-input
		counter packets 1163386 bytes 85215812 jump ufw-after-logging-input
		counter packets 1163386 bytes 85215812 jump ufw-reject-input
		counter packets 1163386 bytes 85215812 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 381406086 bytes 311026832710 jump ufw-before-logging-output
		counter packets 381406086 bytes 311026832710 jump ufw-before-output
		counter packets 3268269 bytes 365536909 jump ufw-after-output
		counter packets 3268269 bytes 365536909 jump ufw-after-logging-output
		counter packets 3268269 bytes 365536909 jump ufw-reject-output
		counter packets 3268269 bytes 365536909 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1709746186 bytes 2045361785159 jump DOCKER-USER
		counter packets 1709746193 bytes 2045361786373 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8715625 bytes 10830778637 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11063773 bytes 4930450434 accept
	...
	chain DOCKER {
		...
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 480773 bytes 29600130 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1709746193 bytes 2045361786373 jump DOCKER-CT
		counter packets 863754207 bytes 1035866284678 jump DOCKER-INTERNAL
		counter packets 863754207 bytes 1035866284678 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 625875095 bytes 881546864486 accept
		iifname "docker0" counter packets 217578759 bytes 138520149647 accept
	}
	...
	chain DOCKER-BRIDGE {
		...
		oifname "docker0" counter packets 480773 bytes 29600130 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 643287075 bytes 854898781706 accept
		oifname "docker0" ct state related,established counter packets 202704911 bytes 154596719989 accept
	}
	...
	chain f2b-ufw-portscan {
		...
		ip saddr 172.217.118.4 counter packets 301 bytes 20265 reject
		...
		ip saddr 172.217.113.4 counter packets 1798 bytes 110314 reject
		...
		ip saddr 172.217.116.4 counter packets 3024 bytes 182626 reject
		ip saddr 85.217.140.16 counter packets 498 bytes 25896 reject
		ip saddr 172.217.115.4 counter packets 3097 bytes 214806 reject
		...
		ip saddr 172.217.114.4 counter packets 7530 bytes 458871 reject
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-11 21:27:07 |
