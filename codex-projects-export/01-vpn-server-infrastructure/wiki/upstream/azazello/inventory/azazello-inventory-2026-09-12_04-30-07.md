...
Generated: 2026-09-12T04:30:07+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:08 up 41 days,  1:17,  0 user,  load average: 0.35, 0.27, 0.27
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 38252 bytes 8963811 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 38252 bytes 2995616 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 117884847 bytes 113986312408 accept
		ct state invalid counter packets 779 bytes 199987 jump ufw-logging-deny
		ct state invalid counter packets 779 bytes 199987 drop
		...
		ip protocol icmp icmp type echo-request counter packets 4722 bytes 280584 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1915233 bytes 591394430 jump ufw-not-local
		...
		counter packets 1915233 bytes 591394430 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 130148749 bytes 117623039967 accept
		counter packets 2370686 bytes 281455265 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		udp dport 138 counter packets 4 bytes 808 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 88 bytes 4048 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 673 bytes 31952 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 666313 bytes 218550044 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 6 bytes 168 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 111008 bytes 33715468 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 38252 bytes 2338242 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 38252 bytes 3014591 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1054003 bytes 63243240 accept
		ip protocol udp ct state new counter packets 1313530 bytes 217876638 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 6367 bytes 1334715 jump f2b-sshd
		ip protocol tcp counter packets 26933812 bytes 58790099842 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 428304488 bytes 436344532509 jump ufw-before-logging-input
		counter packets 428304488 bytes 436344532509 jump ufw-before-input
		counter packets 4769305 bytes 1250045197 jump ufw-after-input
		counter packets 1167802 bytes 85498145 jump ufw-after-logging-input
		counter packets 1167802 bytes 85498145 jump ufw-reject-input
		counter packets 1167802 bytes 85498145 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 387941958 bytes 315900274545 jump ufw-before-logging-output
		counter packets 387941958 bytes 315900274545 jump ufw-before-output
		counter packets 3319885 bytes 374578221 jump ufw-after-output
		counter packets 3319885 bytes 374578221 jump ufw-after-logging-output
		counter packets 3319885 bytes 374578221 jump ufw-reject-output
		counter packets 3319885 bytes 374578221 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1717107072 bytes 2053139879427 jump DOCKER-USER
		counter packets 1717107079 bytes 2053139880641 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8795025 bytes 10925703975 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11178258 bytes 4999970554 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 11051 bytes 3502316 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 482582 bytes 29713134 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1717107079 bytes 2053139880641 jump DOCKER-CT
		counter packets 867641262 bytes 1039895853112 jump DOCKER-INTERNAL
		counter packets 867641262 bytes 1039895853112 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 628302811 bytes 884874958471 accept
		iifname "docker0" counter packets 218841862 bytes 139057013219 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 40722 bytes 8501716 jump DOCKER
		oifname "docker0" counter packets 482582 bytes 29713134 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 645728848 bytes 858128968474 accept
		oifname "docker0" ct state related,established counter packets 203736969 bytes 155115059055 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.239.151.10 counter packets 24 bytes 1056 reject
		ip saddr 85.217.140.7 counter packets 13 bytes 676 reject
		ip saddr 85.217.140.3 counter packets 20 bytes 1040 reject
		ip saddr 85.217.140.27 counter packets 20 bytes 1040 reject
		ip saddr 85.217.149.70 counter packets 84 bytes 4368 reject
		ip saddr 15.235.112.125 counter packets 10 bytes 592 reject
		ip saddr 85.217.140.23 counter packets 64 bytes 3328 reject
		ip saddr 85.217.140.24 counter packets 51 bytes 2652 reject
		ip saddr 85.217.149.37 counter packets 73 bytes 3796 reject
		ip saddr 85.217.140.48 counter packets 224 bytes 11648 reject
		ip saddr 85.217.149.73 counter packets 158 bytes 8216 reject
		ip saddr 85.217.140.11 counter packets 200 bytes 10400 reject
		ip saddr 172.217.112.4 counter packets 1036 bytes 64484 reject
		ip saddr 85.217.140.30 counter packets 121 bytes 6292 reject
		ip saddr 85.217.140.32 counter packets 40 bytes 2080 reject
		ip saddr 85.217.140.19 counter packets 96 bytes 4992 reject
		ip saddr 85.217.140.41 counter packets 307 bytes 15964 reject
		ip saddr 85.217.149.68 counter packets 367 bytes 19084 reject
		ip saddr 85.217.140.33 counter packets 199 bytes 10348 reject
		ip saddr 85.217.140.39 counter packets 373 bytes 19396 reject
		ip saddr 85.217.140.6 counter packets 119 bytes 6188 reject
		ip saddr 85.217.140.9 counter packets 383 bytes 19916 reject
		ip saddr 85.217.149.54 counter packets 99 bytes 5148 reject
		ip saddr 85.217.140.43 counter packets 344 bytes 17888 reject
		ip saddr 85.217.140.1 counter packets 261 bytes 13572 reject
		ip saddr 85.217.140.5 counter packets 164 bytes 8528 reject
		ip saddr 85.217.140.34 counter packets 320 bytes 16640 reject
		ip saddr 194.213.105.2 counter packets 49 bytes 9954 reject
		ip saddr 92.114.107.56 counter packets 232 bytes 13656 reject
		ip saddr 85.217.140.52 counter packets 493 bytes 25636 reject
		ip saddr 85.217.140.47 counter packets 723 bytes 37596 reject
		ip saddr 172.217.118.4 counter packets 2313 bytes 140985 reject
		ip saddr 85.217.140.51 counter packets 565 bytes 29380 reject
		ip saddr 85.217.140.10 counter packets 600 bytes 31200 reject
		ip saddr 85.217.140.20 counter packets 139 bytes 7228 reject
		ip saddr 85.217.140.44 counter packets 514 bytes 26728 reject
		ip saddr 85.217.140.29 counter packets 320 bytes 16640 reject
		ip saddr 31.14.32.7 counter packets 374 bytes 19448 reject
		ip saddr 85.217.140.12 counter packets 525 bytes 27300 reject
		ip saddr 85.217.140.4 counter packets 643 bytes 33436 reject
		ip saddr 85.217.140.26 counter packets 359 bytes 18668 reject
		ip saddr 39.100.72.232 counter packets 131 bytes 5540 reject
		ip saddr 85.217.140.45 counter packets 780 bytes 40560 reject
		ip saddr 85.217.140.8 counter packets 681 bytes 35412 reject
		ip saddr 85.217.140.40 counter packets 575 bytes 29900 reject
		ip saddr 85.217.140.18 counter packets 368 bytes 19136 reject
		ip saddr 185.2.80.252 counter packets 330 bytes 17160 reject
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-12 04:30:04 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-12 01:03:40 |
...
total 404K
drwxr-xr-x  2 root root   4.0K Sep 12 03:10 .
