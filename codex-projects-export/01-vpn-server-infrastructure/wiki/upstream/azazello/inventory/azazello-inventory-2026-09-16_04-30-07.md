...
Generated: 2026-09-16T04:30:07+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:08 up 2 days,  1:17,  0 user,  load average: 0.23, 0.19, 0.18
```
...
-A f2b-ufw-portscan -s 23.230.3.205/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.43.119.34/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.142.204.174/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.95.201.233/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 8881 bytes 1785034 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 8880 bytes 766361 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 33634393 bytes 35350300654 accept
		ct state invalid counter packets 133 bytes 29170 jump ufw-logging-deny
		ct state invalid counter packets 133 bytes 29170 drop
		...
		ip protocol icmp icmp type echo-request counter packets 967 bytes 66231 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 389780 bytes 71928196 jump ufw-not-local
		...
		counter packets 389780 bytes 71928196 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 80 bytes 5920 accept
		ct state related,established counter packets 35936707 bytes 36716037947 accept
		counter packets 464321 bytes 68363680 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 25 bytes 1950 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 1 bytes 202 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 21 bytes 984 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 226 bytes 10524 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 155511 bytes 51007552 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 26392 bytes 8111090 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 8880 bytes 564188 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 8880 bytes 760269 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 191472 bytes 11488288 accept
		ip protocol udp ct state new counter packets 272148 bytes 56795965 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 7371638 bytes 18177955985 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 34025353 bytes 35422330171 jump ufw-before-logging-input
		counter packets 34025353 bytes 35422330171 jump ufw-before-input
		counter packets 231623 bytes 62212561 jump ufw-after-input
		counter packets 49446 bytes 3080231 jump ufw-after-logging-input
		counter packets 49446 bytes 3080231 jump ufw-reject-input
		counter packets 49446 bytes 3080231 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 36401108 bytes 36784407547 jump ufw-before-logging-output
		counter packets 36401108 bytes 36784407547 jump ufw-before-output
		counter packets 464321 bytes 68363680 jump ufw-after-output
		counter packets 464321 bytes 68363680 jump ufw-after-logging-output
		counter packets 464321 bytes 68363680 jump ufw-reject-output
		counter packets 464321 bytes 68363680 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 36186124 bytes 31297344927 jump DOCKER-USER
		counter packets 36186125 bytes 31297344987 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 540155 bytes 667204217 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 735981 bytes 371653588 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 133 bytes 29170 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 133 bytes 29170 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 182177 bytes 59132330 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 207875 bytes 12809592 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 181905 bytes 59118604 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 83290 bytes 4912212 accept
		udp dport 46539 counter packets 0 bytes 0 accept
		udp dport 39425 counter packets 128 bytes 11780 accept
		tcp dport 80 counter packets 68331 bytes 4027913 accept
		udp dport 1194 counter packets 16 bytes 642 accept
		tcp dport 8443 counter packets 5384 bytes 316012 accept
		udp dport 21194 counter packets 20 bytes 3120 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 61 bytes 3476 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 566 bytes 33188 accept
		...
		ip saddr 185.71.196.110 udp dport 24443 counter packets 309 bytes 404172 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 23.230.3.205 counter packets 201 bytes 11936 reject
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-16 04:30:13 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-15 21:39:10 |
...
total 436K
drwxr-xr-x  2 root root   4.0K Sep 16 03:10 .
