...
Generated: 2026-08-12T04:30:03+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 10 days,  1:17,  0 user,  load average: 0.17, 0.24, 0.27
```
...
udp   UNCONN 0      0          127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=2190797,fd=3))                           
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=2190717,fd=3),("systemd",pid=1,fd=207))     
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("smtpd",pid=2224648,fd=6),("master",pid=2191211,fd=13))
tcp   LISTEN 0      4096       127.0.0.1:45821      0.0.0.0:*    users:(("containerd",pid=1204,fd=13))                          
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=2190784,fd=5),("nginx",pid=2190781,fd=5))  
...
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=2190797,fd=4))                           
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=2190784,fd=6),("nginx",pid=2190781,fd=6))  
...
-A f2b-ufw-portscan -s 45.13.186.42/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.85.102.41/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.85.100.175/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.163.61.56/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.171.221.42/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.171.221.253/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.171.220.219/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.171.220.166/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.106.128.142/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 90.156.232.221/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 62.60.217.6/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 57.144.253.33/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 51.250.115.54/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 5.83.129.207/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.14.5/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 217.174.236.232/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.174.236.154/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 199.232.211.52/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.89/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.69/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.6/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.5/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.204/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.179/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.69.186.174/32 -j REJECT --reject-with icmp-port-unreachable

table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 43441 bytes 16448760 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 43441 bytes 2713270 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 10703111 bytes 5478750720 accept
		ct state related,established counter packets 52840292 bytes 48009845842 accept
		ct state invalid counter packets 8511 bytes 521726 jump ufw-logging-deny
		ct state invalid counter packets 8511 bytes 521726 drop
		...
		ip protocol icmp icmp type echo-request counter packets 6377 bytes 395158 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1869149 bytes 1175007053 jump ufw-not-local
		...
		counter packets 1869149 bytes 1175007053 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 10703111 bytes 5478750720 accept
		ct state related,established counter packets 48030985 bytes 32977402165 accept
		counter packets 350884 bytes 38290304 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 3 bytes 164 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 296 bytes 25356 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 36 bytes 8244 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 93 bytes 4288 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 619 bytes 29844 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 747858 bytes 245296825 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 131861 bytes 38111071 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 43440 bytes 2725081 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 43440 bytes 3190959 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 76981 bytes 5455254 accept
		ip protocol udp ct state new counter packets 261746 bytes 31692354 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 174550 bytes 92031035 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 65427440 bytes 54664520499 jump ufw-before-logging-input
		counter packets 65427440 bytes 54664520499 jump ufw-before-input
		counter packets 1089698 bytes 295569255 jump ufw-after-input
		counter packets 208935 bytes 12093627 jump ufw-after-logging-input
		counter packets 208935 bytes 12093627 jump ufw-reject-input
		counter packets 208935 bytes 12093627 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 59084980 bytes 38494443189 jump ufw-before-logging-output
		counter packets 59084980 bytes 38494443189 jump ufw-before-output
		counter packets 350884 bytes 38290304 jump ufw-after-output
		counter packets 350884 bytes 38290304 jump ufw-after-logging-output
		counter packets 350884 bytes 38290304 jump ufw-reject-output
		counter packets 350884 bytes 38290304 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 459316721 bytes 540043591957 jump DOCKER-USER
		counter packets 459316728 bytes 540043593171 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 2325510 bytes 2902025253 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 2906168 bytes 1264427633 accept
		counter packets 3 bytes 164 jump ufw-before-logging-forward
		counter packets 3 bytes 164 jump ufw-before-forward
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7392 bytes 465549 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7392 bytes 465549 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 880763 bytes 283475628 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 989180 bytes 891571854 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 879969 bytes 283435199 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 62418 bytes 4332569 accept
		udp dport 46539 counter packets 632555 bytes 870128453 accept
		udp dport 39425 counter packets 243 bytes 24256 accept
		tcp dport 80 counter packets 51601 bytes 3042007 accept
		udp dport 1194 counter packets 99 bytes 3890 accept
		tcp dport 8443 counter packets 30107 bytes 1766627 accept
		udp dport 21194 counter packets 43 bytes 6596 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 255 bytes 12840 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 2125 bytes 120260 accept
	...
	chain ufw-user-forward {
		...
		iifname "tun79" oifname "eth0" counter packets 3 bytes 164 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 16061 bytes 3221392 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 88046 bytes 5426322 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-12 04:29:56 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-12 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 228K
drwxr-xr-x  2 root root   4.0K Aug 12 03:10 .
drwxr-xr-x 18 root syslog 4.0K Aug  9 00:00 ..
