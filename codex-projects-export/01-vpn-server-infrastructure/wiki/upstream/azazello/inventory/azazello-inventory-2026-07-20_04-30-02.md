...
Generated: 2026-07-20T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 43 days, 14:09,  0 user,  load average: 0.11, 0.28, 0.43
```
...
-A f2b-ufw-portscan -s 189.113.3.82/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.194.10.16/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 134.255.255.136/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 107.155.51.182/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 92.204.138.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 144.31.222.166/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 194.195.210.47/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.115.134/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 161.35.74.235/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 194.67.193.77/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 62.210.142.176/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 157.230.150.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 138.68.249.116/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 142.251.1.95/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 20.206.89.130/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.10/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 137.184.157.77/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.213.56.3/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 31.40.157.137/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.185.141/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 148.153.84.153/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 46.228.223.14/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 149.154.175.53/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.142.204.151/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 10.8.1.25/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 104.83.4.115/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 140.179.19.5/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 179.43.147.42/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.79.115.117/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 7907 bytes 2875007 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 7907 bytes 501704 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 22582017 bytes 12065954583 accept
		ct state related,established counter packets 341858661 bytes 233978797205 accept
		ct state invalid counter packets 23478 bytes 1929633 jump ufw-logging-deny
		ct state invalid counter packets 23478 bytes 1929633 drop
		...
		ip protocol icmp icmp type echo-request counter packets 45698 bytes 2639872 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3731492 bytes 1140495470 jump ufw-not-local
		...
		counter packets 3731492 bytes 1140495470 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 22582021 bytes 12065954799 accept
		ct state related,established counter packets 423577787 bytes 492441340073 accept
		counter packets 2204821 bytes 276584606 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 306 bytes 26133 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 254 bytes 13324 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1482 bytes 75100 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1608825 bytes 527695246 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 270340 bytes 81855472 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 7907 bytes 478448 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 7907 bytes 552962 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 366520 bytes 23503548 accept
		ip protocol udp ct state new counter packets 1796234 bytes 248959742 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 7888268 bytes 8268402034 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1090750 bytes 1359553160 accept
		counter packets 742316821 bytes 613628798366 jump ufw-before-logging-input
		counter packets 742316821 bytes 613628798366 jump ufw-before-input
		counter packets 6775493 bytes 1398125512 jump ufw-after-input
		counter packets 2973018 bytes 166100917 jump ufw-after-logging-input
		counter packets 2973018 bytes 166100917 jump ufw-reject-input
		counter packets 2973018 bytes 166100917 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31413 bytes 6024246 accept
		counter packets 766521379 bytes 783291806262 jump ufw-before-logging-output
		counter packets 766521379 bytes 783291806262 jump ufw-before-output
		counter packets 5708520 bytes 780111684 jump ufw-after-output
		counter packets 5708520 bytes 780111684 jump ufw-after-logging-output
		counter packets 5708520 bytes 780111684 jump ufw-reject-output
		counter packets 5708520 bytes 780111684 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 155952997 bytes 367975949557 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 186852680 bytes 40721156312 accept
		...
		counter packets 565967427 bytes 596214934694 jump DOCKER-USER
		counter packets 565967427 bytes 596214934694 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 5084 bytes 918287 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 18088 bytes 1096631 accept
	...
	chain DOCKER-FORWARD {
		counter packets 565967427 bytes 596214934694 jump DOCKER-CT
		counter packets 285109353 bytes 295928092460 jump DOCKER-INTERNAL
		counter packets 285109353 bytes 295928092460 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 209836178 bytes 263900204850 accept
		iifname "docker0" counter packets 75114807 bytes 32013701477 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 43170 bytes 7168180 jump DOCKER
		oifname "docker0" counter packets 114646 bytes 6986343 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 215646375 bytes 256132387935 accept
		oifname "docker0" ct state related,established counter packets 65211699 bytes 44154454299 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 1491 bytes 109172 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 1491 bytes 109172 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1881207 bytes 609665275 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1852187 bytes 530931402 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1879305 bytes 609564068 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 4029 bytes 238196 accept
		udp dport 46539 counter packets 90298 bytes 124053571 accept
		udp dport 39425 counter packets 70 bytes 6699 accept
		tcp dport 80 counter packets 13047 bytes 777878 accept
		udp dport 1194 counter packets 25 bytes 1283 accept
		tcp dport 8443 counter packets 475 bytes 26359 accept
		...
		tcp dport 52000 counter packets 106 bytes 5543 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 156 bytes 8356 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 2 days   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 2 days   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 2 days   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-20 04:30:08 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-20 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 108K
drwxr-xr-x  2 root root   4.0K Jul 20 03:10 .
