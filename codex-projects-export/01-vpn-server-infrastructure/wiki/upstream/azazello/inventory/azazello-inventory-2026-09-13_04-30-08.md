...
Generated: 2026-09-13T04:30:08+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:09 up 42 days,  1:17,  0 user,  load average: 1.35, 0.50, 0.34
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 42572 bytes 10146718 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 42572 bytes 3362680 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 132526385 bytes 126895517207 accept
		ct state invalid counter packets 876 bytes 235391 jump ufw-logging-deny
		ct state invalid counter packets 876 bytes 235391 drop
		...
		ip protocol icmp icmp type echo-request counter packets 5190 bytes 308022 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2114923 bytes 671417776 jump ufw-not-local
		...
		counter packets 2114923 bytes 671417776 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 146863287 bytes 131270628798 accept
		counter packets 2585009 bytes 310397386 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 170 bytes 14122 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 4 bytes 808 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 96 bytes 4412 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 755 bytes 35704 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 742141 bytes 243421628 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 7 bytes 196 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 123658 bytes 37638356 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 42572 bytes 2625190 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 42572 bytes 3385916 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1146583 bytes 68798016 accept
		ip protocol udp ct state new counter packets 1434952 bytes 241230099 accept
	}
	...
	chain INPUT {
		...
		counter packets 443146281 bytes 449333823496 jump ufw-before-logging-input
		counter packets 443146281 bytes 449333823496 jump ufw-before-input
		counter packets 4872367 bytes 1279840144 jump ufw-after-input
		counter packets 1182266 bytes 86491998 jump ufw-after-logging-input
		counter packets 1182266 bytes 86491998 jump ufw-reject-input
		counter packets 1182266 bytes 86491998 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 404870819 bytes 329576805497 jump ufw-before-logging-output
		counter packets 404870819 bytes 329576805497 jump ufw-before-output
		counter packets 3534208 bytes 403520342 jump ufw-after-output
		counter packets 3534208 bytes 403520342 jump ufw-after-logging-output
		counter packets 3534208 bytes 403520342 jump ufw-reject-output
		counter packets 3534208 bytes 403520342 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1741174719 bytes 2076564504099 jump DOCKER-USER
		counter packets 1741174726 bytes 2076564505313 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 9065274 bytes 11250003355 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11543598 bytes 5194004741 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 12450 bytes 3645538 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 489523 bytes 30133870 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1741174726 bytes 2076564505313 jump DOCKER-CT
		counter packets 880208974 bytes 1051992900055 jump DOCKER-INTERNAL
		counter packets 880208974 bytes 1051992900055 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 635162647 bytes 893038805705 accept
		iifname "docker0" counter packets 223905809 bytes 142471315403 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 42121 bytes 8644938 jump DOCKER
		oifname "docker0" counter packets 489523 bytes 30133870 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 652662776 bytes 866096299766 accept
		oifname "docker0" ct state related,established counter packets 208302976 bytes 158475305492 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 837 bytes 233831 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 837 bytes 233831 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 866831 bytes 281115226 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1249067 bytes 390353402 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 865856 bytes 281064374 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 432090 bytes 25483774 accept
		udp dport 46539 counter packets 245215 bytes 329249345 accept
		udp dport 39425 counter packets 231 bytes 56034 accept
		tcp dport 80 counter packets 295383 bytes 17409443 accept
		udp dport 1194 counter packets 103 bytes 4528 accept
		tcp dport 8443 counter packets 75082 bytes 4419535 accept
		udp dport 21194 counter packets 3 bytes 452 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 438 bytes 25073 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1132 bytes 62180 accept
		...
		ip saddr 185.71.196.110 udp dport 24443 counter packets 1135 bytes 1484580 accept
	}
...
## Fail2Ban summary
```text
2026-09-13 04:30:12,839 fail2ban                [826872]: ERROR   Failed to access socket path: /var/run/fail2ban/fail2ban.sock. Is fail2ban running?
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-13 04:30:11 |
