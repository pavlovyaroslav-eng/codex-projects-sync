...
Generated: 2026-07-08T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 31 days, 17:09,  0 user,  load average: 0.34, 0.43, 0.47
```
...
veth37b087f@if2  UP             fe80::b002:30ff:fe4b:831b/64 
veth62a6c54@if2  UP             fe80::f8b5:d2ff:fe6d:907d/64 
vethf45ec58@if3  UP             fe80::f8bf:f2ff:fe66:cae1/64 
vethe4d7648@if2  UP             fe80::12:ceff:fe54:49f/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::7d2b:3b2e:87f9:9557/64 
...
fe80::/64 dev veth37b087f proto kernel metric 256 pref medium
fe80::/64 dev veth62a6c54 proto kernel metric 256 pref medium
fe80::/64 dev vethf45ec58 proto kernel metric 256 pref medium
fe80::/64 dev vethe4d7648 proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1268115,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1268442,fd=16))                
udp   UNCONN 0      0                  *:59105            *:*    users:(("xray-linux-amd6",pid=1268442,fd=25))                
udp   UNCONN 0      0              *%wg0:48900            *:*    users:(("xray-linux-amd6",pid=1268442,fd=44))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1268119,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0              *%wg0:37770            *:*    users:(("xray-linux-amd6",pid=1268442,fd=107))               
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1091930,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1267853,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1268442,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1268442,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1268385,fd=5),("nginx",pid=1268384,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1268733,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1268367,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1267859,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1268442,fd=15))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1268385,fd=6),("nginx",pid=1268384,fd=6))
```
...
-A f2b-ufw-portscan -s 95.142.204.159/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.129.236.72/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.228.227.177/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.228.227.176/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.228.227.174/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.228.227.173/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 89.31.120.238/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.137.206/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 82.22.5.20/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.24.93.18/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.163.16.10/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 69.164.217.245/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 57.144.120.144/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.0.252.176/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 51.222.254.143/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.211.235/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.163.53/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.109.17/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 43.175.230.153/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 37.221.79.155/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 37.221.79.152/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 23.35.208.43/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.20.155.24/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.58.207.74/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.26.61.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.23.97.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.23.97.139/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.19.197.129/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.105/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.165.50.19/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.15.186.230/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 173.255.212.137/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.43.54.111/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.43.116.163/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 38072 bytes 9226916 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 38072 bytes 2569823 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 10083393 bytes 5750735191 accept
		ct state related,established counter packets 196615164 bytes 149283188794 accept
		ct state invalid counter packets 8938 bytes 624804 jump ufw-logging-deny
		ct state invalid counter packets 8938 bytes 624804 drop
		...
		ip protocol icmp icmp type echo-request counter packets 35524 bytes 2046380 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1855856 bytes 427251705 jump ufw-not-local
		...
		counter packets 1855856 bytes 427251705 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 10083397 bytes 5750735407 accept
		ct state related,established counter packets 227190702 bytes 266246632313 accept
		counter packets 1508029 bytes 201718699 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 206 bytes 10858 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 166 bytes 14730 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 128 bytes 6724 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 675 bytes 34396 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 709128 bytes 232594630 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 118415 bytes 36042920 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 38071 bytes 2382223 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 37699 bytes 3017246 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 207832 bytes 13886263 accept
		ip protocol udp ct state new counter packets 1281192 bytes 186297156 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 142622 bytes 110715757 jump f2b-ufw-portscan
		iifname "tun79" counter packets 564431 bytes 702934602 accept
		counter packets 582674350 bytes 521902828477 jump ufw-before-logging-input
		counter packets 582674350 bytes 521902828477 jump ufw-before-input
		counter packets 5347811 bytes 1034290506 jump ufw-after-input
		counter packets 2598031 bytes 143237786 jump ufw-after-logging-input
		counter packets 2598031 bytes 143237786 jump ufw-reject-input
		counter packets 2598031 bytes 143237786 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 16412 bytes 3142553 accept
		counter packets 556938878 bytes 550707013203 jump ufw-before-logging-output
		counter packets 556938878 bytes 550707013203 jump ufw-before-output
		counter packets 5011728 bytes 705245777 jump ufw-after-output
		counter packets 5011728 bytes 705245777 jump ufw-after-logging-output
		counter packets 5011728 bytes 705245777 jump ufw-reject-output
		counter packets 5011728 bytes 705245777 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 77585967 bytes 189435620242 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 91417327 bytes 16433422769 accept
		...
		counter packets 307258765 bytes 339552268368 jump DOCKER-USER
		counter packets 307258765 bytes 339552268368 jump DOCKER-FORWARD
		counter packets 430 bytes 24918 jump ufw-before-logging-forward
		counter packets 430 bytes 24918 jump ufw-before-forward
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 14 bytes 1194 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 94 bytes 5604 accept
	...
	chain DOCKER-FORWARD {
		counter packets 307258765 bytes 339552268368 jump DOCKER-CT
		counter packets 155125250 bytes 172094989891 jump DOCKER-INTERNAL
		counter packets 155125250 bytes 172094989891 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 136323303 bytes 161055767699 accept
		iifname "docker0" counter packets 18749118 bytes 11033346308 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 27636 bytes 4334468 jump DOCKER
		oifname "docker0" counter packets 24763 bytes 1516498 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 136412960 bytes 156185363181 accept
		oifname "docker0" ct state related,established counter packets 15720555 bytes 11271915296 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7867 bytes 562948 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7867 bytes 562948 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 828512 bytes 268693400 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1028212 bytes 158604495 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 827644 bytes 268647210 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 163929 bytes 10316975 accept
		udp dport 46539 counter packets 74323 bytes 89214652 accept
		udp dport 39425 counter packets 95 bytes 9485 accept
		tcp dport 80 counter packets 85932 bytes 5134689 accept
		udp dport 1194 counter packets 49 bytes 2906 accept
		tcp dport 8443 counter packets 2948 bytes 166428 accept
		...
		tcp dport 52000 counter packets 176 bytes 9426 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1347 bytes 77472 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 40 | 2026-07-08 04:30:19 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-08 04:30:21 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 36K
drwxr-xr-x  2 root root   4.0K Jul  8 03:00 .
