...
Generated: 2026-09-11T21:10:17+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 21:10:17 up 40 days, 17:57,  1 user,  load average: 0.89, 0.80, 0.86
```
...
udp   UNCONN 0      0                  *:46984            *:*    users:(("rw-core",pid=2921938,fd=48))                        
udp   UNCONN 0      0                  *:38801            *:*    users:(("rw-core",pid=2921938,fd=76))                        
udp   UNCONN 0      0                  *:51146            *:*    users:(("rw-core",pid=2921938,fd=71))                        
udp   UNCONN 0      0                  *:42957            *:*    users:(("rw-core",pid=2921938,fd=25))                        
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1113,fd=7))                          
udp   UNCONN 0      0                  *:51466            *:*    users:(("rw-core",pid=2921938,fd=42))                        
udp   UNCONN 0      0                  *:57625            *:*    users:(("rw-core",pid=2921938,fd=63))                        
udp   UNCONN 0      0                  *:53539            *:*    users:(("rw-core",pid=2921938,fd=17))                        
udp   UNCONN 0      0                  *:39392            *:*    users:(("rw-core",pid=2921938,fd=73))                        
udp   UNCONN 0      0                  *:49637            *:*    users:(("rw-core",pid=2921938,fd=51))                        
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0                  *:43615            *:*    users:(("rw-core",pid=2921938,fd=43))                        
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:60065            *:*    users:(("rw-core",pid=2921938,fd=79))                        
udp   UNCONN 0      0                  *:33510            *:*    users:(("rw-core",pid=2921938,fd=70))                        
udp   UNCONN 0      0                  *:56050            *:*    users:(("rw-core",pid=2921938,fd=67))                        
udp   UNCONN 0      0                  *:35620            *:*    users:(("rw-core",pid=2921938,fd=83))                        
udp   UNCONN 0      0                  *:35737            *:*    users:(("rw-core",pid=2921938,fd=65))                        
udp   UNCONN 0      0                  *:42009            *:*    users:(("rw-core",pid=2921938,fd=74))                        
udp   UNCONN 0      0                  *:50284            *:*    users:(("rw-core",pid=2921938,fd=72))                        
udp   UNCONN 0      0                  *:56512            *:*    users:(("rw-core",pid=2921938,fd=36))                        
udp   UNCONN 0      0                  *:38170            *:*    users:(("rw-core",pid=2921938,fd=47))                        
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 36933 bytes 8623241 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 36933 bytes 2879093 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 111478377 bytes 108479875655 accept
		...
		counter packets 1856812 bytes 570086911 jump ufw-not-local
		...
		counter packets 1856812 bytes 570086911 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 122782877 bytes 111770579712 accept
		counter packets 2316035 bytes 271629255 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		udp dport 67 counter packets 643264 bytes 210989972 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 107117 bytes 32512051 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 36932 bytes 2254966 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 36933 bytes 2893967 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1032248 bytes 61937424 accept
		ip protocol udp ct state new counter packets 1280764 bytes 209375569 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 5396 bytes 1164679 jump f2b-sshd
		ip protocol tcp counter packets 26197111 bytes 57389499607 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 421839490 bytes 430816774451 jump ufw-before-logging-input
		counter packets 421839490 bytes 430816774451 jump ufw-before-input
		counter packets 4737730 bytes 1240987250 jump ufw-after-input
		counter packets 1163179 bytes 85204353 jump ufw-after-logging-input
		counter packets 1163179 bytes 85204353 jump ufw-reject-input
		counter packets 1163179 bytes 85204353 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 380521435 bytes 310037988280 jump ufw-before-logging-output
		counter packets 380521435 bytes 310037988280 jump ufw-before-output
		counter packets 3265234 bytes 364752211 jump ufw-after-output
		counter packets 3265234 bytes 364752211 jump ufw-after-logging-output
		counter packets 3265234 bytes 364752211 jump ufw-reject-output
		counter packets 3265234 bytes 364752211 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1709572074 bytes 2045204228286 jump DOCKER-USER
		counter packets 1709572081 bytes 2045204229500 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8715315 bytes 10830711396 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11063195 bytes 4930377082 accept
	...
	chain DOCKER {
		...
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 480471 bytes 29581158 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1709572081 bytes 2045204229500 jump DOCKER-CT
		counter packets 863660992 bytes 1035787079098 jump DOCKER-INTERNAL
		counter packets 863660992 bytes 1035787079098 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 625867248 bytes 881540360071 accept
		iifname "docker0" counter packets 217494621 bytes 138447613154 accept
	}
	...
	chain DOCKER-BRIDGE {
		...
		oifname "docker0" counter packets 480471 bytes 29581158 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 643279201 bytes 854892402098 accept
		oifname "docker0" ct state related,established counter packets 202631888 bytes 154524748304 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.217.140.47 counter packets 0 bytes 0 reject
		ip saddr 172.217.118.4 counter packets 95 bytes 7905 reject
		ip saddr 85.217.140.51 counter packets 24 bytes 1248 reject
		ip saddr 85.217.140.10 counter packets 92 bytes 4784 reject
		ip saddr 85.217.140.20 counter packets 1 bytes 52 reject
		ip saddr 85.217.140.44 counter packets 22 bytes 1144 reject
		ip saddr 85.217.140.29 counter packets 81 bytes 4212 reject
		ip saddr 31.14.32.7 counter packets 67 bytes 3484 reject
		ip saddr 85.217.140.12 counter packets 105 bytes 5460 reject
		ip saddr 85.217.140.4 counter packets 147 bytes 7644 reject
		ip saddr 85.217.140.26 counter packets 151 bytes 7852 reject
		ip saddr 39.100.72.232 counter packets 131 bytes 5540 reject
		ip saddr 85.217.140.45 counter packets 302 bytes 15704 reject
		ip saddr 85.217.140.8 counter packets 251 bytes 13052 reject
		ip saddr 85.217.140.40 counter packets 185 bytes 9620 reject
		ip saddr 85.217.140.18 counter packets 97 bytes 5044 reject
		ip saddr 185.2.80.252 counter packets 150 bytes 7800 reject
		ip saddr 112.124.22.214 counter packets 87 bytes 3480 reject
		ip saddr 151.80.23.149 counter packets 30 bytes 1748 reject
		ip saddr 85.217.140.53 counter packets 364 bytes 18928 reject
		ip saddr 85.217.140.36 counter packets 372 bytes 19344 reject
		ip saddr 85.217.140.50 counter packets 399 bytes 20748 reject
		ip saddr 47.95.209.9 counter packets 103 bytes 4120 reject
		ip saddr 172.217.113.4 counter packets 1499 bytes 92374 reject
		ip saddr 85.217.140.22 counter packets 150 bytes 7800 reject
		ip saddr 85.217.140.15 counter packets 253 bytes 13156 reject
		...
		ip saddr 85.217.149.69 counter packets 318 bytes 16536 reject
		...
		ip saddr 85.217.140.16 counter packets 479 bytes 24908 reject
		ip saddr 172.217.115.4 counter packets 2881 bytes 201846 reject
		ip saddr 85.217.140.42 counter packets 402 bytes 20904 reject
		ip saddr 85.217.149.71 counter packets 417 bytes 21684 reject
		ip saddr 85.217.140.46 counter packets 549 bytes 28548 reject
		...
		ip saddr 185.2.80.253 counter packets 633 bytes 32916 reject
		ip saddr 85.217.149.72 counter packets 572 bytes 29744 reject
		ip saddr 85.217.140.37 counter packets 628 bytes 32656 reject
		ip saddr 31.14.32.6 counter packets 509 bytes 26468 reject
		ip saddr 31.14.32.8 counter packets 821 bytes 42692 reject
		ip saddr 172.217.114.4 counter packets 7278 bytes 443751 reject
