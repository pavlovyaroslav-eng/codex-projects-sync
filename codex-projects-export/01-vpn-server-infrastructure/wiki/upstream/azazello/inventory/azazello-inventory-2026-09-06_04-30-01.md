...
Generated: 2026-09-06T04:30:01+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 35 days,  1:17,  0 user,  load average: 0.88, 0.48, 0.34
```
...
-A f2b-sshd -j RETURN
-A f2b-ufw-portscan -s 45.131.197.20/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.131.198.20/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 23.139.36.9/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.149.51/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.131.199.20/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.131.196.20/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 16.5.0.254/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 39.100.83.177/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.149.68/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.200.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.9/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.97.2.79/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 39.100.80.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.40.44.67/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.43.154.219/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 112.124.37.42/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 81.12.33.38/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 162.248.102.36/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 12332 bytes 3187808 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 12332 bytes 936483 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 32340765 bytes 32815181810 accept
		ct state invalid counter packets 283 bytes 20396 jump ufw-logging-deny
		ct state invalid counter packets 283 bytes 20396 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1181 bytes 67786 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 603160 bytes 234065861 jump ufw-not-local
		...
		counter packets 603160 bytes 234065861 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 34296156 bytes 32906804228 accept
		counter packets 532016 bytes 62651523 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 52 bytes 4272 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 15 bytes 716 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 164 bytes 8144 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 215102 bytes 70553156 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 35757 bytes 10746078 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 12331 bytes 750603 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 12332 bytes 943964 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 248168 bytes 14890080 accept
		ip protocol udp ct state new counter packets 282879 bytes 47682959 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 2330 bytes 554037 jump f2b-sshd
		ip protocol tcp counter packets 8912221 bytes 19394897207 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 341444296 bytes 354815680953 jump ufw-before-logging-input
		counter packets 341444296 bytes 354815680953 jump ufw-before-input
		counter packets 4131150 bytes 1072128969 jump ufw-after-input
		counter packets 1056789 bytes 78583655 jump ufw-after-logging-input
		counter packets 1056789 bytes 78583655 jump ufw-reject-input
		counter packets 1056789 bytes 78583655 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 290250695 bytes 230965235064 jump ufw-before-logging-output
		counter packets 290250695 bytes 230965235064 jump ufw-before-output
		counter packets 1481215 bytes 155774479 jump ufw-after-output
		counter packets 1481215 bytes 155774479 jump ufw-after-logging-output
		counter packets 1481215 bytes 155774479 jump ufw-reject-output
		counter packets 1481215 bytes 155774479 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1604407816 bytes 1943806935585 jump DOCKER-USER
		counter packets 1604407823 bytes 1943806936799 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 7408075 bytes 9156232899 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 9313190 bytes 4136422857 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 27698 bytes 4791124 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 382604 bytes 23571298 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1604407823 bytes 1943806936799 jump DOCKER-CT
		counter packets 810315147 bytes 983951869213 jump DOCKER-INTERNAL
		counter packets 810315147 bytes 983951869213 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 613900998 bytes 868199097902 accept
		iifname "docker0" counter packets 179282580 bytes 102431761090 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 27698 bytes 4791124 jump DOCKER
		oifname "docker0" counter packets 382604 bytes 23571298 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 630971341 bytes 841731002433 accept
		oifname "docker0" ct state related,established counter packets 163121335 bytes 118124065153 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 45.131.197.20 counter packets 100 bytes 5868 reject
		ip saddr 45.131.198.20 counter packets 140 bytes 8256 reject
		ip saddr 23.139.36.9 counter packets 36 bytes 1584 reject
		ip saddr 85.217.149.51 counter packets 23 bytes 1196 reject
		ip saddr 45.131.199.20 counter packets 257 bytes 15160 reject
		ip saddr 85.217.140.20 counter packets 37 bytes 1924 reject
		ip saddr 85.217.140.37 counter packets 16 bytes 832 reject
		ip saddr 45.131.196.20 counter packets 615 bytes 36288 reject
		ip saddr 85.217.140.49 counter packets 90 bytes 4680 reject
		ip saddr 85.217.140.1 counter packets 34 bytes 1768 reject
		ip saddr 85.217.149.71 counter packets 252 bytes 13104 reject
		ip saddr 85.217.140.5 counter packets 63 bytes 3276 reject
		ip saddr 85.217.149.74 counter packets 205 bytes 10660 reject
		ip saddr 85.217.149.70 counter packets 150 bytes 7800 reject
		ip saddr 85.217.140.3 counter packets 90 bytes 4680 reject
		ip saddr 85.217.140.18 counter packets 52 bytes 2704 reject
		ip saddr 85.217.140.29 counter packets 105 bytes 5460 reject
		ip saddr 85.217.149.72 counter packets 237 bytes 12324 reject
		ip saddr 85.217.140.48 counter packets 243 bytes 12636 reject
		ip saddr 85.217.140.24 counter packets 97 bytes 5044 reject
		ip saddr 85.217.140.11 counter packets 359 bytes 18668 reject
		ip saddr 85.217.149.53 counter packets 92 bytes 4784 reject
		ip saddr 85.217.140.7 counter packets 162 bytes 8424 reject
		ip saddr 85.217.140.33 counter packets 215 bytes 11180 reject
		ip saddr 85.217.149.52 counter packets 171 bytes 8892 reject
		ip saddr 85.217.140.26 counter packets 219 bytes 11388 reject
		ip saddr 85.217.140.32 counter packets 52 bytes 2704 reject
		ip saddr 16.5.0.254 counter packets 77 bytes 3388 reject
		ip saddr 152.32.178.38 counter packets 0 bytes 0 reject
		ip saddr 85.217.149.73 counter packets 527 bytes 27404 reject
		ip saddr 85.217.140.6 counter packets 176 bytes 9152 reject
		ip saddr 85.217.149.37 counter packets 226 bytes 11752 reject
		ip saddr 85.217.140.39 counter packets 449 bytes 23348 reject
		ip saddr 85.217.149.63 counter packets 502 bytes 26104 reject
		ip saddr 39.100.83.177 counter packets 117 bytes 4680 reject
		ip saddr 85.217.149.68 counter packets 422 bytes 21944 reject
		ip saddr 47.95.200.211 counter packets 55 bytes 2200 reject
		ip saddr 85.217.140.9 counter packets 652 bytes 33904 reject
		ip saddr 47.97.2.79 counter packets 23 bytes 920 reject
		ip saddr 85.217.140.52 counter packets 433 bytes 22516 reject
		ip saddr 85.217.140.47 counter packets 695 bytes 36140 reject
		ip saddr 39.100.80.211 counter packets 127 bytes 5080 reject
		ip saddr 121.40.44.67 counter packets 103 bytes 4120 reject
		ip saddr 121.43.154.219 counter packets 72 bytes 2880 reject
		ip saddr 112.124.37.42 counter packets 112 bytes 4480 reject
		ip saddr 85.217.140.34 counter packets 291 bytes 15132 reject
		ip saddr 85.217.140.30 counter packets 210 bytes 10920 reject
		ip saddr 85.217.140.35 counter packets 255 bytes 13260 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 2 days    
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-09-06 04:29:47 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-05 15:38:04 |
...
total 380K
drwxr-xr-x  2 root root   4.0K Sep  6 03:30 .
