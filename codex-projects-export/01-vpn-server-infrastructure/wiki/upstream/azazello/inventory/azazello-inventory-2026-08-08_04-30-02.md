...
Generated: 2026-08-08T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 6 days,  1:17,  0 user,  load average: 0.51, 0.31, 0.38
```
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=3956,fd=3),("systemd",pid=1,fd=188))    
...
-A f2b-ufw-portscan -s 47.95.204.109/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 154.247.126.252/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 172.66.43.111/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.180.246.216/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.204.222.170/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.109.10/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 192.176.173.186/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 120.48.168.74/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 39.100.74.177/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 185.253.41.112/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.254.122.106/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 123.60.106.132/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.149.48/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.40.47.210/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.254.122.26/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 84.42.94.198/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.49.42.157/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 91.108.56.185/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.49/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 107.178.240.159/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.4/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 44.197.14.132/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.47/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.69.139.138/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 62.210.142.62/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 85.217.192.33/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.94.96.144/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.102.131/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 78.156.232.14/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 39.100.83.185/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 209.38.59.8/32 -j REJECT --reject-with icmp-port-unreachable

table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 26161 bytes 10783087 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 26161 bytes 1614684 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 6408562 bytes 3225510365 accept
		ct state related,established counter packets 21109192 bytes 18172269711 accept
		ct state invalid counter packets 5895 bytes 333793 jump ufw-logging-deny
		ct state invalid counter packets 5895 bytes 333793 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3930 bytes 242940 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1179619 bytes 736727985 jump ufw-not-local
		...
		counter packets 1179619 bytes 736727985 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 6408562 bytes 3225510365 accept
		ct state related,established counter packets 19452696 bytes 12517886162 accept
		counter packets 180030 bytes 18809519 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 185 bytes 15348 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 69 bytes 3156 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 381 bytes 18320 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 446708 bytes 146519924 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 81649 bytes 23031048 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 26159 bytes 1621238 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 26160 bytes 1822346 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 41179 bytes 2470740 accept
		ip protocol udp ct state new counter packets 133718 bytes 15911539 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 1057850 bytes 669735278 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 28707198 bytes 22135084794 jump ufw-before-logging-input
		counter packets 28707198 bytes 22135084794 jump ufw-before-input
		counter packets 683379 bytes 178222661 jump ufw-after-input
		counter packets 154387 bytes 8634865 jump ufw-after-logging-input
		counter packets 154387 bytes 8634865 jump ufw-reject-input
		counter packets 154387 bytes 8634865 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 26041288 bytes 15762206046 jump ufw-before-logging-output
		counter packets 26041288 bytes 15762206046 jump ufw-before-output
		counter packets 180030 bytes 18809519 jump ufw-after-output
		counter packets 180030 bytes 18809519 jump ufw-after-logging-output
		counter packets 180030 bytes 18809519 jump ufw-reject-output
		counter packets 180030 bytes 18809519 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 279734619 bytes 329747785395 jump DOCKER-USER
		counter packets 279734626 bytes 329747786609 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 1500605 bytes 1888560355 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 1897052 bytes 833530895 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 5026 bytes 290995 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 5026 bytes 290995 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 528992 bytes 169587796 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 651140 bytes 567166529 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 528479 bytes 169561456 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 32357 bytes 1905783 accept
		udp dport 46539 counter packets 406478 bytes 553211757 accept
		udp dport 39425 counter packets 200 bytes 19821 accept
		tcp dport 80 counter packets 30949 bytes 1829141 accept
		udp dport 1194 counter packets 72 bytes 2851 accept
		tcp dport 8443 counter packets 24117 bytes 1417127 accept
		udp dport 21194 counter packets 26 bytes 4008 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 198 bytes 9652 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1838 bytes 104884 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 11869 bytes 2358040 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 49462 bytes 3039509 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 6 days   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 6 days   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 6 days   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 44 | 2026-08-08 04:30:20 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-08 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 204K
drwxr-xr-x  2 root root   4.0K Aug  8 03:10 .
