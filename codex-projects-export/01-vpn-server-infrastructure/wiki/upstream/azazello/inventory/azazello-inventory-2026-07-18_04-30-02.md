...
Generated: 2026-07-18T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 41 days, 14:09,  0 user,  load average: 0.06, 0.17, 0.22
```
...
wg79test         UNKNOWN        10.79.79.1/30 
...
10.79.79.0/30 dev wg79test proto kernel scope link src 10.79.79.1 
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=1869554,fd=3),("systemd",pid=1,fd=158))   
...
443/udp                    ALLOW IN    185.71.196.110             # wg79test udp443 hometele only
...
-A f2b-ufw-portscan -s 151.101.3.6/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.213.56.2/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.210.252/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 91.108.56.172/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.108.56.108/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 86.100.2.54/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 85.217.149.24/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 74.125.11.7/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 71.18.71.13/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 57.144.249.32/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.0.252.190/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.0.252.185/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 51.44.190.225/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 44.205.159.177/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.160.81.0/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 3.230.15.96/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.180.246.112/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 198.74.56.135/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.178.25.163/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.178.25.162/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.253.40.102/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.16.148.89/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.151.204.15/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 178.130.128.21/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.96.136.232/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.109.184.170/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 173.194.151.99/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.217.23.34/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 727 bytes 58593 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 727 bytes 45042 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 20434736 bytes 10958329581 accept
		ct state related,established counter packets 327707590 bytes 219047120961 accept
		ct state invalid counter packets 21748 bytes 1804788 jump ufw-logging-deny
		ct state invalid counter packets 21748 bytes 1804788 drop
		...
		ip protocol icmp icmp type echo-request counter packets 42726 bytes 2452752 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3363756 bytes 951332015 jump ufw-not-local
		...
		counter packets 3363756 bytes 951332015 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 20434740 bytes 10958329797 accept
		ct state related,established counter packets 410609798 bytes 481068926389 accept
		counter packets 2118529 bytes 269059299 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 326 bytes 17470 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 268 bytes 23008 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 234 bytes 12284 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1353 bytes 68552 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1456897 bytes 477862862 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 244449 bytes 74070770 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 725 bytes 40363 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 726 bytes 50222 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 345853 bytes 22263534 accept
		ip protocol udp ct state new counter packets 1731948 bytes 242792674 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 868869 bytes 1227744823 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1084594 bytes 1351910677 accept
		counter packets 725646031 bytes 597400021700 jump ufw-before-logging-input
		counter packets 725646031 bytes 597400021700 jump ufw-before-input
		counter packets 6517668 bytes 1335981542 jump ufw-after-input
		counter packets 2893199 bytes 161584746 jump ufw-after-logging-input
		counter packets 2893199 bytes 161584746 jump ufw-reject-input
		counter packets 2893199 bytes 161584746 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31254 bytes 5993258 accept
		counter packets 751319817 bytes 770804242269 jump ufw-before-logging-output
		counter packets 751319817 bytes 770804242269 jump ufw-before-output
		counter packets 5622228 bytes 772586377 jump ufw-after-output
		counter packets 5622228 bytes 772586377 jump ufw-after-logging-output
		counter packets 5622228 bytes 772586377 jump ufw-reject-output
		counter packets 5622228 bytes 772586377 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 154736393 bytes 365456811833 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 185301423 bytes 40343998254 accept
		...
		counter packets 483741514 bytes 508090633245 jump DOCKER-USER
		counter packets 483741514 bytes 508090633245 jump DOCKER-FORWARD
		counter packets 550 bytes 31530 jump ufw-before-logging-forward
		counter packets 550 bytes 31530 jump ufw-before-forward
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 673 bytes 108086 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 6989 bytes 424781 accept
	...
	chain DOCKER-FORWARD {
		counter packets 483741514 bytes 508090633245 jump DOCKER-CT
		counter packets 243733453 bytes 251433002701 jump DOCKER-INTERNAL
		counter packets 243733453 bytes 251433002701 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 176195289 bytes 220721877802 accept
		iifname "docker0" counter packets 67395308 bytes 30698420897 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 38759 bytes 6357979 jump DOCKER
		oifname "docker0" counter packets 103547 bytes 6314493 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 180938942 bytes 214392522280 accept
		oifname "docker0" ct state related,established counter packets 59069119 bytes 42265108264 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 63 bytes 3711 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 63 bytes 3711 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1703201 bytes 552037476 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1662285 bytes 399386419 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1701471 bytes 551945596 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 136 bytes 7740 accept
		udp dport 46539 counter packets 2620 bytes 3354314 accept
		udp dport 39425 counter packets 6 bytes 606 accept
		tcp dport 80 counter packets 52 bytes 2928 accept
		udp dport 1194 counter packets 1 bytes 28 accept
		tcp dport 8443 counter packets 68 bytes 3976 accept
		udp dport 21194 counter packets 1 bytes 140 accept
		...
		tcp dport 25 counter packets 8 bytes 412 accept
		...
		ip saddr 185.71.196.110 udp dport 443 counter packets 0 bytes 0 accept
	}
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 23 hours   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 23 hours   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 22 hours   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 41 | 2026-07-18 04:30:11 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-18 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 96K
drwxr-xr-x  2 root root   4.0K Jul 18 03:10 .
drwxr-xr-x 18 root syslog 4.0K Jul 17 23:16 ..
