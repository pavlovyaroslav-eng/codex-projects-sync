...
Generated: 2026-07-28T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 51 days, 14:09,  0 user,  load average: 0.37, 0.27, 0.28
```
...
-A f2b-ufw-portscan -s 44.192.201.254/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 57.144.249.33/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.158.177.1/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 93.123.109.39/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 1.1.1.1/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 79.124.56.226/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.23.97.113/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 79.124.56.146/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 20.25.153.59/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.93.10.7/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.46.220.130/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 142.251.153.119/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.104/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.112.173.133/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.23.97.98/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.58.205.142/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 185.253.40.72/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.217.112.4/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.176.35.114/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.163.51.231/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 62.210.142.160/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.16.16.146/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 5.252.32.145/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 123.58.192.214/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 129.134.188.129/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.101.75.39/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.163.56.199/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 20.55.87.52/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 42467 bytes 17089667 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 42467 bytes 2703361 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 31135212 bytes 16626373126 accept
		ct state related,established counter packets 360634808 bytes 250328195630 accept
		ct state invalid counter packets 30059 bytes 2384566 jump ufw-logging-deny
		ct state invalid counter packets 30059 bytes 2384566 drop
		...
		ip protocol icmp icmp type echo-request counter packets 50397 bytes 2902395 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 5742179 bytes 2158186095 jump ufw-not-local
		...
		counter packets 5742179 bytes 2158186095 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 31135560 bytes 16626404360 accept
		ct state related,established counter packets 441406781 bytes 504320274103 accept
		counter packets 2471351 bytes 299038557 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 385 bytes 34664 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 2383 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 321 bytes 16588 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 2031 bytes 102376 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 2215732 bytes 726762140 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 2384 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 375053 bytes 112942717 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 42467 bytes 12999985 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 42467 bytes 3054210 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 431056 bytes 27375708 accept
		ip protocol udp ct state new counter packets 1989873 bytes 266754420 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 3148934 bytes 1832926354 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1090750 bytes 1359553160 accept
		counter packets 771668130 bytes 635557023415 jump ufw-before-logging-input
		counter packets 771668130 bytes 635557023415 jump ufw-before-input
		counter packets 8179585 bytes 1767813357 jump ufw-after-input
		counter packets 3664789 bytes 305590785 jump ufw-after-logging-input
		counter packets 3664789 bytes 305590785 jump ufw-reject-input
		counter packets 3664789 bytes 305590785 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31413 bytes 6024246 accept
		counter packets 793170442 bytes 799753643804 jump ufw-before-logging-output
		counter packets 793170442 bytes 799753643804 jump ufw-before-output
		counter packets 5975050 bytes 802565635 jump ufw-after-output
		counter packets 5975050 bytes 802565635 jump ufw-after-logging-output
		counter packets 5975050 bytes 802565635 jump ufw-reject-output
		counter packets 5975050 bytes 802565635 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 157944612 bytes 370345923916 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 189573940 bytes 41851985995 accept
		...
		counter packets 896017910 bytes 985921561341 jump DOCKER-USER
		counter packets 896017910 bytes 985921561341 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 29033 bytes 5726157 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 71810 bytes 4368844 accept
	...
	chain DOCKER-FORWARD {
		counter packets 896017910 bytes 985921561341 jump DOCKER-CT
		counter packets 449236422 bytes 490174230975 jump DOCKER-INTERNAL
		counter packets 449236422 bytes 490174230975 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 338616707 bytes 447713182460 accept
		iifname "docker0" counter packets 110383675 bytes 42438782247 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 67119 bytes 11976050 jump DOCKER
		oifname "docker0" counter packets 168368 bytes 10258556 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 350647063 bytes 434716669054 accept
		oifname "docker0" ct state related,established counter packets 96134425 bytes 61030661312 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7460 bytes 525186 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7460 bytes 525186 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 2593528 bytes 839863252 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 3151242 bytes 1318468884 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 2590937 bytes 839717211 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 61643 bytes 3653642 accept
		udp dport 46539 counter packets 552150 bytes 763459145 accept
		udp dport 39425 counter packets 320 bytes 30438 accept
		tcp dport 80 counter packets 87490 bytes 5204124 accept
		udp dport 1194 counter packets 107 bytes 7469 accept
		tcp dport 8443 counter packets 11836 bytes 693242 accept
		...
		tcp dport 52000 counter packets 330 bytes 16687 accept
		udp dport 51820 counter packets 2 bytes 1600 accept
		tcp dport 25 counter packets 919 bytes 51120 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 10 days   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 10 days   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 10 days   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 44 | 2026-07-28 04:29:55 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-28 04:29:43 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 156K
drwxr-xr-x  2 root root   4.0K Jul 28 03:10 .
