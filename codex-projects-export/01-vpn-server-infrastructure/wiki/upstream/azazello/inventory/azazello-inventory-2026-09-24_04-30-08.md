...
Generated: 2026-09-24T04:30:08+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:08 up 10 days,  1:17,  0 user,  load average: 0.50, 0.38, 0.30
```
...
-A f2b-ufw-portscan -s 15.204.236.157/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 157.245.253.169/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 138.201.128.32/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 103.92.26.183/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.180.246.141/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 195.179.224.91/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 160.25.166.39/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 162.248.102.36/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.142.204.178/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 100.8.209.33/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 43441 bytes 9729933 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 43441 bytes 4002237 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 157234993 bytes 169823781537 accept
		ct state invalid counter packets 552 bytes 67265 jump ufw-logging-deny
		ct state invalid counter packets 552 bytes 67265 drop
		...
		ip protocol icmp icmp type echo-request counter packets 5215 bytes 316920 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1480947 bytes 294018743 jump ufw-not-local
		...
		counter packets 1480947 bytes 294018743 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 1932 bytes 318825 accept
		ct state related,established counter packets 161805027 bytes 175792828460 accept
		counter packets 2358435 bytes 367163780 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 122 bytes 9732 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 10 bytes 2020 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 82 bytes 3836 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1027 bytes 47376 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 624674 bytes 204892512 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 9 bytes 252 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 112231 bytes 36661219 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 43440 bytes 2660508 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 43440 bytes 3974295 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1067702 bytes 64063120 accept
		ip protocol udp ct state new counter packets 1287369 bytes 302766515 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 6590443 bytes 17304927164 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 158723641 bytes 170118503394 jump ufw-before-logging-input
		counter packets 158723641 bytes 170118503394 jump ufw-before-input
		counter packets 1008976 bytes 265644852 jump ufw-after-input
		counter packets 270821 bytes 24027905 jump ufw-after-logging-input
		counter packets 270821 bytes 24027905 jump ufw-reject-input
		counter packets 270821 bytes 24027905 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 164165394 bytes 176160311065 jump ufw-before-logging-output
		counter packets 164165394 bytes 176160311065 jump ufw-before-output
		counter packets 2358435 bytes 367163780 jump ufw-after-output
		counter packets 2358435 bytes 367163780 jump ufw-after-logging-output
		counter packets 2358435 bytes 367163780 jump ufw-reject-output
		counter packets 2358435 bytes 367163780 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 216069860 bytes 216065365686 jump DOCKER-USER
		counter packets 216069861 bytes 216065365746 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 2587527 bytes 3206801597 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 3523744 bytes 1784207299 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 552 bytes 67265 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 552 bytes 67265 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 738155 bytes 241616947 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 744031 bytes 52465878 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 736916 bytes 241552865 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 257720 bytes 15161884 accept
		udp dport 46539 counter packets 64 bytes 83171 accept
		udp dport 39425 counter packets 162 bytes 15252 accept
		tcp dport 80 counter packets 150460 bytes 8862217 accept
		udp dport 1194 counter packets 87 bytes 4262 accept
		tcp dport 8443 counter packets 60872 bytes 3579982 accept
		udp dport 21194 counter packets 22 bytes 3432 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 1 bytes 389 accept
		tcp dport 52000 counter packets 219 bytes 11924 accept
		udp dport 51820 counter packets 1 bytes 214 accept
		tcp dport 25 counter packets 1877 bytes 106580 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 41 bytes 2460 accept
		ip saddr 185.71.196.110 udp dport 24443 counter packets 413 bytes 540204 accept
	}
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 14218 bytes 1516865 accept
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-24 04:30:08 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-23 20:14:47 |
...
total 480K
drwxr-xr-x  2 root root   4.0K Sep 24 03:10 .
