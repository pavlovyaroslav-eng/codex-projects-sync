...
Generated: 2026-07-07T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 30 days, 17:09,  0 user,  load average: 0.92, 0.76, 0.63
```
...
veth9a2f552@if2  UP             fe80::74fb:29ff:feed:3298/64 
veth9661436@if2  UP             fe80::5010:c8ff:fe17:7658/64 
veth985c579@if3  UP             fe80::1c:6fff:feca:af99/64 
veth4b05783@if2  UP             fe80::cc9c:bdff:fea5:1da1/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::9d91:ed1a:2344:9b00/64 
...
fe80::/64 dev veth9a2f552 proto kernel metric 256 pref medium
fe80::/64 dev veth9661436 proto kernel metric 256 pref medium
fe80::/64 dev veth985c579 proto kernel metric 256 pref medium
fe80::/64 dev veth4b05783 proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1208591,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1208924,fd=16))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1208597,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:49945            *:*    users:(("xray-linux-amd6",pid=1208924,fd=37))                
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1091930,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1208330,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1208924,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1208924,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1208882,fd=5),("nginx",pid=1208881,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1209217,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1208865,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1208335,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1208924,fd=15))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1208882,fd=6),("nginx",pid=1208881,fd=6))
```
...
-A f2b-ufw-portscan -s 91.108.4.157/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.108.56.175/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.79.45.224/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.78.11.60/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 91.228.227.172/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 84.252.149.72/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 76.223.125.140/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.228.223.46/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.16.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.12.231/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 39.100.77.59/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 213.180.193.226/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 194.9.211.96/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.112.173.130/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.217.23.42/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 167.99.189.27/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 156.229.16.141/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 152.32.176.44/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 149.154.175.100/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 149.154.167.50/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 149.154.161.144/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 149.118.142.220/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 146.75.122.13/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 143.42.188.111/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 103.249.70.12/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 33752 bytes 8618259 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 33752 bytes 2305904 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 9032331 bytes 5219969560 accept
		ct state related,established counter packets 182506982 bytes 142765803716 accept
		ct state invalid counter packets 8058 bytes 537502 jump ufw-logging-deny
		ct state invalid counter packets 8058 bytes 537502 drop
		...
		ip protocol icmp icmp type echo-request counter packets 28784 bytes 1661600 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1676591 bytes 375885361 jump ufw-not-local
		...
		counter packets 1676591 bytes 375885361 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 9032335 bytes 5219969776 accept
		ct state related,established counter packets 206683651 bytes 241604244583 accept
		counter packets 1435245 bytes 194931763 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 156 bytes 13950 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 110 bytes 5800 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 589 bytes 30052 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 633366 bytes 207744694 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 105754 bytes 32166306 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 33751 bytes 2125588 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 33379 bytes 2659227 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 191863 bytes 12926951 accept
		ip protocol udp ct state new counter packets 1226016 bytes 180630625 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 273992 bytes 196387588 jump f2b-ufw-portscan
		iifname "tun79" counter packets 498310 bytes 620986143 accept
		counter packets 567328221 bytes 514802839342 jump ufw-before-logging-input
		counter packets 567328221 bytes 514802839342 jump ufw-before-input
		counter packets 5188553 bytes 1001682129 jump ufw-after-input
		counter packets 2527310 bytes 139362007 jump ufw-after-logging-input
		counter packets 2527310 bytes 139362007 jump ufw-reject-input
		counter packets 2527310 bytes 139362007 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 14523 bytes 2778309 accept
		counter packets 535307981 bytes 525527072906 jump ufw-before-logging-output
		counter packets 535307981 bytes 525527072906 jump ufw-before-output
		counter packets 4938944 bytes 698458841 jump ufw-after-output
		counter packets 4938944 bytes 698458841 jump ufw-after-logging-output
		counter packets 4938944 bytes 698458841 jump ufw-reject-output
		counter packets 4938944 bytes 698458841 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 69215492 bytes 168898937534 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 81394339 bytes 14776208497 accept
		...
		counter packets 291316490 bytes 326103724539 jump DOCKER-USER
		counter packets 291316490 bytes 326103724539 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 134 bytes 15248 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 51 bytes 3044 accept
	...
	chain DOCKER-FORWARD {
		counter packets 291316490 bytes 326103724539 jump DOCKER-CT
		counter packets 146831219 bytes 165458750883 jump DOCKER-INTERNAL
		counter packets 146831219 bytes 165458750883 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 133765643 bytes 158039790991 accept
		iifname "docker0" counter packets 13023669 bytes 7413956514 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 25641 bytes 4002814 jump DOCKER
		oifname "docker0" counter packets 15836 bytes 975646 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 133691836 bytes 153220378684 accept
		oifname "docker0" ct state related,established counter packets 10793435 bytes 7424594972 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 7016 bytes 476806 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 7016 bytes 476806 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 739975 bytes 239960802 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 937370 bytes 135964701 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 739221 bytes 239920660 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 159458 bytes 10046059 accept
		udp dport 46539 counter packets 59605 bytes 70773260 accept
		udp dport 39425 counter packets 89 bytes 8934 accept
		tcp dport 80 counter packets 85458 bytes 5107846 accept
		udp dport 1194 counter packets 46 bytes 2795 accept
		tcp dport 8443 counter packets 2702 bytes 152784 accept
		...
		tcp dport 52000 counter packets 134 bytes 7352 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1300 bytes 75036 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 41 | 2026-07-07 04:29:50 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-07 04:29:33 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 32K
drwxr-xr-x  2 root root   4.0K Jul  7 03:00 .
