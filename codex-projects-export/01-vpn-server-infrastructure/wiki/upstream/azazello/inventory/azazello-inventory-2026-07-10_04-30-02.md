...
Generated: 2026-07-10T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 33 days, 17:09,  0 user,  load average: 0.38, 0.33, 0.38
```
...
vethbf8dda5@if2  UP             fe80::5465:91ff:fe52:eb9b/64 
veth027af8e@if2  UP             fe80::4e3:79ff:fe2a:a77b/64 
veth7ca2bc3@if3  UP             fe80::6c48:45ff:fe5f:fbf2/64 
veth7f0aae0@if2  UP             fe80::8cde:7cff:fe23:f168/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::d1dd:ef9e:cf77:89b4/64 
...
fe80::/64 dev vethbf8dda5 proto kernel metric 256 pref medium
fe80::/64 dev veth027af8e proto kernel metric 256 pref medium
fe80::/64 dev veth7ca2bc3 proto kernel metric 256 pref medium
fe80::/64 dev veth7f0aae0 proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1386060,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1386394,fd=14))                
udp   UNCONN 0      0                  *:59175            *:*    users:(("xray-linux-amd6",pid=1386394,fd=7))                 
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1386064,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1091930,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1385881,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1386394,fd=15))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1386394,fd=17))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1386345,fd=5),("nginx",pid=1386343,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1386766,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1386325,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1385889,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1386394,fd=16))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1386345,fd=6),("nginx",pid=1386343,fd=6))
```
...
-A f2b-ufw-portscan -s 57.144.248.144/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 3.174.230.37/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 99.84.91.14/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 99.84.91.112/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 99.84.91.105/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.163.61.56/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.163.58.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.142.204.152/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.186.237.6/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.186.227.171/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.186.227.131/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.186.225.205/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 92.36.15.135/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 87.240.190.71/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.190.70/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.137.208/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.137.141/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.137.130/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.132.72/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 8.8.4.4/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 79.127.251.10/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 78.156.232.237/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 54.224.99.1/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.76.34.93/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.0.252.135/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 5.150.156.38/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 5.101.40.41/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.97.96.186/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.208.63/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.94.93.178/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.228.223.173/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.228.223.15/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.151.198.108/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.151.198.107/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.157.16.81/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 44.192.202.55/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 39.100.86.112/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 39.100.67.218/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 31.13.84.175/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 23.219.139.218/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 23.193.201.51/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.69.139.89/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.20.152.227/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.58.206.206/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.58.205.131/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 213.248.110.70/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 213.248.110.66/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.22.112.65/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 193.17.93.194/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.178.25.163/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.253.41.5/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.201.0.5/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.201.0.42/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 18.66.22.10/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 18.232.44.114/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 178.130.128.41/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 176.112.173.62/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 176.112.173.132/32 -j REJECT --reject-with icmp-port-unreachable

table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 46712 bytes 11548813 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 46712 bytes 3115976 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 12185105 bytes 6812311803 accept
		ct state related,established counter packets 227261390 bytes 163914766851 accept
		ct state invalid counter packets 11928 bytes 888949 jump ufw-logging-deny
		ct state invalid counter packets 11928 bytes 888949 drop
		...
		ip protocol icmp icmp type echo-request counter packets 39196 bytes 2252994 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2189740 bytes 524576096 jump ufw-not-local
		...
		counter packets 2189740 bytes 524576096 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 12185109 bytes 6812312019 accept
		ct state related,established counter packets 272567078 bytes 319083649461 accept
		counter packets 1601294 bytes 211005999 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 247 bytes 12498 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 186 bytes 16506 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 150 bytes 7884 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 838 bytes 42504 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 860439 bytes 282224638 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 144055 bytes 43811100 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 46711 bytes 2962292 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 46339 bytes 3671592 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 230532 bytes 15276401 accept
		ip protocol udp ct state new counter packets 1347851 bytes 193755380 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 68518 bytes 23468789 jump f2b-ufw-portscan
		iifname "tun79" counter packets 711441 bytes 886356533 accept
		counter packets 615762834 bytes 537693778296 jump ufw-before-logging-input
		counter packets 615762834 bytes 537693778296 jump ufw-before-input
		counter packets 5623414 bytes 1097614742 jump ufw-after-input
		counter packets 2696478 bytes 149152790 jump ufw-after-logging-input
		counter packets 2696478 bytes 149152790 jump ufw-reject-input
		counter packets 2696478 bytes 149152790 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 20723 bytes 3976233 accept
		counter packets 604510231 bytes 604614894263 jump ufw-before-logging-output
		counter packets 604510231 bytes 604614894263 jump ufw-before-output
		counter packets 5104993 bytes 714533077 jump ufw-after-output
		counter packets 5104993 bytes 714533077 jump ufw-after-logging-output
		counter packets 5104993 bytes 714533077 jump ufw-reject-output
		counter packets 5104993 bytes 714533077 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 97791410 bytes 233520805496 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 114458454 bytes 21137746359 accept
		...
		counter packets 345180092 bytes 376532653471 jump DOCKER-USER
		counter packets 345180092 bytes 376532653471 jump DOCKER-FORWARD
		counter packets 471 bytes 26558 jump ufw-before-logging-forward
		counter packets 471 bytes 26558 jump ufw-before-forward
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 65 bytes 7503 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 405 bytes 24284 accept
	...
	chain DOCKER-FORWARD {
		counter packets 345180092 bytes 376532653471 jump DOCKER-CT
		counter packets 173709338 bytes 188927016134 jump DOCKER-INTERNAL
		counter packets 173709338 bytes 188927016134 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 144926645 bytes 174893088302 accept
		iifname "docker0" counter packets 28712829 bytes 14026796496 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 29909 bytes 4691819 jump DOCKER
		oifname "docker0" counter packets 39484 bytes 2412959 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 146392645 bytes 169670588649 accept
		oifname "docker0" ct state related,established counter packets 25078109 bytes 17935048688 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 10446 bytes 784230 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 10446 bytes 784230 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1005668 bytes 326102632 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1185133 bytes 198529546 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1004607 bytes 326046550 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 168052 bytes 10589352 accept
		udp dport 46539 counter packets 99941 bytes 121236274 accept
		udp dport 39425 counter packets 115 bytes 11449 accept
		tcp dport 80 counter packets 113938 bytes 6809890 accept
		udp dport 1194 counter packets 72 bytes 3917 accept
		tcp dport 8443 counter packets 3331 bytes 188496 accept
		...
		tcp dport 52000 counter packets 193 bytes 10410 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1438 bytes 82400 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-10 04:30:05 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-10 04:29:21 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 44K
drwxr-xr-x  2 root root   4.0K Jul 10 03:00 .
