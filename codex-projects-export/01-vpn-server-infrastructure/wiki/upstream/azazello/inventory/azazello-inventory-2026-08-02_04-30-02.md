...
Generated: 2026-08-02T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up  1:17,  0 user,  load average: 0.30, 0.25, 0.31
```
...
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::a7fc:9557:b4ac:a8a9/64 
...
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1574,fd=16))             
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1447,fd=5),("nginx",pid=1445,fd=5))
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1574,fd=23))             
...
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1574,fd=14))             
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1447,fd=6),("nginx",pid=1445,fd=6))
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1574,fd=15))             
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1118,fd=9))                         
...
-A f2b-ufw-portscan -s 104.83.4.35/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.97.67.189/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 78.156.235.67/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 69.164.217.74/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 50.116.26.161/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 5.83.129.207/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.8.221/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.207.181/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 39.100.85.178/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 31.13.84.40/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 27.124.6.31/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 208.87.242.185/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.22.113.123/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 199.21.149.124/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 199.167.138.45/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 195.135.195.195/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.99.16.45/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.29.255.102/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 172.67.155.126/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 172.29.172.2/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 172.214.46.102/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 157.240.253.33/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 140.82.121.5/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.176.44/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.167.221/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.166.225/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.166.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.40.43.137/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.199.172.2/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 112.124.56.100/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 108.181.4.175/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 108.181.3.205/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.255.152.29/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.255.152.19/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.255.152.18/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.21.89.0/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.204.222.170/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.107.238.235/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 241 bytes 82683 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 241 bytes 14751 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 49108 bytes 17604842 accept
		ct state related,established counter packets 25369 bytes 11031419 accept
		ct state invalid counter packets 42 bytes 2062 jump ufw-logging-deny
		ct state invalid counter packets 42 bytes 2062 drop
		...
		ip protocol icmp icmp type echo-request counter packets 168 bytes 11219 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 7206 bytes 3562391 jump ufw-not-local
		...
		counter packets 7206 bytes 3562391 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 49108 bytes 17604842 accept
		ct state related,established counter packets 31511 bytes 28900152 accept
		counter packets 895 bytes 59079 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 12 bytes 1152 jump ufw-skip-to-policy-input
		...
		tcp dport 445 counter packets 2 bytes 92 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 4143 bytes 1358904 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 694 bytes 213460 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 241 bytes 19421 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 240 bytes 16416 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 259 bytes 15540 accept
		ip protocol udp ct state new counter packets 597 bytes 40727 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 54624 bytes 21229117 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 81893 bytes 32211933 jump ufw-before-logging-input
		counter packets 81893 bytes 32211933 jump ufw-before-input
		counter packets 5513 bytes 1623434 jump ufw-after-input
		counter packets 662 bytes 49826 jump ufw-after-logging-input
		counter packets 662 bytes 49826 jump ufw-reject-input
		counter packets 662 bytes 49826 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 81514 bytes 46564073 jump ufw-before-logging-output
		counter packets 81514 bytes 46564073 jump ufw-before-output
		counter packets 895 bytes 59079 jump ufw-after-output
		counter packets 895 bytes 59079 jump ufw-after-logging-output
		counter packets 895 bytes 59079 jump ufw-reject-output
		counter packets 895 bytes 59079 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 821938 bytes 824187536 jump DOCKER-USER
		counter packets 821945 bytes 824188750 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 16165 bytes 26759686 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 21510 bytes 5255185 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 40 bytes 1880 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 40 bytes 1880 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 4851 bytes 1573608 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2357 bytes 1988875 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 4849 bytes 1573516 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 126 bytes 7384 accept
		udp dport 46539 counter packets 1375 bytes 1917279 accept
		udp dport 39425 counter packets 36 bytes 3314 accept
		tcp dport 80 counter packets 22 bytes 1108 accept
		udp dport 1194 counter packets 1 bytes 28 accept
		tcp dport 8443 counter packets 98 bytes 5808 accept
		udp dport 21194 counter packets 21 bytes 3276 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 3 bytes 172 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 6 bytes 288 accept
	...
	chain f2b-ufw-portscan {
		ip saddr 104.83.4.35 counter packets 2 bytes 152 reject
		ip saddr 95.97.67.189 counter packets 0 bytes 0 reject
		ip saddr 89.144.35.106 counter packets 0 bytes 0 reject
```
...
mtproto-telegram             telegrammessenger/proxy:latest   Up About an hour   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 45 | 2026-08-02 04:30:03 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-02 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 180K
drwxr-xr-x  2 root root   4.0K Aug  2 03:30 .
drwxrwxr-x 18 root syslog 4.0K Aug  2 03:13 ..
