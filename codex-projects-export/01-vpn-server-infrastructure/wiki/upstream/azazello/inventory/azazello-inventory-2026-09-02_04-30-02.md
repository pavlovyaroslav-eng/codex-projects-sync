...
Generated: 2026-09-02T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 31 days,  1:17,  0 user,  load average: 0.62, 0.44, 0.34
```
...
udp   UNCONN 0      0         127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=1988366,fd=16))                  
udp   UNCONN 0      0      127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=1988366,fd=14))                  
...
udp   UNCONN 0      0          127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1988399,fd=3))                           
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=1988378,fd=3),("systemd",pid=1,fd=203))     
tcp   LISTEN 0      4096      127.0.0.54:53         0.0.0.0:*    users:(("systemd-resolve",pid=1988366,fd=17))                  
tcp   LISTEN 0      32           0.0.0.0:8443       0.0.0.0:*    users:(("openvpn",pid=1108,fd=5))                              
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("smtpd",pid=2657417,fd=6),("master",pid=1988747,fd=13))
tcp   LISTEN 0      4096       127.0.0.1:45821      0.0.0.0:*    users:(("containerd",pid=1204,fd=13))                          
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1988385,fd=5),("nginx",pid=1988384,fd=5))  
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1155725,fd=23))                  
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=1988366,fd=15))                  
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1988399,fd=4))                           
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1988385,fd=6),("nginx",pid=1988384,fd=6))  
...
-A f2b-ufw-portscan -s 121.199.160.16/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 103.76.103.101/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 23.44.215.195/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 165.99.222.235/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 184.16.11.232/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 68.211.112.9/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 89.205.132.126/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 213.172.173.138/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 134161 bytes 47950384 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 134161 bytes 8249212 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 33249672 bytes 17533207517 accept
		ct state related,established counter packets 264299251 bytes 297176012206 accept
		ct state invalid counter packets 23965 bytes 1403670 jump ufw-logging-deny
		ct state invalid counter packets 23965 bytes 1403670 drop
		...
		ip protocol icmp icmp type echo-request counter packets 21210 bytes 1324043 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 6913494 bytes 3993871129 jump ufw-not-local
		...
		counter packets 6913494 bytes 3993871129 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 33249672 bytes 17533207517 accept
		ct state related,established counter packets 217513395 bytes 177889877482 accept
		counter packets 903724 bytes 89541941 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 541 bytes 45485 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 731 bytes 167198 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 289 bytes 13580 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1912 bytes 93764 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 2324776 bytes 762525554 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 394160 bytes 116742100 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 134135 bytes 8339054 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 134160 bytes 9518779 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 223305 bytes 14406555 accept
		ip protocol udp ct state new counter packets 654393 bytes 72756829 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 11307584 bytes 12529204968 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 304507592 bytes 318705818565 jump ufw-before-logging-input
		counter packets 304507592 bytes 318705818565 jump ufw-before-input
		counter packets 3674114 bytes 952076999 jump ufw-after-input
		counter packets 951704 bytes 72489290 jump ufw-after-logging-input
		counter packets 951704 bytes 72489290 jump ufw-reject-input
		counter packets 951704 bytes 72489290 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 251666791 bytes 195512626940 jump ufw-before-logging-output
		counter packets 251666791 bytes 195512626940 jump ufw-before-output
		counter packets 903724 bytes 89541941 jump ufw-after-output
		counter packets 903724 bytes 89541941 jump ufw-after-logging-output
		counter packets 903724 bytes 89541941 jump ufw-reject-output
		counter packets 903724 bytes 89541941 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1495499174 bytes 1830307305748 jump DOCKER-USER
		counter packets 1495499181 bytes 1830307306962 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 7130441 bytes 8768680293 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 8939124 bytes 3981161404 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 17610 bytes 1109068 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 17610 bytes 1109068 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 2722410 bytes 879587709 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 4193546 bytes 3114410812 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 2719948 bytes 879460317 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 494870 bytes 24047753 accept
		udp dport 46539 counter packets 2149926 bytes 2988485065 accept
		udp dport 39425 counter packets 743 bytes 74170 accept
		tcp dport 80 counter packets 487292 bytes 22947205 accept
		udp dport 1194 counter packets 310 bytes 13019 accept
		tcp dport 8443 counter packets 101006 bytes 5935343 accept
		udp dport 21194 counter packets 56 bytes 8560 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 1 bytes 438 accept
		tcp dport 52000 counter packets 801 bytes 41145 accept
		udp dport 51820 counter packets 1 bytes 436 accept
		tcp dport 25 counter packets 4369 bytes 240696 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 24878 bytes 4463489 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 344073 bytes 21253762 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-02 04:30:00 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-02 02:49:50 |
| `/root/cert` | directory | root:root | 755 | 4096 | 2025-03-17 17:20:58 |
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-09-02 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 360K
drwxr-xr-x  2 root root   4.0K Sep  2 03:10 .
drwxr-xr-x 18 root syslog 4.0K Sep  1 00:00 ..
