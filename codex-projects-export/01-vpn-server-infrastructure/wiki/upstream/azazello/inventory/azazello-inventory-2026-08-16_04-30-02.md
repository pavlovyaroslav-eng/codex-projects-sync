...
Generated: 2026-08-16T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 14 days,  1:17,  0 user,  load average: 0.11, 0.27, 0.28
```
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=3101541,fd=3),("systemd",pid=1,fd=230))     
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("smtpd",pid=3110495,fd=6),("master",pid=3101833,fd=13))
tcp   LISTEN 0      4096       127.0.0.1:45821      0.0.0.0:*    users:(("containerd",pid=1204,fd=13))                          
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=2956086,fd=5),("nginx",pid=2956085,fd=5))  
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=2956086,fd=6),("nginx",pid=2956085,fd=6))  
...
-A f2b-ufw-portscan -s 82.146.11.70/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.79.211.97/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 178.217.162.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.208.211/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 195.95.177.10/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.206.68/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 194.45.197.215/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.250.243.86/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 114.117.136.87/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.41.166.76/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.149.68/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 5.139.231.139/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 31.58.91.205/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 1.117.233.115/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.91.64.7/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 185.178.208.143/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 151.236.83.86/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 151.101.1.91/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.24/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 101.255.158.147/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.99.115.249/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 118.31.188.56/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 60721 bytes 22361014 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 60721 bytes 3768308 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 14996525 bytes 7756866692 accept
		ct state related,established counter packets 70096988 bytes 65445276737 accept
		ct state invalid counter packets 10801 bytes 657663 jump ufw-logging-deny
		ct state invalid counter packets 10801 bytes 657663 drop
		...
		ip protocol icmp icmp type echo-request counter packets 9471 bytes 587659 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2620264 bytes 1644615664 jump ufw-not-local
		...
		counter packets 2620264 bytes 1644615664 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 14996525 bytes 7756866692 accept
		ct state related,established counter packets 62847830 bytes 44541113228 accept
		counter packets 467688 bytes 47913322 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 353 bytes 30234 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 519 bytes 118851 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 133 bytes 6380 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 890 bytes 43496 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1047297 bytes 343512817 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 181546 bytes 53037856 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 60720 bytes 3858387 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 60720 bytes 4400639 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 110834 bytes 7486434 accept
		ip protocol udp ct state new counter packets 341465 bytes 38991004 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 8992647 bytes 7457424796 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 87734049 bytes 74848004415 jump ufw-before-logging-input
		counter packets 87734049 bytes 74848004415 jump ufw-before-input
		counter packets 1540930 bytes 432309762 jump ufw-after-input
		counter packets 310192 bytes 35560128 jump ufw-after-logging-input
		counter packets 310192 bytes 35560128 jump ufw-reject-input
		counter packets 310192 bytes 35560128 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 78312043 bytes 52345893242 jump ufw-before-logging-output
		counter packets 78312043 bytes 52345893242 jump ufw-before-output
		counter packets 467688 bytes 47913322 jump ufw-after-output
		counter packets 467688 bytes 47913322 jump ufw-after-logging-output
		counter packets 467688 bytes 47913322 jump ufw-reject-output
		counter packets 467688 bytes 47913322 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 652091960 bytes 779986996187 jump DOCKER-USER
		counter packets 652091967 bytes 779986997401 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 3306375 bytes 4049778186 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 4130992 bytes 1863369218 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 9206 bytes 580338 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 9206 bytes 580338 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1230738 bytes 396749634 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1390664 bytes 1247924777 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1229600 bytes 396690887 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 79646 bytes 5343857 accept
		udp dport 46539 counter packets 865227 bytes 1199013529 accept
		udp dport 39425 counter packets 294 bytes 29435 accept
		tcp dport 80 counter packets 89999 bytes 5333238 accept
		udp dport 1194 counter packets 141 bytes 5751 accept
		tcp dport 8443 counter packets 41154 bytes 2415142 accept
		udp dport 21194 counter packets 43 bytes 6596 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 1 bytes 438 accept
		tcp dport 52000 counter packets 377 bytes 19480 accept
		udp dport 51820 counter packets 1 bytes 436 accept
		tcp dport 25 counter packets 2446 bytes 137700 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 16867 bytes 3295664 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 144637 bytes 8944235 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 2 weeks   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 2 weeks   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 2 weeks   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 44 | 2026-08-16 04:30:02 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-15 12:50:29 |
| `/root/cert` | directory | root:root | 755 | 4096 | 2025-03-17 17:20:58 |
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-16 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
drwxr-xr-x 18 root syslog 4.0K Aug 16 00:00 ..
