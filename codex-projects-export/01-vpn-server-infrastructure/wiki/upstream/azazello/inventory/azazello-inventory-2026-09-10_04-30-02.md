...
Generated: 2026-09-10T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 39 days,  1:17,  0 user,  load average: 0.23, 0.36, 0.39
```
...
udp   UNCONN 0      0                  *:53172            *:*    users:(("rw-core",pid=2921938,fd=27))                        
udp   UNCONN 0      0                  *:51224            *:*    users:(("rw-core",pid=2921938,fd=10))                        
udp   UNCONN 0      0                  *:40987            *:*    users:(("rw-core",pid=2921938,fd=26))                        
udp   UNCONN 0      0                  *:43195            *:*    users:(("rw-core",pid=2921938,fd=18))                        
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1113,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:39759            *:*    users:(("rw-core",pid=2921938,fd=20))                        
udp   UNCONN 0      0                  *:56261            *:*    users:(("rw-core",pid=2921938,fd=21))                        
udp   UNCONN 0      0                  *:46330            *:*    users:(("rw-core",pid=2921938,fd=19))                        
udp   UNCONN 0      0                  *:40314            *:*    users:(("rw-core",pid=2921938,fd=15))                        
...
-A f2b-sshd -j RETURN
-A f2b-ufw-portscan -s 109.238.86.154/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.92.114.35/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 82.25.45.57/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 141.98.50.7/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 146.59.52.63/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.26.103.124/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.11.145.5/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.199.174.33/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.95.199.236/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.95.208.99/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 104.234.6.169/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 29612 bytes 7219613 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 29612 bytes 2284015 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 93249266 bytes 91369772023 accept
		ct state invalid counter packets 579 bytes 105299 jump ufw-logging-deny
		ct state invalid counter packets 579 bytes 105299 drop
		...
		ip protocol icmp icmp type echo-request counter packets 3371 bytes 195652 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1489250 bytes 495283570 jump ufw-not-local
		...
		counter packets 1489250 bytes 495283570 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 101590890 bytes 93698708418 accept
		counter packets 1921237 bytes 216857805 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 122 bytes 10162 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2 bytes 404 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 67 bytes 3088 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 440 bytes 21412 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 515674 bytes 169140564 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 4 bytes 112 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 85792 bytes 25943440 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 29611 bytes 1790381 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 29612 bytes 2292616 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 881823 bytes 52912132 accept
		ip protocol udp ct state new counter packets 1036984 bytes 163693762 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 3586 bytes 818189 jump f2b-sshd
		ip protocol tcp counter packets 21729499 bytes 49023579833 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 403241373 bytes 413631701644 jump ufw-before-logging-input
		counter packets 403241373 bytes 413631701644 jump ufw-before-input
		counter packets 4561664 bytes 1190851549 jump ufw-after-input
		counter packets 1136293 bytes 83499447 jump ufw-after-logging-input
		counter packets 1136293 bytes 83499447 jump ufw-reject-input
		counter packets 1136293 bytes 83499447 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 358934650 bytes 291911345536 jump ufw-before-logging-output
		counter packets 358934650 bytes 291911345536 jump ufw-before-output
		counter packets 2870436 bytes 309980761 jump ufw-after-output
		counter packets 2870436 bytes 309980761 jump ufw-after-logging-output
		counter packets 2870436 bytes 309980761 jump ufw-reject-output
		counter packets 2870436 bytes 309980761 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1684480505 bytes 2023982328995 jump DOCKER-USER
		counter packets 1684480512 bytes 2023982330209 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8325238 bytes 10331236341 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 10522790 bytes 4671220063 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 3503 bytes 466996 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 447841 bytes 27567266 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1684480512 bytes 2023982330209 jump DOCKER-CT
		counter packets 850192061 bytes 1024756689962 jump DOCKER-INTERNAL
		counter packets 850192061 bytes 1024756689962 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 623958615 bytes 879567414083 accept
		iifname "docker0" counter packets 206904401 bytes 130153793770 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 33174 bytes 5466396 jump DOCKER
		oifname "docker0" counter packets 447841 bytes 27567266 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 641341952 bytes 852959631589 accept
		oifname "docker0" ct state related,established counter packets 192946499 bytes 146266008658 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 109.238.86.154 counter packets 64 bytes 2816 reject
		ip saddr 85.217.149.50 counter packets 6 bytes 312 reject
		ip saddr 85.217.149.51 counter packets 16 bytes 832 reject
		ip saddr 85.217.140.7 counter packets 31 bytes 1612 reject
		ip saddr 85.217.149.70 counter packets 72 bytes 3744 reject
		ip saddr 47.92.114.35 counter packets 92 bytes 3680 reject
		ip saddr 79.124.62.246 counter packets 507 bytes 20280 reject
		ip saddr 79.124.62.242 counter packets 472 bytes 18880 reject
		ip saddr 85.217.140.11 counter packets 145 bytes 7540 reject
		ip saddr 85.217.149.73 counter packets 263 bytes 13676 reject
		ip saddr 85.217.140.27 counter packets 109 bytes 5668 reject
		ip saddr 85.217.140.48 counter packets 227 bytes 11804 reject
		ip saddr 85.217.140.23 counter packets 123 bytes 6396 reject
		ip saddr 85.217.149.63 counter packets 358 bytes 18616 reject
		ip saddr 85.217.140.3 counter packets 153 bytes 7956 reject
		ip saddr 47.95.196.164 counter packets 106 bytes 4240 reject
		ip saddr 85.217.140.19 counter packets 214 bytes 11128 reject
		ip saddr 85.217.140.39 counter packets 307 bytes 15964 reject
		ip saddr 85.217.149.68 counter packets 284 bytes 14768 reject
		ip saddr 85.217.140.41 counter packets 355 bytes 18460 reject
		ip saddr 85.217.140.43 counter packets 332 bytes 17264 reject
		ip saddr 85.217.149.65 counter packets 449 bytes 23348 reject
		ip saddr 85.217.140.33 counter packets 165 bytes 8580 reject
		ip saddr 85.217.149.67 counter packets 341 bytes 17732 reject
		ip saddr 85.217.140.9 counter packets 309 bytes 16068 reject
		ip saddr 82.25.45.57 counter packets 17 bytes 988 reject
		ip saddr 141.98.50.7 counter packets 21 bytes 1248 reject
		ip saddr 146.59.52.63 counter packets 0 bytes 0 reject
		ip saddr 85.217.140.52 counter packets 361 bytes 18772 reject
		ip saddr 85.217.140.1 counter packets 209 bytes 10868 reject
		ip saddr 85.217.140.47 counter packets 451 bytes 23452 reject
		ip saddr 85.217.140.6 counter packets 259 bytes 13468 reject
		ip saddr 85.217.149.66 counter packets 511 bytes 26572 reject
		ip saddr 85.217.149.52 counter packets 198 bytes 10296 reject
		ip saddr 2.26.103.124 counter packets 1 bytes 60 reject
		ip saddr 185.11.145.5 counter packets 84 bytes 4944 reject
		ip saddr 85.217.149.64 counter packets 520 bytes 27040 reject
		ip saddr 85.217.140.51 counter packets 553 bytes 28756 reject
		ip saddr 85.217.140.44 counter packets 574 bytes 29848 reject
		ip saddr 85.217.140.24 counter packets 300 bytes 15600 reject
		ip saddr 85.217.140.5 counter packets 277 bytes 14404 reject
		ip saddr 87.240.137.206 counter packets 1 bytes 115 reject
		ip saddr 87.240.129.140 counter packets 1 bytes 115 reject
		ip saddr 85.217.140.31 counter packets 96 bytes 4992 reject
		ip saddr 85.217.140.20 counter packets 198 bytes 10296 reject
		ip saddr 85.217.140.4 counter packets 498 bytes 25896 reject
		ip saddr 85.217.140.12 counter packets 757 bytes 39364 reject
		ip saddr 85.217.140.45 counter packets 654 bytes 34008 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 6 days    
mtproto-telegram             telegrammessenger/proxy:latest   Up 5 weeks   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 2 days    0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-10 04:30:07 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-09 20:38:00 |
...
total 396K
drwxr-xr-x  2 root root   4.0K Sep 10 03:10 .
