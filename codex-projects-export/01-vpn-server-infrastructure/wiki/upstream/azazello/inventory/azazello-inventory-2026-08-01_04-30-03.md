...
Generated: 2026-08-01T04:30:03+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 55 days, 14:09,  0 user,  load average: 0.71, 0.61, 0.53
```
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=3586054,fd=13),("smtpd",pid=693457,fd=6))
...
-A f2b-ufw-portscan -s 10.90.1.50/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.216.247.97/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 160.119.76.51/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.79.207.111/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 183.92.168.184/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 88.99.216.85/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.164.45/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.142.204.187/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.95.198.233/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 89.144.35.106/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 112.124.58.83/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 166.88.75.5/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 67.29.133.50/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.33/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.87.154/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 59747 bytes 24042263 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 59747 bytes 3824191 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 35425449 bytes 18932708961 accept
		ct state related,established counter packets 408791814 bytes 307807127954 accept
		ct state invalid counter packets 32787 bytes 2622912 jump ufw-logging-deny
		ct state invalid counter packets 32787 bytes 2622912 drop
		...
		ip protocol icmp icmp type echo-request counter packets 52442 bytes 3021832 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 6615209 bytes 2650374184 jump ufw-not-local
		...
		counter packets 6615209 bytes 2650374184 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 35425820 bytes 18932742035 accept
		ct state related,established counter packets 481182009 bytes 541215638818 accept
		counter packets 2709818 bytes 324240924 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 419 bytes 37316 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 2383 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 350 bytes 17952 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 2280 bytes 114504 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 2518157 bytes 825957540 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 2384 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 425499 bytes 128248615 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 59746 bytes 14036049 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 59747 bytes 4329023 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 471015 bytes 29793230 accept
		ip protocol udp ct state new counter packets 2183848 bytes 289026250 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 20815846 bytes 21784663928 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1090750 bytes 1359553160 accept
		counter packets 824993176 bytes 695834837446 jump ufw-before-logging-input
		counter packets 824993176 bytes 695834837446 jump ufw-before-input
		counter packets 8726979 bytes 1893066956 jump ufw-after-input
		counter packets 3859000 bytes 316326942 jump ufw-after-logging-input
		counter packets 3859000 bytes 316326942 jump ufw-reject-input
		counter packets 3859000 bytes 316326942 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31413 bytes 6024246 accept
		counter packets 837474397 bytes 838980548561 jump ufw-before-logging-output
		counter packets 837474397 bytes 838980548561 jump ufw-before-output
		counter packets 6213517 bytes 827768002 jump ufw-after-output
		counter packets 6213517 bytes 827768002 jump ufw-after-logging-output
		counter packets 6213517 bytes 827768002 jump ufw-reject-output
		counter packets 6213517 bytes 827768002 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 158889851 bytes 371537329706 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 190870662 bytes 42323408825 accept
		...
		counter packets 1078396466 bytes 1196878632241 jump DOCKER-USER
		counter packets 1078396466 bytes 1196878632241 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 37452 bytes 7350380 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 96340 bytes 5854823 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1078396466 bytes 1196878632241 jump DOCKER-CT
		counter packets 540084558 bytes 595563234776 jump DOCKER-INTERNAL
		counter packets 540084558 bytes 595563234776 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 413201493 bytes 549342513951 accept
		iifname "docker0" counter packets 126614076 bytes 46195344355 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 75538 bytes 13600273 jump DOCKER
		oifname "docker0" counter packets 192898 bytes 11744535 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 428153006 bytes 533439474473 accept
		oifname "docker0" ct state related,established counter packets 110158902 bytes 67875922992 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 9984 bytes 753403 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 9984 bytes 753403 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 2946711 bytes 954380694 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 3671401 bytes 1696155675 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 2943808 bytes 954218509 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 93121 bytes 5509997 accept
		udp dport 46539 counter packets 817288 bytes 1126827098 accept
		udp dport 39425 counter packets 402 bytes 38171 accept
		tcp dport 80 counter packets 107092 bytes 6365567 accept
		udp dport 1194 counter packets 154 bytes 9533 accept
		tcp dport 8443 counter packets 20175 bytes 1180206 accept
		...
		tcp dport 52000 counter packets 504 bytes 25105 accept
		udp dport 51820 counter packets 2 bytes 1600 accept
		tcp dport 25 counter packets 1695 bytes 94680 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 44 | 2026-08-01 04:29:58 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-01 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 172K
drwxr-xr-x  2 root root   4.0K Aug  1 03:10 .
drwxrwxr-x 18 root syslog 4.0K Aug  1 00:00 ..
