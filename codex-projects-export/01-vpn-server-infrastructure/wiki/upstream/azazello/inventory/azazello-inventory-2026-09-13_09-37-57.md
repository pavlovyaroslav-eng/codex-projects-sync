...
Generated: 2026-09-13T09:37:57+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 09:37:57 up 42 days,  6:25,  1 user,  load average: 0.81, 0.79, 0.65
```
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 43496 bytes 10315673 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 43496 bytes 3430383 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 133340584 bytes 127643455742 accept
		...
		counter packets 2165203 bytes 680763593 jump ufw-not-local
		...
		counter packets 2165203 bytes 680763593 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 147648840 bytes 132099038964 accept
		counter packets 2608100 bytes 312979298 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		udp dport 67 counter packets 758402 bytes 248755180 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 7 bytes 196 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 126380 bytes 38484240 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 43495 bytes 2681256 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 43496 bytes 3453577 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1157496 bytes 69452796 accept
		ip protocol udp ct state new counter packets 1447065 bytes 243151835 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 9199 bytes 4631258 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 444010878 bytes 450091113038 jump ufw-before-logging-input
		counter packets 444010878 bytes 450091113038 jump ufw-before-input
		counter packets 4897799 bytes 1286391013 jump ufw-after-input
		counter packets 1188689 bytes 86862097 jump ufw-after-logging-input
		counter packets 1188689 bytes 86862097 jump ufw-reject-input
		counter packets 1188689 bytes 86862097 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 405679463 bytes 330407797575 jump ufw-before-logging-output
		counter packets 405679463 bytes 330407797575 jump ufw-before-output
		counter packets 3557299 bytes 406102254 jump ufw-after-output
		counter packets 3557299 bytes 406102254 jump ufw-after-logging-output
		counter packets 3557299 bytes 406102254 jump ufw-reject-output
		counter packets 3557299 bytes 406102254 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1744255315 bytes 2079483453603 jump DOCKER-USER
		counter packets 1744255322 bytes 2079483454817 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 9145148 bytes 11373885256 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11650800 bytes 5239068378 accept
	...
	chain DOCKER {
		...
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 490693 bytes 30204542 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1744255322 bytes 2079483454817 jump DOCKER-CT
		counter packets 881865365 bytes 1053535120997 jump DOCKER-INTERNAL
		counter packets 881865365 bytes 1053535120997 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 635229861 bytes 893085919942 accept
		iifname "docker0" counter packets 225306217 bytes 143797341184 accept
	}
	...
	chain DOCKER-BRIDGE {
		...
		oifname "docker0" counter packets 490693 bytes 30204542 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 652732728 bytes 866143889211 accept
		oifname "docker0" ct state related,established counter packets 209657229 bytes 159804444609 accept
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 885840 bytes 287295996 drop
	}
	...
	chain ufw-user-input {
		...
		tcp dport 52000 counter packets 455 bytes 26077 accept
