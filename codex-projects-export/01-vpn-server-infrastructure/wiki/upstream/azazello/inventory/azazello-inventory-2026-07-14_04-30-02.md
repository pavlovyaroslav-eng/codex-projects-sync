...
Generated: 2026-07-14T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 37 days, 17:09,  0 user,  load average: 1.04, 0.58, 0.43
```
...
vethc676180@if2  UP             fe80::a8d1:6fff:fe09:e171/64 
vethb2162ee@if2  UP             fe80::a093:c3ff:fec3:f942/64 
veth7b6ce1b@if3  UP             fe80::496:5bff:feab:daa1/64 
veth2d91a8e@if2  UP             fe80::980a:d5ff:fe23:b949/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::1d32:fcfa:d25c:c05f/64 
...
fe80::/64 dev vethc676180 proto kernel metric 256 pref medium
fe80::/64 dev vethb2162ee proto kernel metric 256 pref medium
fe80::/64 dev veth7b6ce1b proto kernel metric 256 pref medium
fe80::/64 dev veth2d91a8e proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1638947,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1639298,fd=16))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0              *%wg0:43406            *:*    users:(("xray-linux-amd6",pid=1639298,fd=25))                
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1638952,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:45908            *:*    users:(("xray-linux-amd6",pid=1639298,fd=7))                 
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1521352,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1638691,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1639298,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1639298,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1639258,fd=5),("nginx",pid=1639257,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1639589,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1639240,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1638698,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1639298,fd=15))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1639258,fd=6),("nginx",pid=1639257,fd=6))
```
...
-A f2b-ufw-portscan -s 2.16.16.163/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.58.206.202/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 94.158.32.139/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 94.100.180.216/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.79.41.253/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.79.41.221/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.79.34.166/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 90.156.232.26/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 87.240.185.156/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 83.143.242.122/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.24.93.18/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 8.132.226.31/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 79.142.76.233/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 78.156.235.149/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 74.178.76.128/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 57.144.248.36/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.0.252.102/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.208.73/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.12.124.24/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 44.192.202.38/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 44.192.201.239/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 35.190.25.25/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 63992 bytes 16361425 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 63992 bytes 4215459 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 16386736 bytes 8937461226 accept
		ct state related,established counter packets 277079109 bytes 187882283960 accept
		ct state invalid counter packets 16747 bytes 1367867 jump ufw-logging-deny
		ct state invalid counter packets 16747 bytes 1367867 drop
		...
		ip protocol icmp icmp type echo-request counter packets 40945 bytes 2343125 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2801855 bytes 738222539 jump ufw-not-local
		...
		counter packets 2801855 bytes 738222539 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 16386740 bytes 8937461442 accept
		ct state related,established counter packets 344139986 bytes 405801246468 accept
		counter packets 1901499 bytes 248486004 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 241 bytes 20902 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 195 bytes 10240 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1118 bytes 56864 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1163679 bytes 381687358 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 194862 bytes 59176020 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 63992 bytes 4175739 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 63619 bytes 4960435 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 292826 bytes 19055437 accept
		ip protocol udp ct state new counter packets 1576506 bytes 226443192 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 76752 bytes 25639238 jump f2b-ufw-portscan
		iifname "tun79" counter packets 877544 bytes 1094733030 accept
		counter packets 670400867 bytes 564000660320 jump ufw-before-logging-input
		counter packets 670400867 bytes 564000660320 jump ufw-before-input
		counter packets 6077934 bytes 1219039778 jump ufw-after-input
		counter packets 2796571 bytes 155729074 jump ufw-after-logging-input
		counter packets 2796571 bytes 155729074 jump ufw-reject-input
		counter packets 2796571 bytes 155729074 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 25592 bytes 4916661 accept
		counter packets 680584975 bytes 693495120698 jump ufw-before-logging-output
		counter packets 680584975 bytes 693495120698 jump ufw-before-output
		counter packets 5405198 bytes 752013082 jump ufw-after-output
		counter packets 5405198 bytes 752013082 jump ufw-after-logging-output
		counter packets 5405198 bytes 752013082 jump ufw-reject-output
		counter packets 5405198 bytes 752013082 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 129033955 bytes 307441897102 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 152960818 bytes 31030334078 accept
		...
		counter packets 402819995 bytes 422155593789 jump DOCKER-USER
		counter packets 402819995 bytes 422155593789 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 383 bytes 179042 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 109 bytes 6528 accept
	...
	chain DOCKER-FORWARD {
		counter packets 402819995 bytes 422155593789 jump DOCKER-CT
		counter packets 203360062 bytes 210589494439 jump DOCKER-INTERNAL
		counter packets 203360062 bytes 210589494439 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 156557184 bytes 191353727679 accept
		iifname "docker0" counter packets 46698747 bytes 19225875188 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 34399 bytes 5651864 jump DOCKER
		oifname "docker0" counter packets 69206 bytes 4209882 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 159316851 bytes 185780185742 accept
		oifname "docker0" ct state related,established counter packets 40143082 bytes 25785913608 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 14869 bytes 1222566 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 14869 bytes 1222566 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1360095 bytes 440951384 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1443189 bytes 297347197 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1358666 bytes 440875342 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 196379 bytes 12376201 accept
		udp dport 46539 counter packets 173304 bytes 208324344 accept
		udp dport 39425 counter packets 238 bytes 26701 accept
		tcp dport 80 counter packets 168443 bytes 10070202 accept
		udp dport 1194 counter packets 127 bytes 7169 accept
		tcp dport 8443 counter packets 4157 bytes 234528 accept
		...
		tcp dport 52000 counter packets 254 bytes 13438 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1724 bytes 98072 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 44 | 2026-07-14 04:29:59 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-14 04:30:21 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 76K
drwxr-xr-x  2 root root   4.0K Jul 14 03:00 .
