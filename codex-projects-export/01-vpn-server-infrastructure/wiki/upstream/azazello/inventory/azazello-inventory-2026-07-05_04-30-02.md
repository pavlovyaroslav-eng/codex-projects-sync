...
Generated: 2026-07-05T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 28 days, 17:09,  0 user,  load average: 0.53, 0.34, 0.33
```
...
veth78eb299@if2  UP             fe80::44b9:1aff:fe6c:9ba9/64 
vetha31d235@if2  UP             fe80::78e9:79ff:fe1b:1a0e/64 
veth7719491@if3  UP             fe80::f42d:ebff:fea6:f68b/64 
vethc39a4b7@if2  UP             fe80::547f:c9ff:fe46:5c06/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::f550:b6b8:854b:eeea/64 
...
fe80::/64 dev veth78eb299 proto kernel metric 256 pref medium
fe80::/64 dev vetha31d235 proto kernel metric 256 pref medium
fe80::/64 dev veth7719491 proto kernel metric 256 pref medium
fe80::/64 dev vethc39a4b7 proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1089228,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0              *%wg0:34106            *:*    users:(("xray-linux-amd6",pid=1089559,fd=20))                
udp   UNCONN 0      0              *%wg0:46528            *:*    users:(("xray-linux-amd6",pid=1089559,fd=61))                
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1089559,fd=15))                
udp   UNCONN 0      0              *%wg0:45218            *:*    users:(("xray-linux-amd6",pid=1089559,fd=33))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1089233,fd=7))                    
udp   UNCONN 0      0              *%wg0:53773            *:*    users:(("xray-linux-amd6",pid=1089559,fd=32))                
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:35536            *:*    users:(("xray-linux-amd6",pid=1089559,fd=25))                
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1091930,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1088966,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1089559,fd=22))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1089559,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1089521,fd=5),("nginx",pid=1089520,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1089851,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1089498,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1088975,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1089559,fd=14))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1089521,fd=6),("nginx",pid=1089520,fd=6))
```
...
-A f2b-ufw-portscan -s 78.156.232.186/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.180.246.136/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.180.246.12/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.180.246.117/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 172.67.188.65/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 142.251.140.78/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 25112 bytes 6392023 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 25112 bytes 1766499 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 6936211 bytes 4151973902 accept
		ct state related,established counter packets 158857467 bytes 132318046586 accept
		ct state invalid counter packets 5906 bytes 384208 jump ufw-logging-deny
		ct state invalid counter packets 5906 bytes 384208 drop
		...
		ip protocol icmp icmp type echo-request counter packets 14305 bytes 827737 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1300171 bytes 291624093 jump ufw-not-local
		...
		counter packets 1300171 bytes 291624093 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 6936215 bytes 4151974118 accept
		ct state related,established counter packets 169581787 bytes 197552887173 accept
		counter packets 1351969 bytes 185763860 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 143 bytes 12936 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 76 bytes 3992 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 439 bytes 22360 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 481923 bytes 158071390 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 80552 bytes 24528017 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 25111 bytes 1614261 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 24739 bytes 2047008 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 172909 bytes 11780056 accept
		ip protocol udp ct state new counter packets 1162858 bytes 172711545 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 103519 bytes 91462659 jump f2b-ufw-portscan
		iifname "tun79" counter packets 381763 bytes 475105259 accept
		counter packets 541189535 bytes 503201838129 jump ufw-before-logging-input
		counter packets 541189535 bytes 503201838129 jump ufw-before-input
		counter packets 4842921 bytes 935536707 jump ufw-after-input
		counter packets 2358520 bytes 130538692 jump ufw-after-logging-input
		counter packets 2358520 bytes 130538692 jump ufw-reject-input
		counter packets 2358520 bytes 130538692 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 10963 bytes 2094221 accept
		counter packets 496026721 bytes 480398551935 jump ufw-before-logging-output
		counter packets 496026721 bytes 480398551935 jump ufw-before-output
		counter packets 4855668 bytes 689290938 jump ufw-after-output
		counter packets 4855668 bytes 689290938 jump ufw-after-logging-output
		counter packets 4855668 bytes 689290938 jump ufw-reject-output
		counter packets 4855668 bytes 689290938 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 53341337 bytes 132329973283 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 64361872 bytes 11955464425 accept
		...
		counter packets 260801938 bytes 298902018734 jump DOCKER-USER
		counter packets 260801938 bytes 298902018734 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 8 bytes 665 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 43 bytes 2568 accept
	...
	chain DOCKER-FORWARD {
		counter packets 260801938 bytes 298902018734 jump DOCKER-CT
		counter packets 130830384 bytes 151772969075 jump DOCKER-INTERNAL
		counter packets 130830384 bytes 151772969075 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 128255577 bytes 151271601085 accept
		iifname "docker0" counter packets 2547096 bytes 497471723 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 23552 bytes 3639801 jump DOCKER
		oifname "docker0" counter packets 3742 bytes 232068 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 128026961 bytes 146620746971 accept
		oifname "docker0" ct state related,established counter packets 1944593 bytes 508302688 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 5081 bytes 336146 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 5081 bytes 336146 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 563133 bytes 182638695 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 737597 bytes 109015182 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 562574 bytes 182608911 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 151224 bytes 9515524 accept
		udp dport 46539 counter packets 46474 bytes 53748525 accept
		udp dport 39425 counter packets 75 bytes 7699 accept
		tcp dport 80 counter packets 76605 bytes 4578969 accept
		udp dport 1194 counter packets 34 bytes 1365 accept
		tcp dport 8443 counter packets 2327 bytes 133098 accept
		...
		tcp dport 52000 counter packets 109 bytes 5980 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1156 bytes 67060 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 41 | 2026-07-05 04:29:50 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-05 04:30:16 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 24K
drwxr-xr-x  2 root root   4.0K Jul  5 03:30 .
