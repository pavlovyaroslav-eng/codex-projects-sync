...
Generated: 2026-08-18T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 16 days,  1:17,  0 user,  load average: 0.29, 0.38, 0.46
```
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("smtpd",pid=3549350,fd=6),("master",pid=3101833,fd=13))
...
-A f2b-ufw-portscan -s 46.228.223.175/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 46.174.54.253/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.23.97.147/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 84.42.92.30/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 103.167.89.1/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.24.91.166/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.95.201.233/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 69361 bytes 25201435 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 69361 bytes 4294369 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 17140384 bytes 8896370076 accept
		ct state related,established counter packets 72818462 bytes 67741077975 accept
		ct state invalid counter packets 11893 bytes 720226 jump ufw-logging-deny
		ct state invalid counter packets 11893 bytes 720226 drop
		...
		ip protocol icmp icmp type echo-request counter packets 11530 bytes 718603 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 2950264 bytes 1854787363 jump ufw-not-local
		...
		counter packets 2950264 bytes 1854787363 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 17140384 bytes 8896370076 accept
		ct state related,established counter packets 65619365 bytes 46636502938 accept
		counter packets 508750 bytes 51804830 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 360 bytes 30730 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 731 bytes 167198 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 145 bytes 6984 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 999 bytes 48704 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1197762 bytes 392865337 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 206632 bytes 60568402 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 69361 bytes 4438308 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 69360 bytes 5013042 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 122115 bytes 8173374 accept
		ip protocol udp ct state new counter packets 370292 bytes 42113002 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 11919085 bytes 9354578623 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 92932533 bytes 78493674243 jump ufw-before-logging-input
		counter packets 92932533 bytes 78493674243 jump ufw-before-input
		counter packets 1743236 bytes 490966242 jump ufw-after-input
		counter packets 336607 bytes 37278887 jump ufw-after-logging-input
		counter packets 336607 bytes 37278887 jump ufw-reject-input
		counter packets 336607 bytes 37278887 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 83268499 bytes 55584677844 jump ufw-before-logging-output
		counter packets 83268499 bytes 55584677844 jump ufw-before-output
		counter packets 508750 bytes 51804830 jump ufw-after-output
		counter packets 508750 bytes 51804830 jump ufw-after-logging-output
		counter packets 508750 bytes 51804830 jump ufw-reject-output
		counter packets 508750 bytes 51804830 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 756348264 bytes 918892069195 jump DOCKER-USER
		counter packets 756348271 bytes 918892070409 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 3783088 bytes 4654933436 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 4717340 bytes 2106215466 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 10223 bytes 639601 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 10223 bytes 639601 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1406629 bytes 453687355 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1544902 bytes 1401165091 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1405362 bytes 453622272 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 92153 bytes 6082296 accept
		udp dport 46539 counter packets 968477 bytes 1349086400 accept
		udp dport 39425 counter packets 442 bytes 44265 accept
		tcp dport 80 counter packets 91300 bytes 5407507 accept
		udp dport 1194 counter packets 155 bytes 6299 accept
		tcp dport 8443 counter packets 51412 bytes 3017832 accept
		udp dport 21194 counter packets 43 bytes 6596 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 1 bytes 438 accept
		tcp dport 52000 counter packets 404 bytes 20968 accept
		udp dport 51820 counter packets 1 bytes 436 accept
		tcp dport 25 counter packets 2635 bytes 147784 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 17433 bytes 3351121 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 173730 bytes 10774685 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 46 | 2026-08-18 04:30:02 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-17 15:33:19 |
| `/root/cert` | directory | root:root | 755 | 4096 | 2025-03-17 17:20:58 |
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-18 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 260K
drwxr-xr-x  2 root root   4.0K Aug 18 03:10 .
