...
Generated: 2026-09-17T04:30:09+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:09 up 3 days,  1:17,  0 user,  load average: 0.61, 0.59, 0.42
```
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("smtpd",pid=641482,fd=6),("master",pid=1895,fd=13))
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=3274,fd=3),("systemd",pid=1,fd=171))    
...
-A f2b-ufw-portscan -s 216.180.246.162/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.142.193.168/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 178.130.128.30/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 47.95.209.77/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.16.16.108/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.11.160.75/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 17.248.213.71/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 39.100.81.0/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.43.153.185/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 13201 bytes 2582300 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 13200 bytes 1148455 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 44307601 bytes 47644435993 accept
		ct state invalid counter packets 192 bytes 34697 jump ufw-logging-deny
		ct state invalid counter packets 192 bytes 34697 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1418 bytes 92319 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 580838 bytes 106728677 jump ufw-not-local
		...
		counter packets 580838 bytes 106728677 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 80 bytes 5920 accept
		ct state related,established counter packets 46568561 bytes 49476878915 accept
		counter packets 637480 bytes 96525115 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 33 bytes 2574 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 606 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 24 bytes 1108 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 311 bytes 14488 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 231121 bytes 75807520 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 84 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 39131 bytes 12041848 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 13200 bytes 818282 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 13200 bytes 1154131 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 269350 bytes 16160968 accept
		ip protocol udp ct state new counter packets 367107 bytes 80257668 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 10200947 bytes 26089337239 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 44890130 bytes 47751297934 jump ufw-before-logging-input
		counter packets 44890130 bytes 47751297934 jump ufw-before-input
		counter packets 359024 bytes 93163435 jump ufw-after-input
		counter packets 88398 bytes 5295207 jump ufw-after-logging-input
		counter packets 88398 bytes 5295207 jump ufw-reject-input
		counter packets 88398 bytes 5295207 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 47206121 bytes 49573409950 jump ufw-before-logging-output
		counter packets 47206121 bytes 49573409950 jump ufw-before-output
		counter packets 637480 bytes 96525115 jump ufw-after-output
		counter packets 637480 bytes 96525115 jump ufw-after-logging-output
		counter packets 637480 bytes 96525115 jump ufw-reject-output
		counter packets 637480 bytes 96525115 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 61852426 bytes 57382042306 jump DOCKER-USER
		counter packets 61852427 bytes 57382042366 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 765616 bytes 968073111 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 1041988 bytes 506822188 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 192 bytes 34697 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 192 bytes 34697 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 270626 bytes 87868228 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 310587 bytes 18880219 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 270252 bytes 87848786 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 123798 bytes 7299136 accept
		udp dport 46539 counter packets 0 bytes 0 accept
		udp dport 39425 counter packets 146 bytes 13530 accept
		tcp dport 80 counter packets 89275 bytes 5262271 accept
		udp dport 1194 counter packets 31 bytes 1856 accept
		tcp dport 8443 counter packets 7128 bytes 416761 accept
		udp dport 21194 counter packets 20 bytes 3120 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 82 bytes 4644 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 891 bytes 52140 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 23 bytes 1380 accept
		ip saddr 185.71.196.110 udp dport 24443 counter packets 389 bytes 508812 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 1.1.1.1 counter packets 0 bytes 0 reject
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-17 04:30:01 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-16 20:26:12 |
...
total 440K
drwxr-xr-x  2 root root   4.0K Sep 17 03:10 .
