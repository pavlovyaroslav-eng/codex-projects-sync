...
Generated: 2026-09-04T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 33 days,  1:17,  0 user,  load average: 0.89, 0.46, 0.33
```
...
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=2803004,fd=3),("systemd",pid=1,fd=248))   
...
-A f2b-ufw-portscan -s 18.218.206.182/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 77.88.44.55/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 104.18.32.47/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 3692 bytes 980103 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 3692 bytes 264795 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 6929735 bytes 8383209394 accept
		ct state invalid counter packets 198 bytes 11911 jump ufw-logging-deny
		ct state invalid counter packets 198 bytes 11911 drop
		...
		ip protocol icmp icmp type echo-request counter packets 361 bytes 21845 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 194645 bytes 85843404 jump ufw-not-local
		...
		counter packets 194645 bytes 85843404 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 6787526 bytes 8152547161 accept
		counter packets 158504 bytes 16019495 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		tcp dport 139 counter packets 4 bytes 184 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 55 bytes 2696 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 64028 bytes 21001184 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 10610 bytes 3173948 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 3690 bytes 224339 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 3692 bytes 272869 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 71260 bytes 4275600 accept
		ip protocol udp ct state new counter packets 86927 bytes 11718522 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 1507 bytes 429787 jump f2b-sshd
		ip protocol tcp counter packets 3392884 bytes 6452973762 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 315623846 bytes 330235431654 jump ufw-before-logging-input
		counter packets 315623846 bytes 330235431654 jump ufw-before-input
		counter packets 3918907 bytes 1012835069 jump ufw-after-input
		counter packets 1020920 bytes 76422577 jump ufw-after-logging-input
		counter packets 1020920 bytes 76422577 jump ufw-reject-input
		counter packets 1020920 bytes 76422577 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 262368553 bytes 206164345969 jump ufw-before-logging-output
		counter packets 262368553 bytes 206164345969 jump ufw-before-output
		counter packets 1107703 bytes 109142451 jump ufw-after-output
		counter packets 1107703 bytes 109142451 jump ufw-after-logging-output
		counter packets 1107703 bytes 109142451 jump ufw-reject-output
		counter packets 1107703 bytes 109142451 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1571151800 bytes 1916898612340 jump DOCKER-USER
		counter packets 1571151807 bytes 1916898613554 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 7363363 bytes 9083693030 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 9256579 bytes 4111153818 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 26360 bytes 4638929 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 361004 bytes 22276610 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1571151807 bytes 1916898613554 jump DOCKER-CT
		counter packets 793038006 bytes 970471374597 jump DOCKER-INTERNAL
		counter packets 793038006 bytes 970471374597 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 606678005 bytes 860456788397 accept
		iifname "docker0" counter packets 169352693 bytes 96792831770 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 26360 bytes 4638929 jump DOCKER
		oifname "docker0" counter packets 361004 bytes 22276610 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 623486745 bytes 834064894028 accept
		oifname "docker0" ct state related,established counter packets 154627056 bytes 112362344929 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 5.83.129.207 counter packets 6 bytes 240 reject
		ip saddr 185.2.80.253 counter packets 17 bytes 884 reject
		ip saddr 85.217.140.19 counter packets 7 bytes 364 reject
		ip saddr 89.144.35.106 counter packets 87 bytes 3480 reject
		ip saddr 85.217.140.23 counter packets 8 bytes 416 reject
		ip saddr 85.217.140.50 counter packets 19 bytes 988 reject
		ip saddr 85.217.149.69 counter packets 95 bytes 4940 reject
		ip saddr 85.217.149.49 counter packets 48 bytes 2496 reject
		ip saddr 85.217.140.53 counter packets 80 bytes 4160 reject
		ip saddr 85.217.140.16 counter packets 97 bytes 5044 reject
		ip saddr 85.217.140.49 counter packets 99 bytes 5148 reject
		ip saddr 85.217.140.37 counter packets 142 bytes 7384 reject
		ip saddr 85.217.149.65 counter packets 258 bytes 13416 reject
		ip saddr 85.217.140.5 counter packets 25 bytes 1300 reject
		ip saddr 85.217.149.71 counter packets 87 bytes 4524 reject
		ip saddr 85.217.149.70 counter packets 191 bytes 9932 reject
		ip saddr 85.217.140.1 counter packets 100 bytes 5200 reject
		ip saddr 85.217.149.74 counter packets 200 bytes 10400 reject
		ip saddr 85.217.149.72 counter packets 317 bytes 16484 reject
		ip saddr 18.218.206.182 counter packets 2 bytes 258 reject
		ip saddr 85.217.140.18 counter packets 146 bytes 7592 reject
		ip saddr 85.217.140.11 counter packets 258 bytes 13416 reject
		ip saddr 85.217.140.48 counter packets 217 bytes 11284 reject
		ip saddr 85.217.140.7 counter packets 106 bytes 5512 reject
		ip saddr 85.217.149.52 counter packets 228 bytes 11856 reject
		ip saddr 85.217.149.59 counter packets 120 bytes 6240 reject
		ip saddr 85.217.140.54 counter packets 117 bytes 6084 reject
		ip saddr 178.130.128.21 counter packets 1 bytes 52 reject
		ip saddr 85.217.149.68 counter packets 448 bytes 23296 reject
		ip saddr 85.217.140.47 counter packets 642 bytes 33384 reject
		ip saddr 85.217.149.55 counter packets 225 bytes 11700 reject
		ip saddr 87.240.139.193 counter packets 0 bytes 0 reject
		ip saddr 85.217.149.57 counter packets 264 bytes 13728 reject
		ip saddr 85.217.140.52 counter packets 424 bytes 22048 reject
		ip saddr 85.217.149.43 counter packets 144 bytes 7488 reject
		ip saddr 10.8.1.3 counter packets 274 bytes 10960 reject
		ip saddr 85.217.140.20 counter packets 313 bytes 16276 reject
		ip saddr 85.217.149.47 counter packets 89 bytes 4628 reject
		ip saddr 85.217.140.31 counter packets 114 bytes 5928 reject
		ip saddr 85.217.140.43 counter packets 979 bytes 50908 reject
		ip saddr 85.217.149.60 counter packets 372 bytes 19344 reject
		ip saddr 31.14.32.6 counter packets 536 bytes 27872 reject
		ip saddr 85.217.140.6 counter packets 187 bytes 9724 reject
		ip saddr 85.217.149.63 counter packets 694 bytes 36088 reject
		ip saddr 85.217.140.9 counter packets 607 bytes 31564 reject
		ip saddr 85.217.140.41 counter packets 637 bytes 33124 reject
		ip saddr 85.217.149.64 counter packets 774 bytes 40248 reject
		ip saddr 85.217.149.62 counter packets 366 bytes 19040 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 20 hours   
mtproto-telegram             telegrammessenger/proxy:latest   Up 4 weeks    0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-04 04:29:53 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-03 12:56:51 |
...
total 368K
drwxr-xr-x  2 root root   4.0K Sep  4 03:10 .
drwxr-xr-x 17 root syslog 4.0K Sep  3 15:00 ..
