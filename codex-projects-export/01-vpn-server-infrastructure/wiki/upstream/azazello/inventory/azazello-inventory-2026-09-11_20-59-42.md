...
Generated: 2026-09-11T20:59:42+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 20:59:43 up 40 days, 17:46,  1 user,  load average: 1.37, 1.12, 0.99
```
...
udp   UNCONN 0      0                  *:58923            *:*    users:(("rw-core",pid=2921938,fd=39))                        
udp   UNCONN 0      0                  *:59094            *:*    users:(("rw-core",pid=2921938,fd=26))                        
udp   UNCONN 0      0                  *:59127            *:*    users:(("rw-core",pid=2921938,fd=19))                        
udp   UNCONN 0      0                  *:24443            *:*    users:(("rw-core",pid=2921938,fd=7))                         
udp   UNCONN 0      0                  *:34808            *:*    users:(("rw-core",pid=2921938,fd=53))                        
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1113,fd=7))                          
udp   UNCONN 0      0                  *:51466            *:*    users:(("rw-core",pid=2921938,fd=42))                        
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:43668            *:*    users:(("rw-core",pid=2921938,fd=56))                        
udp   UNCONN 0      0                  *:33432            *:*    users:(("rw-core",pid=2921938,fd=15))                        
udp   UNCONN 0      0                  *:55977            *:*    users:(("rw-core",pid=2921938,fd=21))                        
udp   UNCONN 0      0                  *:35588            *:*    users:(("rw-core",pid=2921938,fd=9))                         
udp   UNCONN 0      0                  *:41938            *:*    users:(("rw-core",pid=2921938,fd=23))                        
udp   UNCONN 0      0                  *:60509            *:*    users:(("rw-core",pid=2921938,fd=38))                        
udp   UNCONN 5056   0                  *:58741            *:*    users:(("rw-core",pid=2921938,fd=33))                        
udp   UNCONN 0      0                  *:40383            *:*    users:(("rw-core",pid=2921938,fd=27))                        
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 36901 bytes 8615713 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 36901 bytes 2876708 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 111280761 bytes 108296268443 accept
		...
		counter packets 1855525 bytes 569839457 jump ufw-not-local
		...
		counter packets 1855525 bytes 569839457 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 122614817 bytes 111584626467 accept
		counter packets 2314679 bytes 271300533 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 140 bytes 11566 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 606 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 84 bytes 3876 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 667 bytes 31688 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 642715 bytes 210809900 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 107021 bytes 32482025 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 36899 bytes 2253223 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 36901 bytes 2891570 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1031729 bytes 61906284 accept
		ip protocol udp ct state new counter packets 1279933 bytes 209078443 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 4992 bytes 1076407 jump f2b-sshd
		ip protocol tcp counter packets 26158419 bytes 57333494606 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 421640587 bytes 430632919785 jump ufw-before-logging-input
		counter packets 421640587 bytes 430632919785 jump ufw-before-input
		counter packets 4736919 bytes 1240767900 jump ufw-after-input
		counter packets 1163014 bytes 85195179 jump ufw-after-logging-input
		counter packets 1163014 bytes 85195179 jump ufw-reject-input
		counter packets 1163014 bytes 85195179 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 380352019 bytes 309851706313 jump ufw-before-logging-output
		counter packets 380352019 bytes 309851706313 jump ufw-before-output
		counter packets 3263878 bytes 364423489 jump ufw-after-output
		counter packets 3263878 bytes 364423489 jump ufw-after-logging-output
		counter packets 3263878 bytes 364423489 jump ufw-reject-output
		counter packets 3263878 bytes 364423489 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1709360799 bytes 2044997404970 jump DOCKER-USER
		counter packets 1709360806 bytes 2044997406184 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8707801 bytes 10826111405 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11053207 bytes 4926724885 accept
	...
	chain DOCKER {
		...
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 480127 bytes 29559622 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1709360806 bytes 2044997406184 jump DOCKER-CT
		counter packets 863545742 bytes 1035679285363 jump DOCKER-INTERNAL
		counter packets 863545742 bytes 1035679285363 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 625865902 bytes 881539758658 accept
		iifname "docker0" counter packets 217398563 bytes 138348694556 accept
	}
	...
	chain DOCKER-BRIDGE {
		...
		oifname "docker0" counter packets 480127 bytes 29559622 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 643277883 bytes 854891797971 accept
		oifname "docker0" ct state related,established counter packets 202537181 bytes 154426322850 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 172.217.118.4 counter packets 11 bytes 3053 reject
		ip saddr 85.217.140.51 counter packets 24 bytes 1248 reject
		ip saddr 85.217.140.10 counter packets 56 bytes 2912 reject
		ip saddr 85.217.140.20 counter packets 1 bytes 52 reject
		ip saddr 85.217.140.44 counter packets 5 bytes 260 reject
		ip saddr 85.217.140.29 counter packets 62 bytes 3224 reject
		ip saddr 31.14.32.7 counter packets 56 bytes 2912 reject
		ip saddr 85.217.140.12 counter packets 85 bytes 4420 reject
		ip saddr 85.217.140.4 counter packets 114 bytes 5928 reject
		ip saddr 85.217.140.26 counter packets 151 bytes 7852 reject
		ip saddr 39.100.72.232 counter packets 131 bytes 5540 reject
		ip saddr 85.217.140.45 counter packets 272 bytes 14144 reject
		ip saddr 85.217.140.8 counter packets 214 bytes 11128 reject
		ip saddr 85.217.140.40 counter packets 175 bytes 9100 reject
		ip saddr 85.217.140.18 counter packets 97 bytes 5044 reject
		ip saddr 185.2.80.252 counter packets 140 bytes 7280 reject
		ip saddr 112.124.22.214 counter packets 87 bytes 3480 reject
		ip saddr 151.80.23.149 counter packets 30 bytes 1748 reject
		ip saddr 85.217.140.53 counter packets 328 bytes 17056 reject
		ip saddr 85.217.140.36 counter packets 356 bytes 18512 reject
		ip saddr 85.217.140.50 counter packets 367 bytes 19084 reject
		ip saddr 47.95.209.9 counter packets 103 bytes 4120 reject
		ip saddr 172.217.113.4 counter packets 1419 bytes 87574 reject
		ip saddr 85.217.140.22 counter packets 150 bytes 7800 reject
		ip saddr 85.217.140.15 counter packets 228 bytes 11856 reject
		ip saddr 85.217.140.13 counter packets 488 bytes 25376 reject
		ip saddr 85.217.140.2 counter packets 119 bytes 6188 reject
		ip saddr 85.217.140.31 counter packets 112 bytes 5824 reject
		ip saddr 85.217.149.69 counter packets 289 bytes 15028 reject
		ip saddr 85.217.140.35 counter packets 167 bytes 8684 reject
		ip saddr 172.217.116.4 counter packets 2729 bytes 164926 reject
		ip saddr 85.217.140.16 counter packets 457 bytes 23764 reject
		ip saddr 172.217.115.4 counter packets 2809 bytes 197526 reject
		ip saddr 85.217.140.42 counter packets 387 bytes 20124 reject
		ip saddr 85.217.149.71 counter packets 396 bytes 20592 reject
		ip saddr 85.217.140.46 counter packets 517 bytes 26884 reject
		ip saddr 85.217.140.28 counter packets 148 bytes 7696 reject
		ip saddr 85.217.149.74 counter packets 716 bytes 37232 reject
		ip saddr 185.2.80.253 counter packets 620 bytes 32240 reject
		ip saddr 85.217.149.72 counter packets 559 bytes 29068 reject
		ip saddr 85.217.140.37 counter packets 619 bytes 32188 reject
		ip saddr 31.14.32.6 counter packets 497 bytes 25844 reject
		ip saddr 31.14.32.8 counter packets 802 bytes 41704 reject
		ip saddr 172.217.114.4 counter packets 7194 bytes 438711 reject
		ip saddr 85.217.140.49 counter packets 618 bytes 32136 reject
		ip saddr 87.240.137.130 counter packets 0 bytes 0 reject
		ip saddr 95.163.61.56 counter packets 10 bytes 3678 reject
		ip saddr 172.217.119.4 counter packets 7654 bytes 461668 reject
```
