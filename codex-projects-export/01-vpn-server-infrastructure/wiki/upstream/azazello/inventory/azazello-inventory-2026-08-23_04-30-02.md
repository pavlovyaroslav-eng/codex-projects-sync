...
Generated: 2026-08-23T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 21 days,  1:17,  0 user,  load average: 0.41, 0.29, 0.28
```
...
-A f2b-ufw-portscan -s 20.106.231.32/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 4.155.63.150/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.180.246.126/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 216.58.205.138/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 77.168.175.73/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 81.24.93.18/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.110.236.123/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 93.183.106.203/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 90961 bytes 34107766 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 90961 bytes 5610953 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 22532090 bytes 11760422855 accept
		ct state related,established counter packets 216114979 bytes 248069800840 accept
		ct state invalid counter packets 15855 bytes 970839 jump ufw-logging-deny
		ct state invalid counter packets 15855 bytes 970839 drop
		...
		ip protocol icmp icmp type echo-request counter packets 15099 bytes 940319 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 4107735 bytes 2661028217 jump ufw-not-local
		...
		counter packets 4107735 bytes 2661028217 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 22532090 bytes 11760422855 accept
		ct state related,established counter packets 175712830 bytes 148738214832 accept
		counter packets 654731 bytes 66529422 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 419 bytes 35548 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 731 bytes 167198 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 196 bytes 9340 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1340 bytes 65836 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1572826 bytes 515886329 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 268825 bytes 79272410 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 90961 bytes 5732941 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 90960 bytes 6517393 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 158601 bytes 10362799 accept
		ip protocol udp ct state new counter packets 474378 bytes 54190374 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 76307311 bytes 92880327727 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 242785758 bytes 262493163070 jump ufw-before-logging-input
		counter packets 242785758 bytes 262493163070 jump ufw-before-input
		counter packets 2356119 bytes 642916928 jump ufw-after-input
		counter packets 511782 bytes 47480267 jump ufw-after-logging-input
		counter packets 511782 bytes 47480267 jump ufw-reject-input
		counter packets 511782 bytes 47480267 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 198899651 bytes 160565167109 jump ufw-before-logging-output
		counter packets 198899651 bytes 160565167109 jump ufw-before-output
		counter packets 654731 bytes 66529422 jump ufw-after-output
		counter packets 654731 bytes 66529422 jump ufw-after-logging-output
		counter packets 654731 bytes 66529422 jump ufw-reject-output
		counter packets 654731 bytes 66529422 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1032567278 bytes 1280285081966 jump DOCKER-USER
		counter packets 1032567285 bytes 1280285083180 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 4901535 bytes 6006700711 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 6127040 bytes 2735162920 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 13239 bytes 832940 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 13239 bytes 832940 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1844337 bytes 595436661 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2265098 bytes 2065679325 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1842637 bytes 595348892 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 132961 bytes 8382740 accept
		udp dport 46539 counter packets 1442545 bytes 1999435268 accept
		udp dport 39425 counter packets 611 bytes 61125 accept
		tcp dport 80 counter packets 105187 bytes 6116538 accept
		udp dport 1194 counter packets 204 bytes 8511 accept
		tcp dport 8443 counter packets 66168 bytes 3885252 accept
		udp dport 21194 counter packets 44 bytes 6736 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 1 bytes 438 accept
		tcp dport 52000 counter packets 554 bytes 28781 accept
		udp dport 51820 counter packets 1 bytes 436 accept
		tcp dport 25 counter packets 3335 bytes 185164 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 19357 bytes 3558202 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 229587 bytes 14208296 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 45 | 2026-08-22 14:01:08 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-08-23 01:17:26 |
| `/root/cert` | directory | root:root | 755 | 4096 | 2025-03-17 17:20:58 |
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-23 04:30:10 |
| `/etc/3x-ui` | missing | - | - | - | - |
