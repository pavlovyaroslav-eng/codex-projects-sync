...
Generated: 2026-08-04T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 2 days,  1:17,  0 user,  load average: 0.82, 0.59, 0.61
```
...
-A f2b-ufw-portscan -s 104.21.89.9/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 208.109.242.255/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 195.18.27.249/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.39/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 203.107.63.198/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 150.171.110.53/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 170.168.22.255/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 52.159.243.195/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.28/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 4.155.111.102/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 9.234.149.178/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 172.203.207.195/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 188.114.97.2/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.45/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 20.80.109.86/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 8881 bytes 3658860 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 8881 bytes 549363 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 2170824 bytes 1086115863 accept
		ct state related,established counter packets 4309014 bytes 2871284172 accept
		ct state invalid counter packets 2203 bytes 122826 jump ufw-logging-deny
		ct state invalid counter packets 2203 bytes 122826 drop
		...
		ip protocol icmp icmp type echo-request counter packets 1387 bytes 84515 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 389349 bytes 240849999 jump ufw-not-local
		...
		counter packets 389349 bytes 240849999 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 2170824 bytes 1086115863 accept
		ct state related,established counter packets 4307744 bytes 3166230266 accept
		counter packets 65340 bytes 6756799 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 155 bytes 13008 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 30 bytes 1328 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 121 bytes 5680 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 145519 bytes 47730232 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 24710 bytes 7625599 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 8880 bytes 552554 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 8880 bytes 612321 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 14315 bytes 858900 accept
		ip protocol udp ct state new counter packets 49100 bytes 5746166 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 3152334 bytes 1750394842 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 6872777 bytes 4198457375 jump ufw-before-logging-input
		counter packets 6872777 bytes 4198457375 jump ufw-before-input
		counter packets 212671 bytes 57766814 jump ufw-after-input
		counter packets 42136 bytes 2390967 jump ufw-after-logging-input
		counter packets 42136 bytes 2390967 jump ufw-reject-input
		counter packets 42136 bytes 2390967 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 6543908 bytes 4259102928 jump ufw-before-logging-output
		counter packets 6543908 bytes 4259102928 jump ufw-before-output
		counter packets 65340 bytes 6756799 jump ufw-after-output
		counter packets 65340 bytes 6756799 jump ufw-after-logging-output
		counter packets 65340 bytes 6756799 jump ufw-reject-output
		counter packets 65340 bytes 6756799 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 92729784 bytes 103914007780 jump DOCKER-USER
		counter packets 92729791 bytes 103914008994 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 543592 bytes 699439589 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 707783 bytes 300699900 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 1787 bytes 105468 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 1787 bytes 105468 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 170535 bytes 55375847 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 218997 bytes 185483656 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 170352 bytes 55366343 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 20102 bytes 1188183 accept
		udp dport 46539 counter packets 132534 bytes 180481595 accept
		udp dport 39425 counter packets 85 bytes 8006 accept
		tcp dport 80 counter packets 7043 bytes 411179 accept
		udp dport 1194 counter packets 39 bytes 1362 accept
		tcp dport 8443 counter packets 16046 bytes 943764 accept
		udp dport 21194 counter packets 21 bytes 3276 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 35 bytes 1992 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 768 bytes 43528 accept
	...
	chain f2b-ufw-portscan {
		ip saddr 149.154.166.110 counter packets 23 bytes 1196 reject
		ip saddr 46.228.223.46 counter packets 20 bytes 1040 reject
		ip saddr 104.21.89.9 counter packets 11 bytes 584 reject
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 45 | 2026-08-04 04:30:09 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-08-04 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 188K
drwxr-xr-x  2 root root   4.0K Aug  4 03:10 .
