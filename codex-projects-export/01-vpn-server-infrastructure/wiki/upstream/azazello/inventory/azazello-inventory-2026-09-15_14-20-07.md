...
Generated: 2026-09-15T14:20:07+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 14:20:08 up 1 day, 11:07,  1 user,  load average: 0.27, 0.62, 0.77
```
...
udp   UNCONN 0      0          127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1185,fd=3))                      
udp   UNCONN 0      0                  *:53022            *:*    users:(("rw-core",pid=3110,fd=31))                     
udp   UNCONN 0      0                  *:24443            *:*    users:(("rw-core",pid=3110,fd=7))                      
udp   UNCONN 0      0                  *:40970            *:*    users:(("rw-core",pid=3110,fd=16))                     
udp   UNCONN 0      0                  *:43181            *:*    users:(("rw-core",pid=3110,fd=14))                     
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1090,fd=7))                    
udp   UNCONN 0      0                  *:35183            *:*    users:(("rw-core",pid=3110,fd=15))                     
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=2667,fd=7))                 
udp   UNCONN 0      0                  *:51722            *:*    users:(("rw-core",pid=3110,fd=30))                     
udp   UNCONN 0      0                  *:57898            *:*    users:(("rw-core",pid=3110,fd=13))                     
udp   UNCONN 0      0               [::]:51820         [::]:*                                                           
udp   UNCONN 0      0                  *:49889            *:*    users:(("rw-core",pid=3110,fd=34))                     
udp   UNCONN 0      0                  *:38221            *:*    users:(("rw-core",pid=3110,fd=25))                     
udp   UNCONN 0      0                  *:42384            *:*    users:(("rw-core",pid=3110,fd=24))                     
udp   UNCONN 0      0                  *:44636            *:*    users:(("rw-core",pid=3110,fd=36))                     
...
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1895,fd=13))                      
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1185,fd=4))                      
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1381,fd=5),("nginx",pid=1379,fd=5))
tcp   LISTEN 0      32           0.0.0.0:8443       0.0.0.0:*    users:(("openvpn",pid=1085,fd=5))                      
tcp   LISTEN 0      4096         0.0.0.0:52000      0.0.0.0:*    users:(("sshd",pid=3274,fd=3),("systemd",pid=1,fd=87)) 
...
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1381,fd=6),("nginx",pid=1379,fd=6))
...
-A f2b-ufw-portscan -s 54.39.23.241/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.23/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.164.195/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.26.10.134/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 193.46.255.141/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 15.235.149.124/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 178.155.22.195/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 203.23.179.209/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.180.246.96/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 6331 bytes 1313980 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 6331 bytes 507832 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 80 bytes 5920 accept
		ct state related,established counter packets 18617522 bytes 21168179987 accept
		ct state invalid counter packets 108 bytes 27397 jump ufw-logging-deny
		ct state invalid counter packets 108 bytes 27397 drop
		...
		ip protocol icmp icmp type echo-request counter packets 468 bytes 34161 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 271243 bytes 50957682 jump ufw-not-local
		...
		counter packets 271243 bytes 50957682 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 80 bytes 5920 accept
		ct state related,established counter packets 20247886 bytes 22000305794 accept
		counter packets 332438 bytes 45676980 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 18 bytes 1404 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 1 bytes 202 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 10 bytes 472 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 184 bytes 8628 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 110840 bytes 36355464 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 18858 bytes 5791732 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 6330 bytes 409400 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 6330 bytes 515585 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 134956 bytes 8097328 accept
		ip protocol udp ct state new counter packets 196970 bytes 37515625 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 4939759 bytes 12912899901 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 18889421 bytes 21219205147 jump ufw-before-logging-input
		counter packets 18889421 bytes 21219205147 jump ufw-before-input
		counter packets 155582 bytes 43876430 jump ufw-after-input
		counter packets 25670 bytes 1718500 jump ufw-after-logging-input
		counter packets 25670 bytes 1718500 jump ufw-reject-input
		counter packets 25670 bytes 1718500 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 20580404 bytes 22045988694 jump ufw-before-logging-output
		counter packets 20580404 bytes 22045988694 jump ufw-before-output
		counter packets 332438 bytes 45676980 jump ufw-after-output
		counter packets 332438 bytes 45676980 jump ufw-after-logging-output
		counter packets 332438 bytes 45676980 jump ufw-reject-output
		counter packets 332438 bytes 45676980 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 24415204 bytes 20805450503 jump DOCKER-USER
		counter packets 24415205 bytes 20805450563 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 400393 bytes 489029213 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 542243 bytes 282051927 accept
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 108 bytes 27397 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 108 bytes 27397 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 129912 bytes 42157930 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 141543 bytes 8810524 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 129700 bytes 42147158 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 58712 bytes 3464284 accept
		udp dport 46539 counter packets 0 bytes 0 accept
		udp dport 39425 counter packets 116 bytes 10643 accept
		tcp dport 80 counter packets 54418 bytes 3208177 accept
		udp dport 1194 counter packets 12 bytes 484 accept
		tcp dport 8443 counter packets 1762 bytes 103472 accept
		udp dport 21194 counter packets 20 bytes 3120 accept
		iifname "tun79" counter packets 0 bytes 0 accept
		udp dport 33328 counter packets 0 bytes 0 accept
		tcp dport 52000 counter packets 46 bytes 2588 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 319 bytes 18532 accept
		...
		ip saddr 93.183.106.203 tcp dport 2222 counter packets 20 bytes 1200 accept
		ip saddr 185.71.196.110 udp dport 24443 counter packets 204 bytes 266832 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.217.140.30 counter packets 1 bytes 52 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 35 hours   
mtproto-telegram             telegrammessenger/proxy:latest   Up 35 hours   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 35 hours   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 35 hours   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 49 | 2026-09-15 14:20:13 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-15 09:21:22 |
...
total 432K
drwxr-xr-x  2 root root   4.0K Sep 15 03:10 .
drwxrwxr-x 17 root syslog 4.0K Sep 14 03:13 ..
