...
Generated: 2026-09-11T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 40 days,  1:17,  0 user,  load average: 0.31, 0.28, 0.27
```
...
udp   UNCONN 0      0                  *:53298            *:*    users:(("rw-core",pid=2921938,fd=11))                        
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1113,fd=7))                          
udp   UNCONN 0      0                  *:57576            *:*    users:(("rw-core",pid=2921938,fd=13))                        
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0                  *:37475            *:*    users:(("rw-core",pid=2921938,fd=12))                        
...
-A f2b-ufw-portscan -s 151.244.242.247/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 121.199.163.183/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 193.32.162.214/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 82.25.45.37/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 199.167.67.207/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 51.222.56.192/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 15.235.112.125/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 33932 bytes 8013735 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 33932 bytes 2644149 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 105135135 bytes 102268160107 accept
		ct state invalid counter packets 682 bytes 151704 jump ufw-logging-deny
		ct state invalid counter packets 682 bytes 151704 drop
		...
		ip protocol icmp icmp type echo-request counter packets 4019 bytes 234186 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1727737 bytes 544728745 jump ufw-not-local
		...
		counter packets 1727737 bytes 544728745 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 115899063 bytes 105274163826 accept
		counter packets 2176095 bytes 253057138 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 128 bytes 10630 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 2 bytes 404 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 74 bytes 3428 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 576 bytes 27464 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 591041 bytes 193860940 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 98388 bytes 29824420 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 33931 bytes 2070241 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 33932 bytes 2658103 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 975119 bytes 58509684 accept
		ip protocol udp ct state new counter packets 1198210 bytes 194262372 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 3864 bytes 843300 jump f2b-sshd
		ip protocol tcp counter packets 24477162 bytes 54165362966 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 415366480 bytes 424579619842 jump ufw-before-logging-input
		counter packets 415366480 bytes 424579619842 jump ufw-before-input
		counter packets 4664177 bytes 1220386323 jump ufw-after-input
		counter packets 1150693 bytes 84425977 jump ufw-after-logging-input
		counter packets 1150693 bytes 84425977 jump ufw-reject-input
		counter packets 1150693 bytes 84425977 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 373497681 bytes 303523000277 jump ufw-before-logging-output
		counter packets 373497681 bytes 303523000277 jump ufw-before-output
		counter packets 3125294 bytes 346180094 jump ufw-after-output
		counter packets 3125294 bytes 346180094 jump ufw-after-logging-output
		counter packets 3125294 bytes 346180094 jump ufw-reject-output
		counter packets 3125294 bytes 346180094 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1699024307 bytes 2035828757550 jump DOCKER-USER
		counter packets 1699024314 bytes 2035828758764 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8536737 bytes 10632254562 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 10823580 bytes 4798617507 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 4857 bytes 610695 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 464377 bytes 28576530 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1699024314 bytes 2035828758764 jump DOCKER-CT
		counter packets 857976464 bytes 1030914335584 jump DOCKER-INTERNAL
		counter packets 857976464 bytes 1030914335584 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 625124702 bytes 880721664878 accept
		iifname "docker0" counter packets 212992538 bytes 134727619969 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 34528 bytes 5610095 jump DOCKER
		oifname "docker0" counter packets 464377 bytes 28576530 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 642525007 bytes 854095099162 accept
		oifname "docker0" ct state related,established counter packets 198522843 bytes 150819324018 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.217.140.7 counter packets 27 bytes 1404 reject
		ip saddr 85.217.149.70 counter packets 122 bytes 6344 reject
		ip saddr 92.114.107.48 counter packets 84 bytes 4952 reject
		ip saddr 79.124.62.242 counter packets 480 bytes 19200 reject
		ip saddr 79.124.62.246 counter packets 492 bytes 19680 reject
		ip saddr 85.217.140.24 counter packets 57 bytes 2964 reject
		ip saddr 85.217.140.11 counter packets 246 bytes 12792 reject
		ip saddr 85.217.140.48 counter packets 263 bytes 13676 reject
		ip saddr 85.217.149.73 counter packets 247 bytes 12844 reject
		ip saddr 85.217.140.27 counter packets 101 bytes 5252 reject
		ip saddr 85.217.149.37 counter packets 124 bytes 6448 reject
		ip saddr 85.217.140.23 counter packets 136 bytes 7072 reject
		ip saddr 85.217.140.41 counter packets 342 bytes 17784 reject
		ip saddr 85.217.140.3 counter packets 198 bytes 10296 reject
		ip saddr 85.217.140.19 counter packets 188 bytes 9776 reject
		ip saddr 85.217.149.68 counter packets 278 bytes 14456 reject
		ip saddr 85.217.140.39 counter packets 451 bytes 23452 reject
		ip saddr 85.217.140.33 counter packets 300 bytes 15600 reject
		ip saddr 85.217.140.43 counter packets 453 bytes 23556 reject
		ip saddr 85.217.140.9 counter packets 483 bytes 25116 reject
		ip saddr 47.99.45.56 counter packets 129 bytes 5160 reject
		ip saddr 85.217.140.52 counter packets 525 bytes 27300 reject
		ip saddr 85.217.140.1 counter packets 290 bytes 15080 reject
		ip saddr 85.217.140.47 counter packets 343 bytes 17836 reject
		ip saddr 85.217.140.6 counter packets 261 bytes 13572 reject
		ip saddr 85.217.140.51 counter packets 680 bytes 35360 reject
		ip saddr 85.217.140.5 counter packets 281 bytes 14612 reject
		ip saddr 151.244.242.247 counter packets 96 bytes 4224 reject
		ip saddr 85.217.140.12 counter packets 683 bytes 35516 reject
		ip saddr 85.217.140.44 counter packets 686 bytes 35672 reject
		ip saddr 85.217.140.4 counter packets 527 bytes 27404 reject
		ip saddr 85.217.149.54 counter packets 286 bytes 14872 reject
		ip saddr 85.217.140.20 counter packets 395 bytes 20540 reject
		ip saddr 85.217.140.45 counter packets 514 bytes 26728 reject
		ip saddr 172.217.118.4 counter packets 27790 bytes 1668415 reject
		ip saddr 85.217.140.8 counter packets 661 bytes 34372 reject
		ip saddr 85.217.140.10 counter packets 638 bytes 33176 reject
		ip saddr 85.217.140.40 counter packets 681 bytes 35412 reject
		ip saddr 121.199.163.183 counter packets 83 bytes 3320 reject
		ip saddr 185.2.80.252 counter packets 449 bytes 23348 reject
		ip saddr 85.217.140.53 counter packets 908 bytes 47216 reject
		ip saddr 85.217.140.36 counter packets 674 bytes 35048 reject
		ip saddr 31.14.32.7 counter packets 451 bytes 23452 reject
		ip saddr 85.217.140.30 counter packets 280 bytes 14560 reject
		ip saddr 85.217.140.26 counter packets 288 bytes 14976 reject
		ip saddr 85.217.140.29 counter packets 356 bytes 18512 reject
		ip saddr 85.217.140.50 counter packets 818 bytes 42536 reject
		ip saddr 85.217.140.13 counter packets 764 bytes 39728 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 7 days    
mtproto-telegram             telegrammessenger/proxy:latest   Up 5 weeks   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 3 days    0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-11 04:29:58 |
