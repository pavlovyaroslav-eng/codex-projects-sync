...
Generated: 2026-07-25T04:30:03+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 48 days, 14:09,  0 user,  load average: 0.34, 0.30, 0.27
```
...
-A f2b-ufw-portscan -s 37.27.131.99/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.5.11/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 151.101.65.91/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.56.79.53/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 85.217.140.13/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.112/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 93.186.227.141/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.16.16.157/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.22.50.224/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 151.101.193.64/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 84.42.94.30/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 185.151.204.50/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 86.51.26.52/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 151.236.110.187/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.19.126.138/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 31.13.84.51/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 88.221.92.176/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 52.0.252.11/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 17.253.122.197/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.190.208.80/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 157.240.205.61/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 47.95.209.135/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.41.165.206/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 112.124.56.100/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 121.199.162.33/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 118.107.42.196/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 29507 bytes 11992544 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 29507 bytes 1863199 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 27924860 bytes 14908069584 accept
		ct state related,established counter packets 352723813 bytes 243425046725 accept
		ct state invalid counter packets 27574 bytes 2194078 jump ufw-logging-deny
		ct state invalid counter packets 27574 bytes 2194078 drop
		...
		ip protocol icmp icmp type echo-request counter packets 48458 bytes 2794239 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 4922845 bytes 1757452401 jump ufw-not-local
		...
		counter packets 4922845 bytes 1757452401 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 27925208 bytes 14908100818 accept
		ct state related,established counter packets 433758712 bytes 499369477132 accept
		counter packets 2352144 bytes 287928071 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 352 bytes 31874 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 2383 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 296 bytes 15364 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1846 bytes 93208 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1987984 bytes 652060796 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 2384 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 334698 bytes 101171791 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 29507 bytes 8214757 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 29507 bytes 2066189 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 402371 bytes 25654608 accept
		ip protocol udp ct state new counter packets 1902670 bytes 257724089 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 16335607 bytes 14012173476 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1090750 bytes 1359553160 accept
		counter packets 759723025 bytes 626534538630 jump ufw-before-logging-input
		counter packets 759723025 bytes 626534538630 jump ufw-before-input
		counter packets 7607859 bytes 1619709396 jump ufw-after-input
		counter packets 3361409 bytes 243972276 jump ufw-after-logging-input
		counter packets 3361409 bytes 243972276 jump ufw-reject-input
		counter packets 3361409 bytes 243972276 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31413 bytes 6024246 accept
		counter packets 782192814 bytes 793073432805 jump ufw-before-logging-output
		counter packets 782192814 bytes 793073432805 jump ufw-before-output
		counter packets 5855843 bytes 791455149 jump ufw-after-output
		counter packets 5855843 bytes 791455149 jump ufw-after-logging-output
		counter packets 5855843 bytes 791455149 jump ufw-reject-output
		counter packets 5855843 bytes 791455149 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 157193895 bytes 369451469546 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 188547202 bytes 41447218789 accept
		...
		counter packets 759555876 bytes 822316012435 jump DOCKER-USER
		counter packets 759555876 bytes 822316012435 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 22234 bytes 4391981 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 46739 bytes 2830780 accept
	...
	chain DOCKER-FORWARD {
		counter packets 759555876 bytes 822316012435 jump DOCKER-CT
		counter packets 381230710 bytes 407960793933 jump DOCKER-INTERNAL
		counter packets 381230710 bytes 407960793933 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 283791180 bytes 369685532728 accept
		iifname "docker0" counter packets 97235360 bytes 38255867177 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 60320 bytes 10641874 jump DOCKER
		oifname "docker0" counter packets 143297 bytes 8720492 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 293327248 bytes 359009396452 accept
		oifname "docker0" ct state related,established counter packets 84997918 bytes 55345822050 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 5264 bytes 354590 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 5264 bytes 354590 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 2325182 bytes 753377800 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2600026 bytes 1004208846 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 2322819 bytes 753243555 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 32115 bytes 1909269 accept
		udp dport 46539 counter packets 369798 bytes 514692618 accept
		udp dport 39425 counter packets 251 bytes 23931 accept
		tcp dport 80 counter packets 58378 bytes 3477143 accept
		udp dport 1194 counter packets 80 bytes 5983 accept
		tcp dport 8443 counter packets 5671 bytes 330218 accept
		...
		tcp dport 52000 counter packets 231 bytes 11780 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 665 bytes 36792 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 7 days   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 7 days   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 7 days   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-25 04:30:12 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-25 04:30:04 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 128K
drwxr-xr-x  2 root root   4.0K Jul 25 03:10 .
