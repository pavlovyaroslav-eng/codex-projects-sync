...
Generated: 2026-07-27T04:30:02+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 50 days, 14:09,  0 user,  load average: 0.50, 0.43, 0.36
```
...
-A f2b-ufw-portscan -s 149.154.175.50/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 84.252.150.128/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.79.207.110/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 192.168.0.108/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 68.183.235.163/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 134.122.1.127/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 46.101.16.175/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 142.250.203.131/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 95.213.56.1/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 88.221.92.189/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 104.83.5.160/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.151/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.104/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 95.101.75.42/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 88.221.92.14/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 16.59.16.61/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.243.40.182/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 146.75.118.73/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 88.221.92.169/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 94.100.180.215/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 4.155.111.97/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 209.38.59.3/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 52.161.50.32/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 38147 bytes 15314346 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 38147 bytes 2423891 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 30066619 bytes 16052153766 accept
		ct state related,established counter packets 359209050 bytes 249170872130 accept
		ct state invalid counter packets 29004 bytes 2298336 jump ufw-logging-deny
		ct state invalid counter packets 29004 bytes 2298336 drop
		...
		ip protocol icmp icmp type echo-request counter packets 49950 bytes 2877956 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 5473266 bytes 2012481216 jump ufw-not-local
		...
		counter packets 5473266 bytes 2012481216 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 30066967 bytes 16052185000 accept
		ct state related,established counter packets 439994900 bytes 503369024873 accept
		counter packets 2437384 bytes 295467811 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 378 bytes 34118 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 3 bytes 2383 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 314 bytes 16248 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1975 bytes 99628 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 2139691 bytes 701820692 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 3 bytes 2384 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 362392 bytes 109080332 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 38147 bytes 11414133 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 38147 bytes 2707454 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 422386 bytes 26855508 accept
		ip protocol udp ct state new counter packets 1966512 bytes 263928699 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 1765132 bytes 1031118076 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1090750 bytes 1359553160 accept
		counter packets 768903365 bytes 633679665075 jump ufw-before-logging-input
		counter packets 768903365 bytes 633679665075 jump ufw-before-input
		counter packets 7988153 bytes 1715692869 jump ufw-after-input
		counter packets 3562129 bytes 282277764 jump ufw-after-logging-input
		counter packets 3562129 bytes 282277764 jump ufw-reject-input
		counter packets 3562129 bytes 282277764 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 31413 bytes 6024246 accept
		counter packets 790656001 bytes 798224604468 jump ufw-before-logging-output
		counter packets 790656001 bytes 798224604468 jump ufw-before-output
		counter packets 5941083 bytes 798994889 jump ufw-after-output
		counter packets 5941083 bytes 798994889 jump ufw-after-logging-output
		counter packets 5941083 bytes 798994889 jump ufw-reject-output
		counter packets 5941083 bytes 798994889 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 157670345 bytes 370056060998 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 189202936 bytes 41691511338 accept
		...
		counter packets 845860438 bytes 925966606475 jump DOCKER-USER
		counter packets 845860438 bytes 925966606475 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 26531 bytes 5290309 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 63282 bytes 3849088 accept
	...
	chain DOCKER-FORWARD {
		counter packets 845860438 bytes 925966606475 jump DOCKER-CT
		counter packets 424643553 bytes 460352560574 jump DOCKER-INTERNAL
		counter packets 424643553 bytes 460352560574 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 318927505 bytes 419934976274 accept
		iifname "docker0" counter packets 105491038 bytes 40396273636 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 64617 bytes 11540202 jump DOCKER
		oifname "docker0" counter packets 159840 bytes 9738800 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 329635606 bytes 407696210081 accept
		oifname "docker0" ct state related,established counter packets 91581279 bytes 57917835820 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 6565 bytes 449779 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 6565 bytes 449779 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 2504756 bytes 811055785 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 2971034 bytes 1201568072 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 2502232 bytes 810913144 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 56343 bytes 3341797 accept
		udp dport 46539 counter packets 482276 bytes 670320491 accept
		udp dport 39425 counter packets 313 bytes 29784 accept
		tcp dport 80 counter packets 86160 bytes 5127502 accept
		udp dport 1194 counter packets 95 bytes 6573 accept
		tcp dport 8443 counter packets 11038 bytes 646330 accept
		...
		tcp dport 52000 counter packets 289 bytes 14643 accept
		udp dport 51820 counter packets 2 bytes 1600 accept
		tcp dport 25 counter packets 800 bytes 44356 accept
...
mtproto-telegram             telegrammessenger/proxy:latest   Up 9 days   0.0.0.0:9443->443/tcp, [::]:9443->443/tcp
amnezia-awg2                 amnezia-awg2                     Up 9 days   0.0.0.0:39425->39425/udp, [::]:39425->39425/udp
signal-tls-proxy-certbot-1   certbot/certbot                  Up 9 days   80/tcp, 443/tcp
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-27 04:30:02 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-27 04:30:19 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 152K
drwxr-xr-x  2 root root   4.0K Jul 27 03:10 .
