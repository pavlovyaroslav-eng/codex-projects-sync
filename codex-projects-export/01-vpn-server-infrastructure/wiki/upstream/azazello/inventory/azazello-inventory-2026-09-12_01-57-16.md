...
Generated: 2026-09-12T01:57:16+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 01:57:17 up 40 days, 22:44,  1 user,  load average: 1.31, 1.02, 0.90
```
...
udp   UNCONN 0      0                  *:59609            *:*    users:(("rw-core",pid=2921938,fd=25))                        
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=3859403,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
udp   UNCONN 0      0                  *:39760            *:*    users:(("rw-core",pid=2921938,fd=17))                        
udp   UNCONN 0      0                  *:56715            *:*    users:(("rw-core",pid=2921938,fd=11))                        
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 37794 bytes 8865028 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 37793 bytes 2960208 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 117638201 bytes 113630885684 accept
		ct state invalid counter packets 777 bytes 199907 jump ufw-logging-deny
		ct state invalid counter packets 777 bytes 199907 drop
		...
		ip protocol icmp icmp type echo-request counter packets 4688 bytes 278793 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 1897086 bytes 586992132 jump ufw-not-local
		...
		counter packets 1897086 bytes 586992132 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 129922816 bytes 117248855908 accept
		counter packets 2367639 bytes 281002943 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		...
		tcp dport 445 counter packets 670 bytes 31820 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 658191 bytes 215886028 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 5 bytes 140 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 109647 bytes 33292367 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 37793 bytes 2310980 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 37793 bytes 2979165 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 1053030 bytes 63184860 accept
		ip protocol udp ct state new counter packets 1311487 bytes 217485300 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 6311 bytes 1327275 jump f2b-sshd
		ip protocol tcp counter packets 26841835 bytes 58520309385 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 428039659 bytes 435984701616 jump ufw-before-logging-input
		counter packets 428039659 bytes 435984701616 jump ufw-before-input
		counter packets 4758460 bytes 1246872806 jump ufw-after-input
		counter packets 1166445 bytes 85413233 jump ufw-after-logging-input
		counter packets 1166445 bytes 85413233 jump ufw-reject-input
		counter packets 1166445 bytes 85413233 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 387712978 bytes 315525638164 jump ufw-before-logging-output
		counter packets 387712978 bytes 315525638164 jump ufw-before-output
		counter packets 3316838 bytes 374125899 jump ufw-after-output
		counter packets 3316838 bytes 374125899 jump ufw-after-logging-output
		counter packets 3316838 bytes 374125899 jump ufw-reject-output
		counter packets 3316838 bytes 374125899 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1716234312 bytes 2052849247740 jump DOCKER-USER
		counter packets 1716234319 bytes 2052849248954 jump DOCKER-FORWARD
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 8739238 bytes 10856907232 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 11101042 bytes 4948058811 accept
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 10851 bytes 3484120 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 481620 bytes 29651698 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1716234320 bytes 2052849249089 jump DOCKER-CT
		counter packets 867090538 bytes 1039687501979 jump DOCKER-INTERNAL
		counter packets 867090538 bytes 1039687501979 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 628265273 bytes 884841711735 accept
		iifname "docker0" counter packets 218462841 bytes 139002696940 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 40522 bytes 8483520 jump DOCKER
		oifname "docker0" counter packets 481620 bytes 29651698 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 645692767 bytes 858095990310 accept
		oifname "docker0" ct state related,established counter packets 203451015 bytes 155065756800 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.217.149.70 counter packets 53 bytes 2756 reject
		ip saddr 15.235.112.125 counter packets 10 bytes 592 reject
		ip saddr 85.217.140.23 counter packets 64 bytes 3328 reject
		ip saddr 85.217.140.24 counter packets 32 bytes 1664 reject
		ip saddr 85.217.149.37 counter packets 43 bytes 2236 reject
		ip saddr 85.217.140.48 counter packets 157 bytes 8164 reject
		ip saddr 85.217.149.73 counter packets 133 bytes 6916 reject
		ip saddr 85.217.140.11 counter packets 174 bytes 9048 reject
		ip saddr 172.217.112.4 counter packets 761 bytes 47984 reject
		ip saddr 85.217.140.30 counter packets 87 bytes 4524 reject
		ip saddr 85.217.140.32 counter packets 39 bytes 2028 reject
		ip saddr 85.217.140.19 counter packets 96 bytes 4992 reject
		ip saddr 85.217.140.41 counter packets 286 bytes 14872 reject
		ip saddr 85.217.149.68 counter packets 342 bytes 17784 reject
		ip saddr 85.217.140.33 counter packets 167 bytes 8684 reject
		ip saddr 85.217.140.39 counter packets 345 bytes 17940 reject
		ip saddr 85.217.140.6 counter packets 99 bytes 5148 reject
		ip saddr 85.217.140.9 counter packets 359 bytes 18668 reject
		ip saddr 85.217.149.54 counter packets 91 bytes 4732 reject
		ip saddr 85.217.140.43 counter packets 326 bytes 16952 reject
		ip saddr 85.217.140.1 counter packets 259 bytes 13468 reject
		ip saddr 85.217.140.5 counter packets 164 bytes 8528 reject
		ip saddr 85.217.140.34 counter packets 318 bytes 16536 reject
		ip saddr 194.213.105.2 counter packets 49 bytes 9954 reject
		ip saddr 92.114.107.56 counter packets 232 bytes 13656 reject
		ip saddr 85.217.140.52 counter packets 465 bytes 24180 reject
		ip saddr 85.217.140.47 counter packets 650 bytes 33800 reject
		ip saddr 172.217.118.4 counter packets 1989 bytes 121545 reject
		ip saddr 85.217.140.51 counter packets 540 bytes 28080 reject
		ip saddr 85.217.140.10 counter packets 591 bytes 30732 reject
		ip saddr 85.217.140.20 counter packets 104 bytes 5408 reject
		ip saddr 85.217.140.44 counter packets 508 bytes 26416 reject
		ip saddr 85.217.140.29 counter packets 320 bytes 16640 reject
		ip saddr 31.14.32.7 counter packets 324 bytes 16848 reject
		ip saddr 85.217.140.12 counter packets 470 bytes 24440 reject
		ip saddr 85.217.140.4 counter packets 618 bytes 32136 reject
		ip saddr 85.217.140.26 counter packets 322 bytes 16744 reject
		ip saddr 39.100.72.232 counter packets 131 bytes 5540 reject
		ip saddr 85.217.140.45 counter packets 719 bytes 37388 reject
		ip saddr 85.217.140.8 counter packets 659 bytes 34268 reject
		ip saddr 85.217.140.40 counter packets 551 bytes 28652 reject
		ip saddr 85.217.140.18 counter packets 342 bytes 17784 reject
		ip saddr 185.2.80.252 counter packets 290 bytes 15080 reject
		ip saddr 112.124.22.214 counter packets 87 bytes 3480 reject
		ip saddr 151.80.23.149 counter packets 30 bytes 1748 reject
		ip saddr 85.217.140.53 counter packets 813 bytes 42276 reject
		ip saddr 85.217.140.36 counter packets 961 bytes 49972 reject
		ip saddr 85.217.140.50 counter packets 896 bytes 46592 reject
```
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 48 | 2026-09-12 01:57:07 |
