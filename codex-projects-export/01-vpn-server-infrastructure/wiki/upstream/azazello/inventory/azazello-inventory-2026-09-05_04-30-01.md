...
Generated: 2026-09-05T04:30:01+03:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 34 days,  1:17,  0 user,  load average: 0.48, 0.31, 0.21
```
...
-A f2b-ufw-portscan -s 160.119.76.46/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 137.220.136.173/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 17.36.206.10/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 216.180.246.203/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 8012 bytes 2131512 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 8012 bytes 601822 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		...
		ct state related,established counter packets 17780927 bytes 19570768311 accept
		ct state invalid counter packets 250 bytes 18817 jump ufw-logging-deny
		ct state invalid counter packets 250 bytes 18817 drop
		...
		ip protocol icmp icmp type echo-request counter packets 695 bytes 40137 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 390258 bytes 156473188 jump ufw-not-local
		...
		counter packets 390258 bytes 156473188 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 203166 bytes 86146464 accept
		ct state related,established counter packets 18542979 bytes 19458123134 accept
		counter packets 324447 bytes 37796502 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 28 bytes 2184 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 11 bytes 524 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 133 bytes 6648 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 139582 bytes 45782596 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 1 bytes 28 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 23216 bytes 6974047 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 8011 bytes 491400 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 8012 bytes 608912 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 149726 bytes 8983560 accept
		ip protocol udp ct state new counter packets 174074 bytes 28761050 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp tcp dport 52000 counter packets 2093 bytes 525758 jump f2b-sshd
		ip protocol tcp counter packets 5948380 bytes 13015600666 jump f2b-ufw-portscan
		iifname "tun79" counter packets 0 bytes 0 accept
		counter packets 326671037 bytes 341493645553 jump ufw-before-logging-input
		counter packets 326671037 bytes 341493645553 jump ufw-before-input
		counter packets 4025860 bytes 1042556965 jump ufw-after-input
		counter packets 1039619 bytes 77558018 jump ufw-after-logging-input
		counter packets 1039619 bytes 77558018 jump ufw-reject-input
		counter packets 1039619 bytes 77558018 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 0 bytes 0 accept
		counter packets 274289949 bytes 217491698949 jump ufw-before-logging-output
		counter packets 274289949 bytes 217491698949 jump ufw-before-output
		counter packets 1273646 bytes 130919458 jump ufw-after-output
		counter packets 1273646 bytes 130919458 jump ufw-after-logging-output
		counter packets 1273646 bytes 130919458 jump ufw-reject-output
		counter packets 1273646 bytes 130919458 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		counter packets 1583455065 bytes 1924691383465 jump DOCKER-USER
		counter packets 1583455072 bytes 1924691384679 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 27238 bytes 4724162 accept
		ip daddr 172.17.0.2 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 375803 bytes 23161562 accept
	...
	chain DOCKER-FORWARD {
		counter packets 1583455072 bytes 1924691384679 jump DOCKER-CT
		counter packets 799634029 bytes 974387804409 jump DOCKER-INTERNAL
		counter packets 799634029 bytes 974387804409 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 608594347 bytes 862140407743 accept
		iifname "docker0" counter packets 174016697 bytes 99024672051 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 22 bytes 1320 jump DOCKER
		oifname "amn0" counter packets 27238 bytes 4724162 jump DOCKER
		oifname "docker0" counter packets 375803 bytes 23161562 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 625418414 bytes 835750181905 accept
		oifname "docker0" ct state related,established counter packets 158402629 bytes 114553398365 accept
	}
	...
	chain f2b-ufw-portscan {
		ip saddr 85.217.140.16 counter packets 7 bytes 364 reject
		ip saddr 85.217.140.50 counter packets 9 bytes 468 reject
		ip saddr 85.217.149.69 counter packets 12 bytes 624 reject
		ip saddr 85.217.149.49 counter packets 27 bytes 1404 reject
		ip saddr 85.217.140.37 counter packets 41 bytes 2132 reject
		ip saddr 85.217.140.53 counter packets 51 bytes 2652 reject
		ip saddr 85.217.140.49 counter packets 67 bytes 3484 reject
		ip saddr 85.217.140.5 counter packets 59 bytes 3068 reject
		ip saddr 85.217.149.74 counter packets 121 bytes 6292 reject
		ip saddr 85.217.149.65 counter packets 85 bytes 4420 reject
		ip saddr 85.217.149.71 counter packets 255 bytes 13260 reject
		ip saddr 85.217.149.70 counter packets 93 bytes 4836 reject
		ip saddr 85.217.140.1 counter packets 147 bytes 7644 reject
		ip saddr 34.102.162.219 counter packets 118 bytes 14750 reject
		ip saddr 85.217.149.72 counter packets 269 bytes 13988 reject
		ip saddr 85.217.140.18 counter packets 88 bytes 4576 reject
		ip saddr 85.217.140.48 counter packets 157 bytes 8164 reject
		ip saddr 85.217.140.11 counter packets 166 bytes 8632 reject
		ip saddr 146.75.118.73 counter packets 0 bytes 0 reject
		ip saddr 85.217.149.52 counter packets 154 bytes 8008 reject
		ip saddr 85.217.140.7 counter packets 135 bytes 7020 reject
		ip saddr 160.119.76.46 counter packets 275 bytes 11000 reject
		ip saddr 1.0.0.1 counter packets 8 bytes 480 reject
		ip saddr 85.217.140.32 counter packets 110 bytes 5720 reject
		ip saddr 85.217.149.51 counter packets 151 bytes 7852 reject
		ip saddr 85.217.140.26 counter packets 264 bytes 13728 reject
		ip saddr 85.217.140.3 counter packets 171 bytes 8892 reject
		ip saddr 85.217.140.33 counter packets 204 bytes 10608 reject
		ip saddr 85.217.140.24 counter packets 113 bytes 5876 reject
		ip saddr 85.217.140.29 counter packets 164 bytes 8528 reject
		ip saddr 85.217.149.53 counter packets 157 bytes 8164 reject
		ip saddr 85.217.140.20 counter packets 283 bytes 14716 reject
		ip saddr 85.217.149.68 counter packets 646 bytes 33592 reject
		ip saddr 85.217.140.47 counter packets 495 bytes 25740 reject
		ip saddr 85.217.149.73 counter packets 528 bytes 27456 reject
		ip saddr 85.217.140.52 counter packets 706 bytes 36712 reject
		ip saddr 85.217.140.39 counter packets 563 bytes 29276 reject
		ip saddr 85.217.140.9 counter packets 597 bytes 31044 reject
		ip saddr 85.217.149.63 counter packets 458 bytes 23816 reject
		ip saddr 85.217.140.34 counter packets 275 bytes 14300 reject
		ip saddr 85.217.149.67 counter packets 680 bytes 35360 reject
		ip saddr 85.217.140.28 counter packets 355 bytes 18460 reject
		ip saddr 85.217.149.37 counter packets 320 bytes 16640 reject
		ip saddr 85.217.149.64 counter packets 678 bytes 35256 reject
		ip saddr 85.217.140.6 counter packets 439 bytes 22828 reject
		ip saddr 85.217.140.30 counter packets 320 bytes 16640 reject
		ip saddr 85.217.140.35 counter packets 341 bytes 17732 reject
		ip saddr 85.217.140.31 counter packets 129 bytes 6708 reject
```
...
remnanode                    remnawave/node:3.4.1             Up 44 hours   
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 47 | 2026-09-05 04:29:38 |
...
| `/etc/letsencrypt` | directory | root:root | 755 | 4096 | 2026-09-04 12:47:30 |
...
total 372K
drwxr-xr-x  2 root root   4.0K Sep  5 03:10 .
