...
Generated: 2026-07-17T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:03 up 40 days, 17:09,  0 user,  load average: 0.09, 0.25, 0.26
```
...
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::a229:994e:dbec:20bc/64 
...
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1818675,fd=16))                
...
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1818675,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1818675,fd=23))                
...
-A f2b-ufw-portscan -s 198.74.56.46/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 94.100.180.216/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.108.4.164/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.108.4.144/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 87.240.185.150/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 85.217.149.44/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 85.217.149.40/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 81.196.8.146/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 80.231.123.139/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 8.8.8.8/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 54.255.209.114/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 46.228.223.172/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 45.79.207.129/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.79.168.172/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.33.12.214/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 45.225.135.171/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 34.102.215.99/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 217.69.139.216/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 217.69.139.215/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 2.16.16.153/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.150/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 2.16.16.103/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 194.55.96.133/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 194.221.250.50/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.178.25.174/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 192.12.31.92/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.190.208.80/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 188.170.74.38/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 185.16.148.89/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 178.217.160.253/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 173.255.221.189/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 173.194.6.167/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 173.194.151.101/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 76952 bytes 19998755 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 76952 bytes 5024965 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 19533576 bytes 10525947911 accept
		ct state related,established counter packets 317069361 bytes 213070417578 accept
		ct state invalid counter packets 20723 bytes 1710358 jump ufw-logging-deny
		ct state invalid counter packets 20723 bytes 1710358 drop
		...
		ip protocol icmp icmp type echo-request counter packets 42267 bytes 2420651 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3218544 bytes 901629985 jump ufw-not-local
		...
		counter packets 3218544 bytes 901629985 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 19533580 bytes 10525948127 accept
		ct state related,established counter packets 395617581 bytes 462903006465 accept
		counter packets 2088184 bytes 266677860 jump ufw-user-output
	}
	...
	chain ufw-before-forward {
		...
		counter packets 323 bytes 17314 jump ufw-user-forward
	}

	chain ufw-after-input {
		udp dport 137 counter packets 266 bytes 22852 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 224 bytes 11732 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1309 bytes 66308 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1390444 bytes 456066278 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 233379 bytes 70699354 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 76951 bytes 5011369 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 76579 bytes 5915389 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 338009 bytes 21791454 accept
		ip protocol udp ct state new counter packets 1711062 bytes 241080430 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 66471 bytes 22882001 jump f2b-ufw-portscan
		iifname "tun79" counter packets 1039410 bytes 1296656816 accept
		counter packets 713959946 bytes 590941108086 jump ufw-before-logging-input
		counter packets 713959946 bytes 590941108086 jump ufw-before-input
		counter packets 6405219 bytes 1308829997 jump ufw-after-input
		counter packets 2858329 bytes 159604153 jump ufw-after-logging-input
		counter packets 2858329 bytes 159604153 jump ufw-reject-input
		counter packets 2858329 bytes 159604153 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 30255 bytes 5799941 accept
		counter packets 735396095 bytes 752203559236 jump ufw-before-logging-output
		counter packets 735396095 bytes 752203559236 jump ufw-before-output
		counter packets 5591883 bytes 770204938 jump ufw-after-output
		counter packets 5591883 bytes 770204938 jump ufw-after-logging-output
		counter packets 5591883 bytes 770204938 jump ufw-reject-output
		counter packets 5591883 bytes 770204938 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 148707915 bytes 350613323469 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 177666496 bytes 38501672920 accept
		...
		counter packets 460059640 bytes 478376185505 jump DOCKER-USER
		counter packets 460059640 bytes 478376185505 jump DOCKER-FORWARD
		counter packets 547 bytes 31374 jump ufw-before-logging-forward
		counter packets 547 bytes 31374 jump ufw-before-forward
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 21 bytes 1933 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 77 bytes 4596 accept
	...
	chain DOCKER-FORWARD {
		counter packets 460059640 bytes 478376185505 jump DOCKER-CT
		counter packets 232404594 bytes 237646419309 jump DOCKER-INTERNAL
		counter packets 232404594 bytes 237646419309 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 170031014 bytes 210625280289 accept
		iifname "docker0" counter packets 62238291 bytes 27008961512 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 38107 bytes 6251826 jump DOCKER
		oifname "docker0" counter packets 96635 bytes 5894308 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 173951166 bytes 204568994058 accept
		oifname "docker0" ct state related,established counter packets 53703880 bytes 36160772138 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 18346 bytes 1527567 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 18346 bytes 1527567 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1625622 bytes 526866524 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1594596 bytes 374852389 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1623948 bytes 526777596 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 210635 bytes 13142969 accept
		udp dport 46539 counter packets 231668 bytes 280178010 accept
		udp dport 39425 counter packets 337 bytes 36935 accept
		tcp dport 80 counter packets 183386 bytes 10956678 accept
		udp dport 1194 counter packets 162 bytes 8660 accept
		tcp dport 8443 counter packets 5627 bytes 320224 accept
		...
		tcp dport 52000 counter packets 302 bytes 16050 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1890 bytes 106904 accept
		tcp dport 9443 counter packets 71 bytes 4252 accept
	}
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 43 | 2026-07-17 04:29:57 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-17 04:29:24 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
-rw-r--r--  1 root root   3.2K Jul 16 03:00 restart-2026-07-16.log
-rw-r--r--  1 root root   3.2K Jul 17 03:00 restart-2026-07-17.log
```
