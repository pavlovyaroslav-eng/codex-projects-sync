...
Generated: 2026-07-16T04:30:02+00:00  
Host: azazello  
FQDN: azazello  
...
Linux azazello 6.8.0-107-generic #107-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 13 19:51:50 UTC 2026 x86_64 x86_64 x86_64 GNU/Linux
 ...
 04:30:02 up 39 days, 17:09,  0 user,  load average: 0.42, 0.34, 0.36
```
...
veth23b39b1@if2  UP             fe80::6011:2ff:fe0f:9f44/64 
vethcd82695@if2  UP             fe80::c5c:d2ff:fe6c:74dd/64 
veth53e3166@if3  UP             fe80::fc17:7fff:feba:30a1/64 
veth349750c@if2  UP             fe80::45a:b1ff:fe35:fa9e/64 
wg0              UNKNOWN        172.16.0.2/32 2606:4700:110:8522:d608:2fba:6dba:94bf/128 fe80::2d8:b2ce:a613:4b4/64 
...
fe80::/64 dev veth23b39b1 proto kernel metric 256 pref medium
fe80::/64 dev vethcd82695 proto kernel metric 256 pref medium
fe80::/64 dev veth53e3166 proto kernel metric 256 pref medium
fe80::/64 dev veth349750c proto kernel metric 256 pref medium
...
udp   UNCONN 0      0            0.0.0.0:39425      0.0.0.0:*    users:(("docker-proxy",pid=1758807,fd=7))                    
udp   UNCONN 0      0            0.0.0.0:51820      0.0.0.0:*                                                                 
udp   UNCONN 0      0            0.0.0.0:21194      0.0.0.0:*    users:(("openvpn",pid=709029,fd=5))                          
udp   UNCONN 0      0                  *:46539            *:*    users:(("xray-linux-amd6",pid=1759121,fd=16))                
udp   UNCONN 0      0              [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=7))                          
udp   UNCONN 0      0               [::]:39425         [::]:*    users:(("docker-proxy",pid=1758812,fd=7))                    
udp   UNCONN 0      0               [::]:51820         [::]:*                                                                 
tcp   LISTEN 0      256        127.0.0.1:5353       0.0.0.0:*    users:(("unbound",pid=1521352,fd=4))                         
tcp   LISTEN 0      4096         0.0.0.0:9443       0.0.0.0:*    users:(("docker-proxy",pid=1758496,fd=7))                    
tcp   LISTEN 0      4096       127.0.0.1:62789      0.0.0.0:*    users:(("xray-linux-amd6",pid=1759121,fd=14))                
...
tcp   LISTEN 0      4096       127.0.0.1:11111      0.0.0.0:*    users:(("xray-linux-amd6",pid=1759121,fd=23))                
...
tcp   LISTEN 0      511          0.0.0.0:80         0.0.0.0:*    users:(("nginx",pid=1759083,fd=5),("nginx",pid=1759082,fd=5))
tcp   LISTEN 0      4096   127.0.0.53%lo:53         0.0.0.0:*    users:(("systemd-resolve",pid=127066,fd=15))                 
tcp   LISTEN 0      100          0.0.0.0:25         0.0.0.0:*    users:(("master",pid=1759420,fd=13))                         
tcp   LISTEN 0      4096               *:2020             *:*    users:(("x-ui",pid=1759065,fd=9))                            
tcp   LISTEN 0      1024           [::1]:8388          [::]:*    users:(("ss-server",pid=1087,fd=5))                          
tcp   LISTEN 0      4096            [::]:9443          [::]:*    users:(("docker-proxy",pid=1758502,fd=7))                    
tcp   LISTEN 0      4096               *:443              *:*    users:(("xray-linux-amd6",pid=1759121,fd=15))                
tcp   LISTEN 0      511             [::]:80            [::]:*    users:(("nginx",pid=1759083,fd=6),("nginx",pid=1759082,fd=6))
```
...
-A f2b-ufw-portscan -s 91.78.8.161/32 -j REJECT --reject-with icmp-port-unreachable
-A f2b-ufw-portscan -s 91.108.56.147/32 -j REJECT --reject-with icmp-port-unreachable
...
-A f2b-ufw-portscan -s 84.42.94.122/32 -j REJECT --reject-with icmp-port-unreachable
...
table ip filter {
	chain ufw-before-logging-input {
		ct state new limit rate 3/minute burst 10 packets counter packets 72632 bytes 18781943 log prefix "[UFW AUDIT] "
	}

	chain ufw-before-logging-output {
		ct state new limit rate 3/minute burst 10 packets counter packets 72632 bytes 4754920 log prefix "[UFW AUDIT] "
	}
	...
	chain ufw-before-input {
		iifname "lo" counter packets 18486588 bytes 9999952333 accept
		ct state related,established counter packets 305513723 bytes 206586595080 accept
		ct state invalid counter packets 19421 bytes 1598699 jump ufw-logging-deny
		ct state invalid counter packets 19421 bytes 1598699 drop
		...
		ip protocol icmp icmp type echo-request counter packets 41613 bytes 2380178 accept
		udp sport 67 udp dport 68 counter packets 0 bytes 0 accept
		counter packets 3078896 bytes 844600830 jump ufw-not-local
		...
		counter packets 3078896 bytes 844600830 jump ufw-user-input
	}

	chain ufw-before-output {
		oifname "lo" counter packets 18486592 bytes 9999952549 accept
		ct state related,established counter packets 380310058 bytes 445888336285 accept
		counter packets 2040259 bytes 261673651 jump ufw-user-output
	}
	...
	chain ufw-after-input {
		udp dport 137 counter packets 261 bytes 22462 jump ufw-skip-to-policy-input
		udp dport 138 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		tcp dport 139 counter packets 214 bytes 11196 jump ufw-skip-to-policy-input
		tcp dport 445 counter packets 1258 bytes 63836 jump ufw-skip-to-policy-input
		udp dport 67 counter packets 1314829 bytes 431264558 jump ufw-skip-to-policy-input
		udp dport 68 counter packets 0 bytes 0 jump ufw-skip-to-policy-input
		fib daddr type broadcast counter packets 220586 bytes 66814072 jump ufw-skip-to-policy-input
	}
	...
	chain ufw-after-logging-input {
		limit rate 3/minute burst 10 packets counter packets 72632 bytes 4731206 log prefix "[UFW BLOCK] "
	}

	chain ufw-after-logging-output {
		limit rate 3/minute burst 10 packets counter packets 72259 bytes 5598592 log prefix "[UFW ALLOW] "
	}
	...
	chain ufw-track-output {
		ip protocol tcp ct state new counter packets 325645 bytes 21049162 accept
		ip protocol udp ct state new counter packets 1678280 bytes 237132871 accept
	}
	...
	chain INPUT {
		...
		ip protocol tcp counter packets 67242 bytes 22982575 jump f2b-ufw-portscan
		iifname "tun79" counter packets 998551 bytes 1246098300 accept
		counter packets 701215716 bytes 583874108723 jump ufw-before-logging-input
		counter packets 701215716 bytes 583874108723 jump ufw-before-input
		counter packets 6290403 bytes 1278533830 jump ufw-after-input
		counter packets 2831987 bytes 157998386 jump ufw-after-logging-input
		counter packets 2831987 bytes 157998386 jump ufw-reject-input
		counter packets 2831987 bytes 157998386 jump ufw-track-input
	}

	chain OUTPUT {
		type filter hook output priority filter; policy accept;
		oifname "tun79" counter packets 29234 bytes 5602932 accept
		counter packets 718993659 bytes 734657889269 jump ufw-before-logging-output
		counter packets 718993659 bytes 734657889269 jump ufw-before-output
		counter packets 5543958 bytes 765200729 jump ufw-after-output
		counter packets 5543958 bytes 765200729 jump ufw-after-logging-output
		counter packets 5543958 bytes 765200729 jump ufw-reject-output
		counter packets 5543958 bytes 765200729 jump ufw-track-output
	}

	chain FORWARD {
		type filter hook forward priority filter; policy drop;
		ip daddr 10.79.0.0/24 iifname "eth0" oifname "tun79" ct state related,established counter packets 143186166 bytes 337585192411 accept
		ip saddr 10.79.0.0/24 iifname "tun79" oifname "eth0" counter packets 171048162 bytes 37519033314 accept
		...
		counter packets 439036080 bytes 457253210376 jump DOCKER-USER
		counter packets 439036080 bytes 457253210376 jump DOCKER-FORWARD
	...
	chain DOCKER {
		ip daddr 172.29.172.2 iifname != "amn0" oifname "amn0" udp dport 39425 counter packets 49 bytes 5732 accept
		ip daddr 172.17.0.3 iifname != "docker0" oifname "docker0" tcp dport 443 counter packets 115 bytes 6884 accept
	...
	chain DOCKER-FORWARD {
		counter packets 439036080 bytes 457253210376 jump DOCKER-CT
		counter packets 221621942 bytes 227300556803 jump DOCKER-INTERNAL
		counter packets 221621942 bytes 227300556803 jump DOCKER-BRIDGE
		iifname "br-566ebeb0f4f1" counter packets 0 bytes 0 accept
		iifname "amn0" counter packets 165114096 bytes 204687649965 accept
		iifname "docker0" counter packets 56388089 bytes 22601934615 accept
	}

	chain DOCKER-BRIDGE {
		oifname "br-566ebeb0f4f1" counter packets 0 bytes 0 jump DOCKER
		oifname "amn0" counter packets 35991 bytes 5883927 jump DOCKER
		oifname "docker0" counter packets 83219 bytes 5056922 jump DOCKER
	}

	chain DOCKER-CT {
		oifname "br-566ebeb0f4f1" ct state related,established counter packets 0 bytes 0 accept
		oifname "amn0" ct state related,established counter packets 168765460 bytes 198764406452 accept
		oifname "docker0" ct state related,established counter packets 48648678 bytes 31188247121 accept
	}
	...
	chain ufw-logging-deny {
		ct state invalid limit rate 3/minute burst 10 packets counter packets 17227 bytes 1428942 log prefix "[UFW AUDIT INVALID] "
		limit rate 3/minute burst 10 packets counter packets 17227 bytes 1428942 log prefix "[UFW BLOCK] "
	}
	...
	chain ufw-skip-to-policy-input {
		counter packets 1537148 bytes 498176124 drop
	}
	...
	chain ufw-not-local {
		fib daddr type local counter packets 1543356 bytes 346510236 return
		fib daddr type multicast counter packets 0 bytes 0 return
		fib daddr type broadcast counter packets 1535540 bytes 498090594 return
		limit rate 3/minute burst 10 packets counter packets 0 bytes 0 jump ufw-logging-deny
		counter packets 0 bytes 0 drop
	}

	chain ufw-user-input {
		tcp dport 443 counter packets 207739 bytes 12971772 accept
		udp dport 46539 counter packets 210901 bytes 253683328 accept
		udp dport 39425 counter packets 319 bytes 35126 accept
		tcp dport 80 counter packets 183025 bytes 10937032 accept
		udp dport 1194 counter packets 154 bytes 8354 accept
		tcp dport 8443 counter packets 4935 bytes 279684 accept
		...
		tcp dport 52000 counter packets 283 bytes 15050 accept
		udp dport 51820 counter packets 0 bytes 0 accept
		tcp dport 25 counter packets 1819 bytes 103096 accept
...
| `/var/lib/hometele-monitor/command-agent.since` | regular file | root:root | 644 | 42 | 2026-07-16 04:30:01 |
...
| `/etc/x-ui` | directory | root:root | 755 | 4096 | 2026-07-16 04:29:25 |
| `/etc/3x-ui` | missing | - | - | - | - |
...
total 84K
drwxr-xr-x  2 root root   4.0K Jul 16 03:00 .
